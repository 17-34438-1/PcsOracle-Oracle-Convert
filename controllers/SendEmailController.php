...
class SendEmailController extends CI_Controller {
	...
	function sendEmail($subject=null,$body=null,$emailClient=null,$pdfFilePath_cartTicket=null,$pdfFilePath_Bill=null,$pdfFilePath_releaseorder=null)
	{
	...
	//	$file_name="admin_20160716103021.xls";
		...
		$mail->AddAddress("kaws.med@gmail.com");
	...
	//	$mail->addAttachment("resources/uploadfile/".$pdfFilePath_Bill);   //worked
		...
		if(!$mail->Send())
			{
				...
				$datawrite="IP: $ip_add | NewYork Time: $newYorkDate | BangladeshTime: $bangladeshDate | $mail->AddAddress('kaws.med@gmail.com')\r\n";
	  ...
	  return $rtnmsg;
		...
		function sendMail(){
			// $config = Array(
			// 	'protocol' => 'smtp',
			// 	'smtp_host' => 'cpatos.gov.bd',
			// 	'smtp_port' => 25,
			// 	'smtp_user' => 'No-reply@cpatos.gov.bd',
			// 	'smtp_pass' => '123456!@#',
			// 	'mailtype' => 'html',
			// 	'charset' => 'iso-8859-1',
			// 	'wordwrap' => TRUE,
			...
			// $this->email->from('cpatos.gov.bd', 'CPATOS');
			// $this->email->to('kaws.med@gmail.com');
	
			// $this->email->subject('Email Test For CPATOS');
			...
			$from = 'No-reply@cpatos.gov.bd';
			$to   = 'kaws.med@gmail.com';
			$subject = 'Email Test';
			...
			$config['smtp_host']    = 'cpatos.gov.bd';
			$config['smtp_port']    = '25';
			$config['smtp_timeout'] = '30';
			$config['smtp_user']    = 'No-reply@cpatos.gov.bd';
