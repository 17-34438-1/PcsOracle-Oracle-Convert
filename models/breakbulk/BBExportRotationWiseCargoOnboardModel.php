...
class BBExportRotationWiseCargoOnboardModel extends CI_Model
{
...
function ExportRotationWiseOnboardCargoSearch($keyword){
   ...
   function ExportRotationWiseOnboardCargoSearchIGMData($keyword){
