...
class BBImportRotationWiseCargoOnboardModel extends CI_Model
{
...
function importRotationWiseOnboardCargoSearch($keyword){
...
WHERE VSL_VESSEL_VISIT_DETAILS.IB_VYG= '$keyword' AND inv_unit_fcy_visit.transit_state='S20_INBOUND'  ORDER BY CRG_BILLS_OF_LADING.NBR ASC )");
   ...
   function importRotationWiseOnboardCargoSearchIGMData($keyword){
