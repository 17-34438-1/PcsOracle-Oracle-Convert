	...
	<?php
			...
			for($i=0; $i<count($notice_List); $i++)
			{
				...
				$notify_addr = preg_replace('/[^A-Za-z0-9,;()@&\-]/', ' ', $notice_List[$i]['Notify_address']);
	?>
                ...
                <table width="80%" align="center">
				   <tr>
                    ...
                    <tr>
                        <td colspan="3">To, Messrs  <?php echo $notice_List[$i]['Notify_name'] ?><br/><?php echo  $notify_addr; ?> <br/> ________________________________________</td>
                    </tr>
                    <tr>
                        <td>&nbsp;</td>
                    </tr>
                ...
                <table border="1" width="60%" align="center" style="border-collapse: collapse;">
					...
					<?php
					 ...
					 $sql = "SELECT  igm_detail_container.cont_number, igm_details.Pack_Marks_Number, igm_details.BL_No, igm_detail_container.cont_status
							...
							UNION 
							SELECT  igm_sup_detail_container.cont_number, igm_supplimentary_detail.Pack_Marks_Number, igm_supplimentary_detail.BL_No, igm_sup_detail_container.cont_status
							...
							WHERE igm_supplimentary_detail.Import_Rotation_No='$rotation' AND igm_supplimentary_detail.BL_No IN ('$bl')";	
