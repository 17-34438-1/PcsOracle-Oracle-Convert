        ...
        <div class="col-lg-12">						
            <section class="panel">
                <div class="panel-body">
                    <form class="form-horizontal form-bordered" method="POST" action="<?php echo site_url('Auction/AuctionHandOverReportFormLCL')?>" id="myform" name="myform" onsubmit="return validate()">
						<div class="row">
            ...
            <section class="panel">
                <div class="panel-body" style="padding:0px;">
					...
					<form class="form-horizontal form-bordered" method="POST" action="<?php echo site_url('Auction/AuctionHandOverReportFormLCL')?>" 
							target="<?php if($save_flag=="0") echo "_self"; else echo "_blank";?>">
							...
							<?php								
								...
								for($i=0;$i<count($resultBL);$i++)
								{
									...
									while($rowIgmDtls = mysqli_fetch_object($resIgmDtls)){
										...
										$cont_gross_weight = $rowIgmDtls->cont_gross_weight;
									}
									
									$rl_no = "";
									$rl_date = "";
									$queryHandoverData = "SELECT rl_no,rl_date FROM auction_handover_lcl WHERE bl_no='$blNo'";
							...
							?>
								<tr>
									...
									<td class="text-center" rowspan="<?php echo $cntContainers; ?>">
										...
										<input type="hidden" class="form-control" name="<?php echo "Pack_Description".$j;?>" id="Pack_Description" value="<?php echo $Pack_Description; ?>">
								...
								<?php 
									...
									for($n=1; $n<count($resultIgmDtls); $n++)
										...
										INNER JOIN sparcsn4.ref_equipment ON sparcsn4.ref_equipment.gkey=sparcsn4.inv_unit_equip.eq_gkey 
										INNER JOIN sparcsn4.ref_equip_type ON sparcsn4.ref_equip_type.gkey=sparcsn4.ref_equipment.eqtyp_gkey 
										WHERE sparcsn4.inv_unit.id='$cont'";
