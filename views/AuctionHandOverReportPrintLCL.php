	...
	<table border="0" align="center" width="100%" style="border-collapse:collapse;margin-bottom:10px;">
		<tr>
			...
			<td style="width:10%;">
				<img align="left" width="80px" height="45px"  src="<?php echo ASSETS_PATH?>images/auction_img.png">
			</td>
		</tr>
		<tr>
	...
	<table border="1" align="center" width="100%" style="border-collapse:collapse;">
		...
		<tbody>
			<?php
				...
				$query2 = "SELECT cont, size, height, TYPE, auction_handover_lcl.cont_status, last_pos_slot, obpc_number, obpc_date, igm_detail_container.Cont_gross_weight
							FROM auction_handover_lcl
							LEFT JOIN igm_details ON igm_details.BL_No=auction_handover_lcl.bl_no AND auction_handover_lcl.rotation_no=igm_details.Import_Rotation_No
							LEFT JOIN cchaportdb.igm_detail_container ON cchaportdb.igm_detail_container.igm_detail_id=cchaportdb.igm_details.id
							WHERE auction_handover_lcl.rotation_no='$rotation' AND auction_handover_lcl.bl_no='$blNo'
							
							UNION 

							SELECT cont, size, height, TYPE, auction_handover_lcl.cont_status, last_pos_slot, obpc_number, obpc_date, igm_sup_detail_container.Cont_gross_weight
							FROM auction_handover_lcl
							LEFT JOIN igm_supplimentary_detail ON igm_supplimentary_detail.BL_No=auction_handover_lcl.house_bl AND auction_handover_lcl.rotation_no=igm_supplimentary_detail.Import_Rotation_No
							LEFT JOIN cchaportdb.igm_sup_detail_container ON cchaportdb.igm_sup_detail_container.igm_sup_detail_id=cchaportdb.igm_supplimentary_detail.id
							WHERE auction_handover_lcl.rotation_no='$rotation' AND auction_handover_lcl.house_bl='$blNo'";
							//return;
			...
			?>
				<tr align="center">
					...
					<?php 
						...
						$Cont_gross_weight = @$resultSub[0]['Cont_gross_weight'];
					...
					<td align="center" ><?php echo $Cont_gross_weight; ?></td>
              ...
              <?php if($count>1)
				  	for($n=1; $n<count($resultSub); $n++)
						...
						$Cont_gross_weight = $resultSub[$n]['Cont_gross_weight'];
