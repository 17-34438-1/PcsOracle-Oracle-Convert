		...
		<section class="panel">
			<div class="panel-body">
				<?php if($frmType=="search" or $frmType=="inserted" or $frmType=="deleted") { ?>
					<form method="POST" enctype="multipart/form-data" action="<?php echo site_url("EDOController/bbEDOUpload") ?>" target="successMsg">
						...
						<table border="1" style="border-collapse:collapse;margin-bottom:20px;" align="center" width="100%">
							...
							<tr>
								...
								<td colspan="2" rowspan="4" valign="top">
									...
									<p>
										<font style="margin-left:2px;margin-right:4px;color:#000000;"><b>R No:</b></font>
										<input type="text" name="r_no" id="r_no"
											style="text-align:center; border:1px solid blue;width:150px;height:30px;" autocomplete="off" 
												value="<?php if($edit=="edit" or $edit=="extendValidity"){echo $r_no;}?>" required>
										 <br/>
									</p>
									<p>
										<font style="margin-left:2px;margin-right:4px;color:#000000;"><b>R No Date:</b></font>
										<input type="date" name="r_no_date" id="r_no_date"
											style="text-align:center; border:1px solid blue;width:150px;height:30px;" autocomplete="off" 
												value="<?php if($edit=="edit" or $edit=="extendValidity"){echo $r_no_date;}?>" required>
										 <br/>
									</p>
									<!--p>
							...
							<tr>
								<th valign="top" class="text-center" rowspan="2">No of Packages</th>
								<th valign="top" class="text-center" rowspan="2"><nobr>Kind of Packages</nobr></th>
								<th valign="top" class="text-center" rowspan="2">Description of Goods</th>
								<th valign="top" class="text-center" rowspan="2">Marks and Numbers</th>
								<th valign="top" class="text-center" colspan="2">Quantity</th>
							</tr>
							<tr>
								<th valign="top" class="text-center">Net Quantity</th>
								<th valign="top" class="text-center">Gross Quantity</th>
							</tr>
							<tr>
								...
								<td align="center">
									<p>
										<nobr>
											<input type="text" name="net_weight" id="net_weight" value="<?php if($edit == "edit"){echo $weight;} else { echo $weight; }?>" 
								...
								<td align="center">
									<p>
										<input type="text" name="gross_weight" id="gross_weight"
											style="text-align:center; border:1px solid blue;width:100px;" autocomplete="off" 
												value="<?php if($edit == "edit"){echo $weight;} else { echo $weight; }?>" required 
												readonly >
									</p>
								</td>
							</tr>
							...
							<tr>
								<td valign="middle" align="center" style="text-align:center; border:0px solid blue;">
									<p>
										<b>Remarks : </b>
									</p>
								</td>
								<td colspan="5" valign="middle" align="left" style="text-align:center; border:0px solid blue;">
									<p>
										<textarea type="text" name="remarks" id="remarks"
											style="text-align:left; border:1px solid blue;width:100%;height:35px;"  
