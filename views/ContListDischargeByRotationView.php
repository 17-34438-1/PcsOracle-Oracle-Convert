			...
			<div class="col-lg-12">						
				<section class="panel">
					...
					<div class="panel-body">
						<form class="form-horizontal form-bordered" id="myform" method="POST" action="<?php echo site_url('report/contListDischargeByRotationDownloadView') ?>"
						target="_blank">
							...
							<div class="form-group">
								...
								<div class="col-md-6">
									<div class="input-group mb-md">
										...
										<input type="date" name="dis_date_from" id="dis_date_from" class="form-control" value="<?php echo date("yy/m/d"); ?>" >
									</div>
									<div class="input-group mb-md">
										<span class="input-group-addon span_width">To Date:</span>
										<input type="date" name="dis_date_to" id="dis_date_to" class="form-control" value="<?php echo date("yy/m/d"); ?>" >
									</div>
