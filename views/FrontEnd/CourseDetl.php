    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <ul class="breadcrumb">
                ...
                <li><a href="all-courses.html">All Courses</a> <span class="divider">/</span></li>
        ...
        <aside  class="col-md-4 col-sm-4">
            <div class="col-left">
                ...
                <ul class="submenu-col">
                    ...
                    <li><a href="course-detail.html" id="active">Administration (10)</a></li>
                    <li><a href="course-detail.html">Business (08)</a></li>
                    <li><a href="course-detail.html">Communication (05) <img src="<?php echo  ASSETS_WEB_PATH?>fimg/new.png" alt="New"></a></li>
        ...
        <section class="col-md-8 col-sm-8">
            <div class="col-right">
                <div class="main-img">
                    <img src="<?php echo  ASSETS_WEB_PATH?>fimg/pic-4.jpg" alt="" class="img-responsive">
                ...
                <div class="strip-lessons">
                    <div class="row">
                        <div class="col-md-3 col-sm-6 col-xs-6">
                            <div class="box-style-one borders"><img src="<?php echo  ASSETS_WEB_PATH?>fimg/lessons.png" alt=""><h5>Intro one</h5></div>
                        </div>
                ...
                <div class="strip-lessons">
                    <div class="row">
                        <div class="col-md-3 col-sm-6 col-xs-6">
                            <div class="box-style-one borders"><img src="<?php echo  ASSETS_WEB_PATH?>fimg/lessons.png" alt=""><h5>Intro two</h5></div>
                        </div>
                        <div class="clearfix visible-xs-block"></div>
                        <div class="col-md-9 col-sm-12">
                            <h4>Ulum epicurei</h4>
