        ...
        <div class="row">
            ...
            <div class="col-md-4 col-sm-4" id="contacts-footer">
                ...
                <ul>
                    ...
                    <!--li><i class="icon-phone-sign"></i>Fax: +880-31-XXXXXX</li-->
			...
			<div class="col-md-4 col-sm-4" id="contacts-footer">
                ...
                <ul>
                    <li style="font-family:courier;"><i class=""></i> <b><font size=5 color=green> <?php echo $todayHit; ?> </font></b></li>
                    <!--li style="font-family:courier;"><i class=""></i>Total Hit    : <font size=5 color=red> <?php echo $counts; ?> </font></li-->
                </ul>
            </div>
			...
			<div class="col-md-4 col-sm-4 company_logo" id="brand-footer">
				...
				<a href="http://datasoft-bd.com/" target="_blank">
                    <img width="150px" height="50px" src="<?php echo  ASSETS_WEB_PATH ?>fimg/datasoft_logo.png" alt="">
                </a> -->
			</div>
...
<!--ul id="example-1" class="sticklr">
    <li><a href="#"  ><img src="<?php echo ASSETS_WEB_PATH?>fimg/wh.png" alt=""></a>
        <ul>
            <li class="sticklr-title"><a href="http://themeforest.net/user/Ansonika/portfolio?ref=ansonika">Quick links</a></li>
            <li><a href="<?php echo site_url('FrontEndController/AllCourse')?>" title="All courses">All</a></li>
            <li><a href="<?php echo site_url('FrontEndController/CourseDetl')?>" title="Course detail">Details</a></li>
            <li><a href="<?php echo site_url('FrontEndController/Staff')?>" title="Meet the team">Meet the team</a></li>
            <li><a href="<?php echo site_url('FrontEndController/ContactUs')?>" title="Apply for a course">Apply for a post</a></li>
