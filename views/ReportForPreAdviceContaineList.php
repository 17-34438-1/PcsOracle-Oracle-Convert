		...
		<div class="col-lg-12">						
			<section class="panel">
				<div class="panel-body">
					<form class="form-horizontal form-bordered" method="POST" action="<?php echo base_url().'index.php/Report/RequestForPreAdviceReportView'; ?>" target="_blank" id="myform" name="myform">
						<div class="form-group">
							...
							<div class="col-md-6">		
								...
								<div class="input-group mb-md">
									<span class="input-group-addon span_width" id="lbl_line">To Date <span class="required">*</span></span>
