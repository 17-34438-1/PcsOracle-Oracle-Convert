		...
		<div class="col-lg-12">						
			<section class="panel">
				...
				<div class="panel-body">
					...
					<div class="row">
						<form action="<?php echo site_url('Vessel/forwardTugHiringListToBillOp');?>" method="POST">
							<div class="col-md-12">
								<div align="left">
									<p>
										<div class="col-md-6">
											<div class="input-group mb-md">
												<span class="input-group-addon span_width">
													Bill Operator <span class="required"><b>*</b></span>
												</span>
												<select class="form-control" name="bill_op" id="bill_op" required>
													<option value="">--Select--</option>
													<?php for($i=0; $i<count($billOpList); $i++) { ?>
													<option value="<?php echo $billOpList[$i]['login_id']; ?>">
														<?php echo $billOpList[$i]['u_name']; ?>
													</option>
													<?php } ?>
												</select>
											</div>
