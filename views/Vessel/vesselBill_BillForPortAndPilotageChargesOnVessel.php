		...
		<div align ="center">
			...
			<table align="center" width="95%">
				...
				<tr>
					...
					<td align="center" width="2%">:</td>
					<td align="left"><font size="5"><b><?php echo $bill_rslt[0]['creator'];?></b></font></td>					
				</tr>
				<tr>
					<td align="left" class="padding_top_bottom"><font size="5"><b>Vessel Name</b></font></td>
					<td align="center" width="2%">:</td>
					<td align="left" class="padding_top_bottom"><font size="5"><?php echo $bill_rslt[0]['vesselName'];?></font></td>
					<td width="2%"></td>					
					<td align="left" class="padding_top_bottom"><font size="5"><b>Bill Date</b></font></td>
					<td align="center" width="2%">:</td>
					<td align="left" class="padding_top_bottom"><font size="5"><b><?php echo $bill_rslt[0]['created'];?></b></font></td>
				</tr>
				<tr>
					...
					<td align="center" width="2%">:</td>
					<td align="left" style="width:25%"><font size="5"><b><?php echo $bill_rslt[0]['flagcountry'];?></b></font></td>					
				</tr>
				<tr>
				...
				<tr>
					<td align="left" class="padding_top_bottom"><font size="5"><b>Date of Bearthing</b></td>
					<td align="center" width="2%">:</td>
					<!--td align="left" class="padding_top_bottom"><font size="5"><?php echo $bill_rslt[0]['dateOfBerth'];?></font></td-->
				...
				<tr>
					...
					<td align="center" width="2%">:</td>
					<!--td align="left" class="padding_top_bottom"><font size="5"><?php echo $bill_rslt[0]['dateOfLeave'];?></font></td--> 
					...
					<td align="center" width="2%">:</td>
					<td align="left" class="padding_top_bottom"><font size="5"><?php echo $bill_rslt[0]['timeLeaveFrom'];?> To: <?php echo $bill_rslt[0]['timeLeaveTo'];?> HRS</font></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td align="center" width="2%">:</td>
					<td align="left" class="padding_top_bottom"><?php echo $bill_rslt[0]['cargo'];?></font></td>
				</tr>
				<tr>
					<td align="left" class="padding_top_bottom"><font size="5"><b>Ex.Rate</b></font></td>
					<td align="center" width="2%">:</td>
					<td align="left" class="padding_top_bottom"><font size="5"><b><?php echo number_format($bill_rslt[0]['exchangeRate'],4);?></b></font></td>
					<td width="2%"></td>
					<td align="left"></td>
					<td align="left"></td>					
				</tr>
			...
			<table align="center" width="95%" border=0>				
				...
				<tr>
					...
					<td align="center" class="padding_top_bottom"><font size="5"><?php echo $bill_rslt[$i]['glcode']; ?></font></td>
					<td align="right" class="padding_top_bottom_right"><font size="5"><?php echo number_format($bill_rslt[$i]['rateBilled'],4); ?></font></td>
					...
					<td align="center" class="padding_top_bottom"><font size="5"><?php echo $bill_rslt[$i]['move']; ?></font></td>
				...
				<tr>
					...
					<td align="right"><font size="5"><?php echo number_format(($grandTotUSD*$bill_rslt[0]['exchangeRate']),2); ?></font></td>
					<td align="right"><font size="5"><?php echo number_format(($grandTotVATUSD*$bill_rslt[0]['exchangeRate']),2); ?></font></td>
				</tr>
			</table>	
