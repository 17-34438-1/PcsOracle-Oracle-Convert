		...
		<div align ="center">
			...
			<table align="center" width="95%">
				...
				<tr>
					...
					<td align="center">:</td>
					<td align="left" class="padding_top_bottom"><font size="5"><?php echo "";?></font></td>					
				</tr>
				<tr>
				...
				<tr>
					...
					<td align="left" class="padding_top_bottom"><font size="5"><?php echo $bill_rslt[0]['agent_code'];?></font></td> 
				</tr>
				<tr>
			...
			<table border="0" style="border-collapse:collapse" align="center" width="95%">
				...
				<tr>
					<td align="left" width="250px"><font size="5"><b>DESCRIPTION</b></font></td>
					<td align="right"><font size="5"><b>A/C</b></font></td>
					<td align="right"><font size="5"><b>RATE</b></font></td>
					<td align="center"><font size="5"><b>BAS</b></font></td>
				...
				{
					$grandTotVAT = $grandTotVAT + $bill_rslt[$i]['vatusd'];
					$totalTkus = $totalTkus + $bill_rslt[$i]['totusd'];
				?>
				...
				<tr>
					...
					<td align="right"> 
						<font size="5"><?php echo number_format($bill_rslt[$i]['totusd'],4); ?></font>
					</td>										
					<td align="right"> 
						<font size="5"><?php echo number_format($bill_rslt[$i]['vatusd'],4); ?></font>
					</td>											
				</tr>
				<?php  
				    } 
			...
			<table align="center" width="85%" border=0>
				<tr>					
					<td align="left" colspan="2"> 
						<img src="<?php echo $_SERVER['DOCUMENT_ROOT']."/resources/images/signature_vessel_bill/".$bill_rslt[0]['creator'].".jpg" ?>" alt="No Image Found" width="100" height="50">
					</td>
					...
					<td align="right" colspan="2">
						...
						{
						?>
							<img src="<?php echo $_SERVER['DOCUMENT_ROOT']."/resources/images/signature_vessel_bill/".$bill_rslt[0]['acc_apprv_by'].".jpg" ?>" alt="No Image Found" width="100" height="50">
						<?php
						}
						?>
					</td>
