	...
	<div class="col-lg-12">						
		...
		<div class="form-group">
			...
			<table width=100%>
				...
				<tr>
					<!-- <td align="left">
						উপরোক্ত বিষয়ে জানানো যাচ্ছে যে , অত্র বিভাগের বার্থিং শাখায় জমাকৃত বাণিজ্যিক জাহাজের  &nbsp;<label id="filela2" name="filela2">0</label> &nbsp; টি পাইলটিং এর আগমন নির্গমন  পেপার পরবর্তী প্রয়োজনীয় ব্যবস্থা গ্রহণের জন্য এতদসঙ্গে সংযুক্ত করে প্রেরণ করা হল। (১-১৫)
					</td> -->
					<td align="left">
					...
					<table width=100%>				
						<tr>
							<td align="left">
								...
								<u>সংযুক্ত : &nbsp;&nbsp; বর্ণনামতে</u> <!-- <label id="filela" name="filela">0</label> &nbsp;সেট পাইলটেজ পেপার। -->
						</tr>
						<tr><td> <br/></td></tr>
						<tr>
							<td align="right">
