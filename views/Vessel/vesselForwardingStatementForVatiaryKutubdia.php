<table border="0" align="center" width="100%" style="border-collapse:collapse;">
    <tr>
        <td align="center" width="70%">
            ...
            <h2>VESSEL FORWARDING STATEMENT (<?php echo strtoupper($action);?>)</h2>
            <h2>(MARINE DEPARTMENT)</h2>
            <h2>STATEMENT OF SHIPS SAILED FROM <?= $action=="Vatiary"?"BHATIARY":"KUTUBDIA";?> ANCHOAGE.</h2>
            <h2>DURING THE MONTH 
            <?php 
                //echo $filedt;
            ...
            <?php if($action == "Vatiary"){?>
            <h2>FOR PORT DUES, TUG HIRE CHARGE & PILOTAGE CHARGE</h2>
            <?php } ?>
        </td>				
    </tr>	
</table>
...
?>
    <tr align="center">
        ...
        <td align="center" style="font-size: 12pt;"><?php echo $departData[$i]['agent'];?></td>
...
<table border="0" align="center" width="100%" style="border-collapse:collapse;margin-top:10px;page-break-inside:avoid;">
    <tr>
