...
-->
	...
	<BODY>
		...
		<div style="background-color: lightblue;height:1050px;">
				...
				<tr>
					<td align="left">1.</td>
					<td align="left" style="width:200px; font-size: 12px;">VESSEL NAME :   <u>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php $vsl=$rtnVesselDetails_igm[0]['Vessel_Name']; if( $vsl==""){ echo $rsltn4ForVsl; } else echo $vsl; ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </u></td>
								<td align="left" style="width:200px; font-size: 12px;">CALL SIGN :<u>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $radioCallSign; ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </u></td>
								<td align="left" style="width:200px; font-size: 12px;">FLAG : <u>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $flagValue; ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </u></td>
											</tr>
											<tr>
												<td align="left">2.</td>
											...
											<tr>                                
												<td align="left">3.</td>
								<td align="left" style="width:200px; font-size: 12px;">GRT : <u>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $grtValue;?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </u></td>
								<td align="left" style="width:200px; font-size: 12px;">NRT : <u>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $nrtValue;?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </u></td>
												<td align="left" style="width:160px; font-size: 12px;">DECK CARGO : <u>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $rtnVesselDetails_igm[0]['Deck_cargo']?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </u></td>
											</tr>
											<tr>
												<td align="left">4.</td>
								<td align="left" style="width:250px; font-size: 12px;">LOA : <u>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $loaCm;?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </u></td>
					...
					<table class="tbl" width="100%" border ='0' cellpadding='0' cellspacing='0' >
						...
						<td colspan="4" >
							<?php 
								if($rtn_vsl_arrival_info[0]['photo_base_64'] != "" || $rtn_vsl_arrival_info[0]['photo_base_64'] != null){ ?><img height="50px" width="190px" src="data:image/jpeg;charset=utf-8;base64,<?php echo $rtn_vsl_arrival_info[0]['photo_base_64']; ?>"/> <?php } ?></td>
						</tr>
						...
						<td colspan="4" >
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							<u>
								&nbsp;&nbsp;&nbsp;&nbsp;<?php if($rtn_vsl_arrival_info[0]['sign_arraival']!=""){echo $rtn_vsl_arrival_info[0]['sign_arraival'];} else {echo $rtn_vsl_arrival_info[0]['mooring_frm_time'];} ?>&nbsp;&nbsp;&nbsp;&nbsp;
						...
						<tr><td colspan="4">&nbsp;</td></tr>
								<tr><td colspan="4">&nbsp;</td></tr>
						<tr>
									<td colspan="4" >  <?php if(count($rtn_vsl_arrival_info)>0) { ?> <img height="50px" width="190px" src="http://cpatos.gov.bd/tosapi/ahm_pilot_signature/<?php echo @$rtn_vsl_arrival_info[0]['pilot_login'];?>.png"/> <?php  } else { echo ""; } ?></td>	
									<td colspan="4" ></td>
									<td colspan="1"></td>
						</tr>
						<tr>
		...
		<div style="page-break-after: always;background: #eaf9a7; height:1050px;">
			<table class="tbl" width="100%" border ='0' cellpadding='0' cellspacing='0' >
				...
				<tr align="left">
					<td colspan="4"><font size="2px">1. VESSEL NAME : <u><?php $vsl=$rtnVesselDetails_igm[0]['Vessel_Name']; if( $vsl==""){ echo $rsltn4ForVsl; } else echo $vsl; ?></u></font></td>
				...
				<tr align="left">
					<td colspan="4">3. GRT : <u><?php echo $grtValue; ?></u></td>
					<td colspan="3">NRT : <u><?php echo $nrtValue; ?></u></td>
					<td colspan="3">DECK CARGO : <u><?php echo $rtnVesselDetails_igm[0]['Deck_cargo']; ?></u></td>
				</tr>
				<tr align="left">
					<td colspan="4">4. LOA : <u><?php echo $loaCm; ?></u></td>
					<td colspan="6" class="lbl">MAX FW DRAUGHT : <u><?php echo $beamCm; ?></u></td>
				...
				<tr align="left">
					<td colspan="10" class="lbl">6. LOCAL AGENT : <u><?php echo $localAgent; ?></u></td> 
				...
				<tr>
					<!--td colspan="4" class="lbl">
						<?php if($rslt_show_current_data[0]['photo_base_64'] != "" || $rslt_show_current_data[0]['photo_base_64'] != null){ ?>
							<img height="50px" width="190px" src="data:image/jpeg;charset=utf-8;base64,<?php echo $rslt_show_current_data[0]['photo_base_64']; ?>"/>
						<?php } ?>
					</td-->	
					
					<td colspan="4" class="lbl">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<u><?php if(count($rslt_show_current_data)>0) { echo date("Y-m-d", strtotime($rslt_show_current_data[0]['mooring_frm_time'])); } else {echo "";} ?></u></td>	
				...
				<tr>
					...
					<tr><td colspan="10" class="lbl"></td></tr>
					<tr>
						<td colspan="4" class="lbl">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <?php if(count($rslt_show_current_data)>0) { ?> <img height="50px" width="190px" src="http://cpatos.gov.bd/tosapi/ahm_pilot_signature/<?php echo @$rslt_show_current_data[0]['pilot_login'];?>.png"/> <?php  } else { echo ""; } ?></td>	
						<td colspan="6" class="lbl">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
					</tr>
					<tr>
		...
		<div style="background: #E6E45A; font-family: Times New Roman;font-size: 10px; height:1050px;">
			<table class="tbl" width="100%" border ='0' cellpadding='0' cellspacing='0' >
				...
				<tr align="left">
					<!--td colspan="4">
						1.&nbsp;&nbsp;&nbsp;VESSEL NAME : <u><?php $vsl=$rtnVesselDetails_igm[0]['Vessel_Name']; if( $vsl==""){ echo $rsltn4ForVsl; } else echo $vsl; ?></u>
					</td-->
					<td colspan="4">
						1.&nbsp;&nbsp;&nbsp;VESSEL NAME : <u><?php echo $vesselName; ?></u>
					</td>
				...
				<tr align="left">
						<td colspan="3">3.&nbsp;&nbsp;&nbsp;GRT : <u><?php echo $grtValue; ?></u></td>
						<td colspan="3">NRT : <u><?php echo $nrtValue; ?></u></td>
						<td colspan="4">DECK CARGO : <u><?php echo $rtnVesselDetails_igm[0]['Deck_cargo']; ?></u></td>
				</tr>
				<tr align="left">
						<td colspan="4">4.&nbsp;&nbsp;&nbsp;LOA : <u><?php echo $loaCm; ?></u></td>
						<td colspan="6">MAX FW DRAUGHT : <u><?php echo $beamCm; ?></u></td>
				</tr>
				<tr align="left">
				...
				<tr align="left">
						<td colspan="3">
							7.&nbsp;&nbsp;&nbsp;NAME OF PILOT : <u><?php if($chk_igm_id>0) { echo $rtnVesselDetails_depart[0]['pilot_name']; } else { echo "---------"; } ?></u>
						</td>
						<td colspan="2">
							BOARDED AT : <u><?php if($chk_igm_id>0) { echo $rtnVesselDetails_depart[0]['pilot_on_board']; } else { echo "--------"; } ?></u>
						</td>
					...
					<tr><td colspan="4">&nbsp;</td></tr>
						...
						<td colspan="4" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							<u>&nbsp;&nbsp;&nbsp;&nbsp;
								<?php if($rtnVesselDetails_depart[0]['sign_arraival']!=""){echo $rtnVesselDetails_depart[0]['sign_arraival'];} else 
								{echo date("Y-m-d", strtotime($rtnVesselDetails_depart[0]['mooring_to_time']));}  ?>&nbsp;&nbsp;&nbsp;&nbsp;
							</u>
						</td>	
						<!--td colspan="4" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<u>&nbsp;&nbsp;&nbsp;&nbsp;<?php echo "2018-09-26";?>&nbsp;&nbsp;&nbsp;&nbsp;</u></td-->
						<td colspan="4">------------------------------------------------------------</td>		
					...
					<tr><td colspan="10" class="lbl"></td></tr>
					<tr>
						<td colspan="4" class="lbl">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <?php if(count($rtnVesselDetails_depart)>0) { ?> <img height="50px" width="190px" src="http://cpatos.gov.bd/tosapi/ahm_pilot_signature/<?php echo @$rtnVesselDetails_depart[0]['pilot_login'];?>.png"/> <?php  } else { echo ""; } ?></td>	
						<td colspan="6" class="lbl">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
					</tr>
					<tr>
						<td colspan="4" class="lbl">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;--------------------</td>	
