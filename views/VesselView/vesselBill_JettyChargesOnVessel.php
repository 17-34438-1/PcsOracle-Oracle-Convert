		...
		<div align ="center">
			<table align="center" width="95%">
				...
				<tr>
					...
					<td align="left" style="width:25%">: &nbsp;&nbsp;<?php echo $bill_rslt[0]['created'];?></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td align="left"></td>
					<td align="left" style="width:10%">Flag</td>
					<td align="left" style="width:25%">: &nbsp;&nbsp;<?php echo $bill_rslt[0]['flagcountry'];?></td>
				</tr>
				<tr>
			...
			<table align="center" width="95%">
				...
				<tr>
					...
					<td align="right" ><?php echo $bill_rslt[$i]['totbsd']; ?></td>											
					<td align="right" ><?php echo $bill_rslt[$i]['vatbd']; ?></td>											
				</tr>
				<?php  
				} 
				?>
				<tr>
					...
					<td style="border-top: 1px solid black;" align="right"><?php echo number_format($grandTotUSD,4); ?></td>
					<td style="border-top: 1px solid black;"></td>
					<td style="border-top: 1px solid black;"></td>
				</tr>
				<tr>
					...
					<td style="border-top: 1px solid black;"></td>
					<td style="border-top: 1px solid black;" align="right"><?php echo $grandTotBDT; ?></td>
					<td style="border-top: 1px solid black;" align="right"><?php echo $grandTotVAT; ?></td>
				</tr>
			...
			<table align="center" width="85%">
				<tr>
					<td><b>Inward TK</b> <?php echo numtowords($grandTotBDT) ?></td>
				</tr><tr>
					<td><b>Inward VAT</b> <?php echo numtowords($grandTotVAT) ?></td>
				</tr>
			</table>
