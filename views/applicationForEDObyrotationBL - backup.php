	...
	{	
		...
		else
		{
			...
			{							
				...
				{
					alert("Wrong Combination of Rotation and BL");
	...
	<div class="col-lg-6">						
		<div class="panel-body">
			...
			<form class="form-horizontal form-bordered" method="POST" 
				action="<?php echo site_url("ShedBillController/applicationForEDObyrotationBLentry") ?>" onsubmit="return validate();">
				<div class="form-group">
					<!--label class="col-md-3 control-label">&nbsp;</label-->
					<div class="col-md-12">		
						<div class="input-group mb-md">
							<span class="input-group-addon span_width">Rotation No <span class="required">*</span></span>
							<input type="text" name="rot_no" id="rot_no" class="form-control login_input_text" autofocus= "autofocus" tabindex="1" placeholder="Rotation No" required>
						</div>
						<div class="input-group mb-md">
						...
						<div class="input-group mb-md">
							<span class="input-group-addon span_width">BE No</span>
							<input type="text" name="be_no" id="be_no" class="form-control login_input_text" tabindex="3" placeholder="Bill of Entry No">
						</div>
						<div class="input-group mb-md">
							<span class="input-group-addon span_width">BE Date</span>
							<input type="date" name="be_date" id="be_date" class="form-control login_input_text" tabindex="4">
						</div>
						<div class="input-group mb-md">
							<span class="input-group-addon span_width">Office Code</span>
							<input type="text" name="office_code" id="office_code" class="form-control login_input_text" tabindex="5" placeholder="Office Code">
						</div>
					</div>									
