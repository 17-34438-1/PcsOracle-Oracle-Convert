...
<html>
	<table align="center" width="95%">
		...
		<tr>
			<td  align="center" style="font-size:14px;"><b>(Removal Tally Book)</b></td>
		</tr>	
		<tr>
			<td  align="center"><b>COPY TO BE RETURNED TO PARENT SHED</b></td>
		</tr>	
		<tr><td align="center"><font size="4"><b><?php echo "ROT: ".$rotation; ?></b>
			&nbsp;&nbsp;&nbsp;&nbsp; ARRIVAL DATE: <?php echo $result[0]['ATA']; ?>
			&nbsp;&nbsp;&nbsp;&nbsp; C/L DATE: <?php echo $landingDt; ?></font></td>
		...
		<tr>
			<td align="center"><font size="4">The cargo of S.S -  <?php echo $result[0]['V_NAME']; ?> &nbsp;&nbsp;&nbsp;Ex. Shed ___________
			transferred to Shed No. ____/AUCTION  in wagon No.<b><u>By paper</u></b></font>
			</td>	
		</tr>
		</table>
		...
		<tr>
			...
			<td align="center"><nobr><b>RL_NO.</b></nobr></td>
			<td align="center"><nobr><b>RL_DATE</b></nobr></td>
			<td align="center"><nobr><b>OBPC_NO</b></nobr></td>
			<td align="center"><nobr><b>OBPC_DATE</b></nobr></td>
			<td align="center"><nobr><b>REMARKS</b></nobr></td>
		</tr>
	...
	<tr>
		<td><b>Date ________________Posted &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Manifest Clerk.</b></td>
		<td><b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Tally Clerk.</b></td>
	</tr>
	</table>
<?php
