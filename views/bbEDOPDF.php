<table border="0" align="center" width="90%" style="margin-bottom:0px;">
	<tr>
...
<table border="0" style="border-collapse:collapse;font-size:12px;margin-top:10px;margin-bottom:0px;" align="center" width="85%">
	<tr>
		<td>EDO No : <?php echo $edo_number; ?></td>
		<td></td>
		<td></td>
	</tr>
	<tr>
		<td>Date : <?php echo $edoUploadingTime; ?></td>
		<td></td>
		<td></td>
	</tr>
	<tr>
	...
	<tr>	
		<td>Deputy Traffic Manager(OPS)</td>
		<td></td>		
		<td></td>
	</tr>
	<tr>	
	...
	<tr>	
		<td>Chittagong</td>
		<td></td>		
		<td align="right"><b>Print Date : </b><?php echo date("Y-m-d H:i:s"); ?></td>
	</tr>
</table>
<table border="1" style="border-collapse:collapse;margin-top:0px;" align="center" width="85%">
	<form method="POST" enctype="multipart/form-data" action="<?php echo site_url("Report/shedDeliveryOrderInfoEntry") ?>">
		<tr>
			<th colspan="4" valign="center" align="center" style="font-size:20px;"><b>AGENT DELIVERY ORDER</b></th>
		...
		<tr>
			...
			<td>
				<b>Reg No</b><br><?php echo $Import_Rotation_No;?>
			</td>
		</tr>
		<tr>
			<td>
			...
			<td colspan="2" rowspan="4" valign="top">
				...
				<!--p>
					<font style="margin-left:2px;margin-right:4px;color:#000000;"><b>EDO No:</b></font> <?php echo $edo_number; ?><br>
				</p>
				<p>
				...
				<p>
					<font style="margin-left:2px;margin-right:4px;color:#000000;"><b>R No:</b></font> <?php echo $r_no;?><br>
				</p>
				<p>
					<font style="margin-left:2px;margin-right:4px;color:#000000;"><b>R No Date:</b></font> <?php echo $r_no_date;?><br>
				</p>
				<!--p>
		...
		<tr>
			...
			<td colspan="2" valign="top">
				...
				<p>
					<?php echo $exporter_name;?><br>
					<?php echo $exporter_address;?>
				</p>
			</td>
		</tr>
		<tr>
			<th valign="top" align="center" rowspan="2">No of Packages</th>
			<th valign="top" align="center" rowspan="2"><nobr>Kind of Packages</nobr></th>
			<th valign="top" align="center" rowspan="2">Description of Goods</th>
			<th valign="top" align="center" rowspan="2">Marks and Numbers</th>
			<th valign="top" class="center" colspan="2">Quantity</th>
		</tr>
		<tr>
			<th valign="top" class="center">Net Quantity</th>
			<th valign="top" class="center">Gross Quantity</th>
		</tr>
		<tr>
		...
		<tr>
			...
			<td colspan="2" align="center">
				<b>Please Deliver to C&F:  </b> <?php echo $cnfName;?>
			</td>
			<td colspan="2" align="center">
		...
		<tr>
			<td colspan="2" align="center" style="border-right:0px solid black;">
				<b>Remarks : </b> 
			</td>
			<td colspan="4" style="border-left:0px solid black;">
				<?php echo $remarks;?>
			</td>
		</tr>
</table>
...
<table border="0" style="border-collapse:collapse;text-align:center;" align="center" width="85%">
	<tr>
		...
		<td width="33%" align="center">
			________________________<br>Authorized Signature
		</td>
	</tr>
</table>