			...
			<div class="col-lg-12">						
				<section class="panel">
					...
					<div class="panel-body">
						<form class="form-horizontal form-bordered" id="myform" method="POST" action="<?php echo site_url('report/berthOperatorWiseExportContainerListView') ?>"
						target="_blank">
							...
							<div class="form-group">
								...
								<div class="col-md-6">
									<div class="input-group mb-md">
										...
										<input type="date" name="fromdate" id="fromdate" class="form-control" value="<?php echo date("yy/m/d"); ?>">
									</div>
									<div class="input-group mb-md">
										<span class="input-group-addon span_width">To Date:</span>
										<input type="date" name="todate" id="todate" class="form-control" value="<?php echo date("yy/m/d"); ?>">
									</div>
