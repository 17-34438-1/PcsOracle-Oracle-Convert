	...
	function addBillToTable(e)
	{
		...
		else
		{
			...
			if (confirm("Do you want to Generate Bill?") == true) 
			{
				...
				var url="<?php echo site_url('ajaxController/getBillDetails')?>?verify_num="+verify_num+"&unstfDt="+unstfDt+"&uptoDt="+uptoDt+"&rpc="+rpc+"&hcCharge="+hcCharge+"&scCharge="+scCharge+"&vatInfo="+vatInfo+"&mlwf="+mlwf;
				// alert(url);
								...
								<td>	 
									<table align="center" border="0" width="700px">	
										<tr align="left">
											...
											<td>
												<input type="text" class="form-control" style="width:120px;" tabindex="1" id="verify_num"  name="verify_num" onblur="getBillData(this.value);" autofocus/>
										...
										<fieldset>
											...
											<table height="217px">
												...
												<tr>
													<td> BILL FOR</td>
													<td>:</td>
													<td><input tabIndex="2" type="text" class="form-control" style="width:130px; height:30px;" id="bill_for"  name="bill_for" list="forBill"/>
										...
										<div class="right_tbl_div" align="right" style="width:250px;">
											<table height="120px;">
												<tr>
													<td>TOTAL PORT</td>
													<td>:</td>
													<td><input type="text" class="total_port form-control" id="total_port" style="width : 100px" name="total_port" value=0 /></td>
												</tr>
												<tr>
													<td>TOTAL VAT</td>
													<td>:</td>
