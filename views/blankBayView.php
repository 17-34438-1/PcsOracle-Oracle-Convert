...
?>
	<table align="center" cellspacing="0" cellpadding="0">		
		<tr>
			<td></td>
			<td colspan="<?php if($rowbay->centerLineA==1 or $rowbay->gapLineA==1) echo $maxCol+1; else echo $maxCol;?>" class="nogrid" align="center" valign="bottom">
				<b><?php echo "Bay ".$title; ?></b>
			</td>
		</tr>
		<!-- Row leble start -->
		<tr>
