...
<table border="0" style="border-collapse:collapse;" align="center" width="85%">
    <tr>
        ...
        <td style="width: 10%; font-size: 10px; text-align: right;">
            <span><b>Birth Op :</b></span><span> <b><?php  echo $VESSELDATA[0]['BERTH']?></b></span>
        </td>
       
    </tr>
    <tr>
        <td style="width: 10%; font-size: 10px; text-align: left;">
            <span><b>ATA :</b></span><span> <b><?php  echo $VESSELDATA[0]['ETA']?></b></span>
        </td>
        <td style="width: 10%; font-size: 10px; text-align: center;">
            <span><b>ATD :</b></span><span> <b><?php  echo $VESSELDATA[0]['ETD']?></b></span>
        </td>

        <td style="width: 10%; font-size: 10px; text-align: right;">
            <span><b>Birth :</b></span><span> <b><?php  echo $VESSELDATA[0]['BERTH']?></b></span>
        </td>
    ...
    <tbody>
        <tr>
            ...
            <?php  
             ...
             if($ACTUAL_BL == $dataIGM['BL_NO'].trim()){
               ?>
