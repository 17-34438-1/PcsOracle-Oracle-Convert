...
?>
<?php 
		 $row_rotationno=count($rotation)>0?$rotation[0]['Import_Rotation_No']:$igmMasterList[0]['Import_Rotation_No'];
         echo form_open('breakbulk/BBIGMController/BBIGMSubDetailsHtmlSerch');
 ...
 ?>
    <div class="table-responsive">
		...
		<input type="hidden" name="myflag" value="53">
            ...
            <input type="hidden" name="rotation" value="<?php echo $row_rotationno; ?>">
			...
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			<b>IMPORT ROTATION NO :</b> <b><?php echo $row_rotationno;?></b>
