...
<table border="0" style="border-collapse:collapse;" align="center" width="85%">
    <tr>
        <td style="width: 10%; font-size: 10px; text-align: left;">
            <span><b>VESSEL NAME :</b></span><span> <b><?php  echo $BLDATA[0]['VESSEL_NAME']?></b></span>
        </td>
        <td style="width: 10%; font-size: 10px; text-align: right;">
            <span><b>ROTATION :</b></span><span> <b><?php  echo $BLDATA[0]['ROTATION']?></b></span>
        </td>
    </tr>
</table>
<table border="1" style="border-collapse:collapse;" align="center" width="85%">    
    <thead>
        <tr>
            ...
            <th style="text-align: center; font-size: 10px;">CONSINEE AND NOTIFY PARTY </th>
        </tr>
    </thead>
    <?php 
     foreach($BLDATA as $data){?>
    <tbody>
        <tr>
            ...
            <td style="text-align: center;"><?php  echo $data['CONSINEE_NOTIFY'];?></td>
        </tr>
    </tbody>
    <?php } ?>
