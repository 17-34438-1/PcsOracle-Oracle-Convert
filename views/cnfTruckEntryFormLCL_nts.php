					...
					<section class="panel form-wizard" id="w4">
						...
						<section class="panel">
							<div class="panel-body">
								<form class="form-horizontal form-bordered" method="POST" action="<?php echo site_url('LCL/cnfTruckEntryLCL') ?>" name="myform" onsubmit="return(validation());" style="padding:12px 20px;">
				...
				<div class="col-md-12">
					<div class="toggle" data-plugin-toggle data-plugin-options='{ "isAccordion": true }'>
						<section class="toggle <?php if($editVal==0  && $payForm==0){echo "active";} ?>">
							<label>Container & Cargo Information</label>
								...
								<div class="panel-body">
									...
									?>
										<div class="row">
											...
											<div class="col-md-3">
												<?php echo $rotation = $rtnVerifyReport[0]['import_rotation']?>
											</div>
										</div>
										<div class="row">
											<div class="col-md-2">
										...
										<div class="row">
											...
											<div class="col-md-3">
												...
												<?php 
													if($cont_status!="FCL")
														$container = $rtnVerifyReport[0]['cont_number'];
										...
										<div class="row">
											...
											<div class="col-md-3">
												<?php //if(isset($rslt_posYardBlock[0]['currentPos']))echo $rslt_posYardBlock[0]['currentPos'];
													...
													$igm_type_query = "SELECT igm_type FROM lcl_dlv_assignment WHERE rot_no = '$rotation' AND bl_no = '$blNo' AND igm_sup_dtl_id='$igm_id' LIMIT 1";
													$igm_type_rslt=mysqli_query($con_cchaportdb,$igm_type_query);
													$igm_type = "";
													while($igmRow=mysqli_fetch_object($igm_type_rslt)){
														$igm_type = $igmRow->igm_type;
													}

													if($igm_type=='sup_dtl')
													{
														$check_tally_sql="SELECT shed_loc,shed_yard FROM shed_tally_info WHERE cont_number='$container' AND import_rotation='$rotation' AND igm_sup_detail_id='$igm_id'";
													}
													else
													{
														$check_tally_sql="SELECT shed_loc,shed_yard FROM shed_tally_info WHERE cont_number='$container' AND import_rotation='$rotation' AND igm_detail_id='$igm_id'";	
													}

													$check_tally=mysqli_query($con_cchaportdb,$check_tally_sql);
													$loc = "";
													$yard = "";
													while($locRow=mysqli_fetch_object($check_tally)){
														$loc = $locRow->shed_loc;
														$yard = $locRow->shed_yard;
													}
													echo $loc;
												?>
											</div>
						...
						<section class="toggle <?php if($editVal==0 && $payForm==0){echo "active";} ?>">
							...
							<div class="toggle-content">
								<div class="panel-body">
									<!--form class="form-horizontal" id="truckDtlForm" name="truckDtlForm" method="post" action="<?php echo site_url('LCL/deliver_2'); ?>" onsubmit="return chkConfirm()"-->
									<form class="form-horizontal" id="truckDtlForm" name="truckDtlForm" method="post" action="<?php echo site_url('LCL/jettySarkarEntry'); ?>" onsubmit="return chkConfirm()">
										...
										<div class="form-group">
											...
											?>
												<div class="row">
													<div class="col-sm-12 text-center">
														<button type="submit" value="Save" name="deliver" class="btn btn-primary" <?php if($totalTruck!=0 && $totalTruck==$totalTruckOut){echo "disabled";} ?> > 
														<?php if($jetty_sirkar_id!=null){ ?>
															Update
														<?php }else{ ?>
															Save
														<?php } ?> 
												...
												<table class="table table-bordered table-hover table-striped">
													...
													<tr>
														...
														<!-- <td class="text-center">
															<form class="form-horizontal" id="truckDtlEditForm" name="truckDtlEditForm" method="post" action="<?php echo site_url('LCL/jettySarkarEntry'); ?>" >
																<input type="hidden" id="contNo" name="contNo" value="<?php echo $rtnVerifyReport[0]['cont_number']?>"> 
																<input type="hidden" id="rotNo" name="rotNo" value="<?php echo $rtnVerifyReport[0]['import_rotation']?>">
																<input type="hidden" id="blNo" name="blNo" value="<?php echo $blNo; ?>">
																<input type="hidden" id="cont_status" name="cont_status" value="<?php echo $cont_status; ?>">
						...
						<section class="toggle <?php if($editVal == 1 || $addVal == 1 || $payVal == 1){echo "active";} ?>">
							...
							<div class="toggle-content">
								<div class="panel-body">
									...
									<form method="post" action="<?php echo site_url('LCL/addTruckToDoDtlLCL'); ?>" onsubmit="return chkValidTruckInfo()">
										<input type="hidden" id="vrfyOtherDataId" name="vrfyOtherDataId" value="<?php echo $vrfyOtherDataId; ?>" />
										<input type="hidden" id="contNo" name="contNo" value="<?php echo $rtnVerifyReport[0]['cont_number']?>"> 
										<input type="hidden" id="rotNo" name="rotNo" value="<?php echo $rtnVerifyReport[0]['import_rotation']?>">
										<input type="hidden" id="blNo" name="blNo" value="<?php echo $blNo; ?>">
									...
									<div class="table-responsive">
										<table id="truckInfoTbl" class="table table-bordered  table-hover table-striped mb-none" cellspacing="2" cellpadding="2" align="left">
												...
												<tr>
													...
													<td align="center">
														<form method="post" action="<?php echo site_url('LCL/cnfTruckEntryLCL'); ?>">
													...
													<td align="center">
														<p class="m-none">
															<form method="post" action="<?php echo site_url('LCL/cnfTruckPayForm'); ?>">
														...
														<p class="m-none">
														<form action="<?php echo site_url('LCL/checkoutbyOnline'); ?>" method="POST">
																<input type="hidden" id="payAmt" name="payAmt" value="57.5" />
						...
						<section class="toggle <?php if($payForm==1){echo "active";} ?>" id="payment">
							...
							<div class="toggle-content">
								<div class="panel-body">
									<form class="form-horizontal" id="paymentDtlForm" name="paymentDtlForm" method="post" action="<?php echo site_url('LCL/cnfTruckPay'); ?>" onsubmit="return confirmPay()">
										<input type="hidden" id="contNo" name="contNo" value="<?php echo $rtnVerifyReport[0]['cont_number']?>"> 
										...
										<div class="form-group">
											...
											<div class="col-md-4">		
												<div class="input-group mb-md">
													...
													<select class="form-control" id="payMethod" name="payMethod" required onchange="btncng(this.value)">
