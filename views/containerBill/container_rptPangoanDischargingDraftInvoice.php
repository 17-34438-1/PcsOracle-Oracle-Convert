...
<body>	
		...
		<div align ="center">
			<table align="center" width="95%">
				...
				<tr>
					...
					<td align="left">: &nbsp; DISCHARGING BILL (PCT) <!--?php echo $bill_rslt[0]['vesselName'];?--></td>
					<td align="left"></td>
			...
			<table align="center" width="95%">
				...
				<tr>
					...
					<td align="left" ><?php if ($bill_rslt[$i]['usd']!="" or  null) echo $bill_rslt[$i]['usd'];  echo $bill_rslt[$i]['Particulars']; echo '   ('.$bill_rslt[$i]['wpn'].')';?></td>
					...
					<td align="right"><?php $sum= $bill_rslt[$i]['amt'] + $bill_rslt[$i]['vat']; echo number_format($sum,2); $sumTotal=$sumTotal+$sum;?></td>	
				</tr>
				<?php  } ?>
				<tr>
					<td colspan="9">
				...
				<tr>
					<td align="center"><nobr> 20 => </nobr><?php echo $bill_rslt[0]['qtytot20'];?></td>
					<td align="center"><nobr> 40 => </nobr><?php echo $bill_rslt[0]['qtytot40'];?></td>
					<td align="center"><nobr> 45 => </nobr><?php echo $bill_rslt[0]['qtytot45'];?></td>
		...
		<!--div class="text-right mr-lg">
			...
			<!--form name="view_bill" id="view_bill" action="<?php echo site_url("BillControllerView/viewContainerBill"); ?>" method="post" target="_blank">
				<input type="text" name="draftNumber" id="draftNumber" value="<?php echo $bill_list[$i]['draft']; ?>" />
				<input type="text" name="draft_view" id="draft_view" value="<?php echo $bill_list[$i]['pdf_draft_view_name']; ?>" />
				<input type="text" name="printBtn" id="printBtn" value="1" />
				<input name="print_container_bill" id="print_container_bill" type="submit" value="Print"  class="btn btn-primary btn-sm fa fa-print" />
			</form>
