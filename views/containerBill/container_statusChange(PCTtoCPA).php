...
<body>	
		<div align ="center">
			<table align="center" width="95%" border="0">
				<tr>
					<td align="left" style="width:13%">Bill No</td>
				...
				<tr>
					...
					<td align="left" style="width:2%">:</td>
					<td align="left"> Status Change Bill (PCT to CPA)<!--?php echo $bill_rslt[0]['vesselName'];?--></td>
					<td align="left"></td>
				...
				<tr>
					...
					<td align="left" style="width:2%">:</td>
					<td style="align:justified"> <?php echo $bill_rslt[0]['payCustomerId'];?></td>
					<td align="left"></td>
			...
			<table align="center" width="95%" border='0'>
				...
				<tr>
					...
					<td align="right"><?php echo $bill_rslt[$i]['days2'];?></td>
