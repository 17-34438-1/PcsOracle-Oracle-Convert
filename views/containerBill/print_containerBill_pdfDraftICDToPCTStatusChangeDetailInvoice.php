		...
		<div align ="center">
			<table align="center" width="95%" style="font-size:14px;">
				...
				<tr>
					...
					<!--td align="left">: &nbsp;&nbsp;<?php echo date($rslt_detail[0]['created']);?></td-->
			...
			<table align="center" width="98%" style="font-size:13px;">
                ...
                $preLoc_qu="SELECT inv_goods.destination 
				FROM inv_unit 
				INNER JOIN inv_goods ON inv_goods.gkey=inv_unit.goods
				WHERE inv_unit.gkey=$gkey";
				$rslt_detail2=$this->bm->dataSelect($preLoc_qu);
                $preloc="";	
                if($rslt_detail2[0][DESTINATION]){				
