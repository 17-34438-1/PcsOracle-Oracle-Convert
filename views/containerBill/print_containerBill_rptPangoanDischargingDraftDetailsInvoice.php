...
<body>	
		<div align ="center">
			<table align="center" width="90%" style="font-size:13px;">
				...
				<tr>
					...
					<td align="left"><nobr>:&nbsp;&nbsp;<?php echo $rslt_detail[0]['ibVisitId'];?></nobr></td>
					<td align="left"></td>
					<td align="left">Date </td>
					<td align="left"><nobr>:&nbsp;&nbsp;<?php echo $rslt_detail[0]['billing_date'];?></nobr></td>
					<td align="left"></td>
			...
			<table align="center" width="95%" style="font-size:13px;">
				<tr>
					<td colspan="7">
				...
				<?php
					...
					WHERE inv_unit.gkey=$mis_billing_details_gkey";
			...
			<table align="center" width="85%" style="font-size:13px;">	
				<tr>
					<td colspan="17">&nbsp;</td>
				</tr>
				<tr>
