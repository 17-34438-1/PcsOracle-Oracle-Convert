		...
		<div align ="center">
			<table align="center" width="98%">
				...
				<tr>
					...
					<td  align="left">: &nbsp;&nbsp;<?php echo $concustomername;?></td>
					<td align="left"></td>
					<td align="left"></td>
					<td align="left"></td>
					<td align="left"></td>
			...
			<table align="center" width="95%">
				...
				<tr>
					...
					<td align="center" style="width:60px">IMT ROT</td>
					<td align="center" style="width:70px">IMT ATA</td>
					<td align="center">C.L.DATE</td>
					<td align="center" style="width:60px">From Depo</td>
					<td align="center">L.ISSUE DATE</td>
				...
				if(isset($rslt_detail2[0]['DESTINATION'])){
				$preloc =$rslt_detail2[0]['DESTINATION'];
				}else{
					$preloc="";   
				}
				?>
