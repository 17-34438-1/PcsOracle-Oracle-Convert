		...
		<div align ="center">
			...
			<table align="center" width="100%" style="font-size:13px;">
				...
				<tr>
					...
					<td align="center" style="width:15%"><nobr>AMOUNT BDT</nobr></td>
					<td align="center" style="width:10%"><nobr>VAT BDT</nobr></td>
					<td align="center"><nobr>TOTAL BDT</nobr></td>
				...
				?>
					...
					<td align="center"><font style="border: 0px solid black;"><?php echo $i+1;?></font></td>
					<td align="left" ><?php if ($bill_rslt[$i]['usd']!="" or  null) echo $bill_rslt[$i]['usd'];  echo $bill_rslt[$i]['Particulars'];?></td>
					<td align="left"><?php echo $bill_rslt[$i]['size'];
								...
								else if($bill_rslt[$i]['size']=="40")
								{
									...
									$size45++;
					?></td>
					<td align="center"><?php echo number_format($bill_rslt[$i]['height'],1);?></td>
					<td align="center"><?php echo $bill_rslt[$i]['qty'];?></td>
				
					<td align="center"><?php echo $days2 ; ?></td>
					<td align="center" style="width:15%"><?php echo number_format($bill_rslt[$i]['rateBilled'],4); ?></td>
					<td align="center" style="width:15%"><?php echo number_format($bill_rslt[$i]['amt'],2);												
										$sumAmt=$sumAmt+$bill_rslt[$i]['amt'];?></td>
					<td align="center" style="width:15%"><?php echo number_format($bill_rslt[$i]['vat'],2);
											$sumVat=$sumVat+$bill_rslt[$i]['vat'];?></td>
					<td align="center"><?php $sum= $bill_rslt[$i]['amt'] + $bill_rslt[$i]['vat'];
