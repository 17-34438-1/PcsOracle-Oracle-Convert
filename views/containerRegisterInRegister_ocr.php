					...
					<!-- start: page -->
						<div class="row">
							<div class="col-lg-12">						
								...
								<!-- <div class="form-group" align="center"><b>INWARD & OUTWARD CONTAINER OCR REGISTER </b></div> -->
				...
				<div class="form-group">
					...
					<form name= "myForm" onsubmit="return(validation());" action="<?php echo site_url("GateController/containerRegisterInRegisterView_ocr");?>" target="_blank" method="post">
						...
						<div class="input-group mb-md">
								...
								<div class="col-md-6">		
									<div class="input-group mb-md">
										...
										<div class="col-md-6">		
										<div class="input-group mb-md">
											<span class="input-group-addon span_width" >GATE NO:<span class="required">*</span></span>
