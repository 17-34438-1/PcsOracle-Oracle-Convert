...
<?php } else if($_SESSION['org_Type_id']==4) { ?>
	...
	<section role="main" class="content-body">
		...
		<?php 
			...
			) AS tbl WHERE berth IS NOT NULL ORDER BY sl,berth";
		...
		<div class="col-md-12 col-lg-12 col-xl-12">
			<div class="row">
				...
				<?php
					while($row=mysqli_fetch_object($query)){
						...
						$queryTotImportCont=mysqli_query($con_sparcsn4,$sqlGetTotImportCont);
						$rowTotImportCont=mysqli_fetch_object($queryTotImportCont);
						...
						$sqlGetTotImportTeus="SELECT SUM(IF(size>=40, 2, 1)) AS teus FROM (
							...
							$queryTotImportTeus=mysqli_query($con_sparcsn4,$sqlGetTotImportTeus);
							$rowTotImportTeus=mysqli_fetch_object($queryTotImportTeus);
						...
						$queryTotImportDischargeCont=mysqli_query($con_sparcsn4,$sqlGetTotImportDischargeCont);
						$rowTotImportDischargeCont=mysqli_fetch_object($queryTotImportDischargeCont);
						...
						$queryTotExportCont=mysqli_query($con_sparcsn4,$sqlGetTotExportCont);
						$rowTotExportCont=mysqli_fetch_object($queryTotExportCont);
			...
			INNER JOIN sparcsn4.ref_country ON sparcsn4.ref_country.cntry_code=sparcsn4.vsl_vessels.country_code
			INNER JOIN sparcsn4.ref_bizunit_scoped ON sparcsn4.ref_bizunit_scoped.gkey=sparcsn4.vsl_vessel_visit_details.bizu_gkey
			WHERE sparcsn4.argo_carrier_visit.phase='20INBOUND' AND DATE(sparcsn4.argo_visit_details.eta) BETWEEN '$date' AND DATE_ADD('$date', INTERVAL 1 DAY) AND sparcsn4.ref_country.cntry_code!='BD'
			ORDER BY sparcsn4.argo_carrier_visit.phase,sparcsn4.vsl_vessels.name) AS tbl ORDER BY eta,berth";
			$query=mysqli_query($con_sparcsn4,$strQuery);
			$j=0;
		...
		<div class="col-md-12 col-lg-12 col-xl-12">
			...
			INNER JOIN sparcsn4.ref_country ON sparcsn4.ref_country.cntry_code=sparcsn4.vsl_vessels.country_code
			INNER JOIN sparcsn4.ref_bizunit_scoped ON sparcsn4.ref_bizunit_scoped.gkey=sparcsn4.vsl_vessel_visit_details.bizu_gkey
			WHERE DATE(sparcsn4.argo_visit_details.etd)='$date' AND sparcsn4.ref_country.cntry_code!='BD'
			union all 
			SELECT sparcsn4.vsl_vessel_visit_details.vvd_gkey,sparcsn4.vsl_vessels.name, vsl_vessel_visit_details.ib_vyg,
			IFNULL(sparcsn4.vsl_vessel_visit_details.flex_string03,sparcsn4.vsl_vessel_visit_details.flex_string02) AS berthop,
			(SELECT sparcsn4.argo_quay.id FROM sparcsn4.argo_quay
			...
			INNER JOIN sparcsn4.ref_country ON sparcsn4.ref_country.cntry_code=sparcsn4.vsl_vessels.country_code
			INNER JOIN sparcsn4.ref_bizunit_scoped ON sparcsn4.ref_bizunit_scoped.gkey=sparcsn4.vsl_vessel_visit_details.bizu_gkey
			WHERE DATE(sparcsn4.argo_visit_details.etd)='$date' AND sparcsn4.ref_country.cntry_code='BD' and sparcsn4.vsl_vessels.notes='BD'
			) AS tbl ORDER BY eta,berth";
			$query=mysqli_query($con_sparcsn4,$strQuery);
			$j=0;
