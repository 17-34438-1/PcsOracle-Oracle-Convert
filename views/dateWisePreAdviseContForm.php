			...
			<div class="col-lg-12">						
				<section class="panel">
					...
					<div class="panel-body">
						<form class="form-horizontal form-bordered" id="myform" method="POST" action="<?php echo site_url('report/dateAndRoatinWisePreAdviseContView') ?>"
						target="_blank">
							...
							<div class="form-group">
								...
								<div class="col-md-6">
									...
									<div class="input-group mb-md">
										...
										<input type="date" name="fromdate" id="fromdate" class="form-control" value="<?php echo date("yy/m/d"); ?>" required>
									</div>
