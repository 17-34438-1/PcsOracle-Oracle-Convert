...
SELECT mis_exp_unit_preadv_req.rotation,ctmsmis.mis_exp_unit_preadv_req.gkey AS gkey,mis_exp_unit_preadv_req.cont_id AS cont_id,mis_exp_unit_preadv_req.cont_mlo,
mis_exp_unit_preadv_req.cont_size AS cont_size,mis_exp_unit_preadv_req.isoType,'' AS loc,'' AS emtyDate,
mis_exp_unit_preadv_req.rotation,mis_exp_unit_preadv_req.cont_status,mis_exp_unit_preadv_req.pod,
goods_and_ctr_wt_kg,seal_no,last_update,cont_mlo, 
...
WHERE  mis_exp_unit_preadv_req.rotation='$ddl_imp_rot_no' AND DATE(last_update)='$fromdate' ORDER BY cont_mlo
 ";
	...
	$sql2="SELECT NAME FROM vsl_vessel_visit_details
	...
	";
		...
		// print_r( $strQuery2Res);
		$rowShortName=oci_execute($strQuery2Res);
		// $results=array();
...
<tr align="center">
		...
		<td><?php if($rowShortName->NAME) echo $short_name; else echo "&nbsp;";?></td>
