			...
			<div class="col-lg-12">						
				<section class="panel">
					<div class="panel-body">
						<form class="form-horizontal form-bordered" method="POST" action="<?php echo base_url().'index.php/Report/date_wise_icd_report_action'; ?>" target="_blank" id="myform" name="myform" onsubmit="return validate()">
							<div class="form-group">
								<label class="col-md-3 control-label">&nbsp;</label>
								<div class="col-md-6">		
									<div class="input-group mb-md">
										<span class="input-group-addon span_width">ICD Entry Date	 <span class="required">*</span></span>
										<input type="date" name="icd_entry_date" id="icd_entry_date" class="form-control" value="">
									</div>												
								</div>
