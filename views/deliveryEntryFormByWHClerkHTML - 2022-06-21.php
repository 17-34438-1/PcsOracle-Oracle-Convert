	...
	{			
		...
		{			
			...
			if(imgNumber>0){
				...
				var imagePath = "<?php echo site_url('"+imgpath+bl+"/"+rot+"/"+verifyNo+"')?>";
			...
			document.getElementById("exitNoteNum").value=jsonData.deliveryList[0].exit_note_number;
			document.getElementById("paperFileDate").value=jsonData.deliveryList[0].paper_file_date;
			document.getElementById("cusOrderNo").value=jsonData.deliveryList[0].cus_rel_odr_no; 
			document.getElementById("cusOrderDate").value=jsonData.deliveryList[0].cus_rel_odr_date;
			document.getElementById("billOfEntryDate").value=jsonData.deliveryList[0].be_date;
			document.getElementById("billOfEntryNo").value=jsonData.deliveryList[0].be_no;
			...
			if(jsonData.seaInfo.length!=0 )
		 	{
				...
				if(jsonData.seaInfo[0].cnf_lic != jsonData.deliveryList[0].cnf_lic_no)	
				{
			...
			document.getElementById("cnf_lic").value=jsonData.deliveryList[0].cnf_lic_no;						
			document.getElementById("cnfName").value=jsonData.deliveryList[0].cnf_name;						
			document.getElementById("date").value=jsonData.deliveryList[0].cnfDate;						
					...
					<table border=0 align="right" >
						<tr>
							<td align="right" height>
								<form name= "btnForm" onsubmit="return validateform();" action="<?php echo site_url("Report/xml_conversion_action");?>"  method="post" target="_blank">
					...
					<div class="table-responsive">								
						...
						<caption style="padding-bottom:0px;"><font size="2" color="blue"><u> Search </u></font></caption>
							<tr>
								...
								<td align="center"><nobr><input style="width:100px;" class="form-control" type="text" id="rotNo" name="rotNo" <?php if($doFormFlag==1){?> value="<?php echo $rotNo;?>" <?php }?> tabindex="1" ></nobr></td>
								<th>VERIFY NO:</th>
					...
					<div class="table-responsive">							
						...
						<caption style="padding-bottom:0px;"><font size="2" color="blue"><u> IGM Information </u></font></caption>
							...
							<tr>
								...
								<td><nobr><input style="width:150px;" class="form-control" type="text"  id="blNo" name="blNo" <?php if($doFormFlag==1){?> value="<?php echo $blNo;?>"  autofocus <?php }?> onblur="getBlInfo(this.value)" tabindex="2"></nobr></td>
								<!--td><nobr><input style="width:140px;" type="text"  id="blNo" name="blNo" <?php if($doFormFlag==1){?> value="<?php echo $blNo;?>"  autofocus <?php }?> onblur="getSeaInfo()" tabindex="2"><font color='red'><b>*</b></font></nobr></td-->
								<th><nobr>MLO:</nobr></th>
