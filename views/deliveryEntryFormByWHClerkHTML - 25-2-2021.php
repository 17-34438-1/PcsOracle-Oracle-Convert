<script language="JavaScript">
	...
	{			
		...
		{			
			...
			document.getElementById("cnf_lic").value=jsonData.deliveryList[0].cnf_lic_no;						//2019-08-01 - intakhab
			document.getElementById("cnfName").value=jsonData.deliveryList[0].cnf_name;						//2019-08-01 - intakhab
