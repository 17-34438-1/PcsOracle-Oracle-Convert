	...
	{			
		...
		{			
			...
			if(imgNumber>0){
				...
				var imgpath="igmViewController/DeliveryOrderImgShow/0/";
			...
			if(jsonData.deliveryList[0].verify_number!="" || jsonData.deliveryList[0].verify_number!=" ")
			{			
		...
		<div class="col-md-12">
			<section class="panel">
				...
				<div class="panel-body">
					...
					<div class="table-responsive">								
						...
						<caption style="padding-bottom:0px;"><font size="2" color="blue"><u> Search </u></font></caption>
							<tr>
								...
								<th>ROTATION NO:<font color='red'><b>*</b></font></th>
								...
								<td align="center">
										...
										<a href="" target="_BLANK" class="btn btn-primary" id="doPdf" style="visibility:hidden;text-decoration:none;padding:8px;margin-left:10px;" >
											View DO 
										</a> 
									</td>
									...
									<td align="center">
										<a href="" target="_BLANK" class="btn btn-primary" id="doImage" style="text-decoration:none;visibility:hidden;padding:8px;">
											DO Attachment 
										</a>
					...
					<div class="table-responsive">													
						<table width="100%">
						<caption style="padding-bottom:0px;"><font size="2" color="blue"><u> CNF Info </u></font></caption>	
							<tr> 
								<td>
									<table >
										<tr>
