		...
		<div class="col-md-12">
			<section class="panel">
				...
				<div class="panel-body">
					...
					<form name= "myForm" onsubmit="return validate();" action="<?php echo site_url("ReleaseOrderController/deliveryEntryForm");?>" method="post">
					...
					<!-- <div class="panel-body">														 -->
						<table align="center" id="mytbl" style="background-color: #c3ecf9;">								
							...
							<tr>
								<td>
									<?php if(isset($verifyInfo)){ echo $verifyInfo;}?>
								</td>
							</tr>
						</table>
					<!-- </div> -->
