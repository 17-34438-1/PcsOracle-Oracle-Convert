...
<table width="100%" border ='0' cellpadding='0' cellspacing='0'>
	<tr bgcolor="#ffffff" align="center" height="100px">
		<td colspan="13" align="center">
			<table border=0 width="100%">
				...
				<tr align="center">
					<td colspan="12">
						<font size="4"><b>DG Container Delivery Report</b></font>
					</td>
				</tr>
				<tr align="center">
					<?php if($sCriteria=="rotation") { ?>
					<td colspan="12">
						<font size="4">Rotation : <strong><?php echo $srotation; ?></strong></font>
					</td>
					<?php } else if($sCriteria=="date") { ?>
					<td colspan="12">
						<font size="4">From : <strong><?php echo $fdate; ?></strong>  To : <strong><?php echo $ldate; ?></strong></font>
					</td>
					<?php } ?>
				</tr>
			</table>
	...
	<tr align="center">
			...
			<th style="border-width:3px;">Delivery Date</th>
		...
		if($sCriteria=="rotation")
			...
			{
				$strCrt = "DATE(igm_detail_container.Delivery_Status_date) between '$fdate' and '$ldate'";	
				$strSupCrt = "DATE(igm_sup_detail_container.Delivery_Status_date) between '$fdate' and '$ldate'";
			}
			
			
	
		$query=mysqli_query($con_cchaportdb,"SELECT DISTINCT igms.id AS id,igms.mlocode,igms.IGM_id AS IGM_id,igms.Import_Rotation_No AS Import_Rotation_No,
		...
		while($row=mysqli_fetch_object($query)){
			...
			$subQuery = oci_parse($con_sparcsn4_oracle,"SELECT inv_unit_fcy_visit.flex_string04 AS rl_no,inv_unit_fcy_visit.flex_string04 AS rl_date,inv_unit_fcy_visit.flex_string07 AS obpc_number,
			...
			$row=oci_execute($subQuery);

			$rowSubQuery=oci_fetch_object($subQuery);			
		?>
		<tr align="center">
			...
			<td style="border-width:3px;"><?php if($row->Discharged_Status_date) echo $row->Discharged_Status_date; else echo "&nbsp;";?></td>
