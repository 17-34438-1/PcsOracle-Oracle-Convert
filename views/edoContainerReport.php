					...
					<section class="panel">
						...
						<div class="panel-body">
							<form class="form-horizontal form-bordered" id="myform" method="POST" 
								action="<?php echo site_url('EDOController/edoContainerReportPdf') ?>" target="_blank">
								<div class="form-group">
									...
									<div class="col-md-12" align="center">
										<label class="checkbox-inline">
											<input type="radio" id="rptType" name="rptType" value="pdf" checked> PDF
										</label>
										<label class="checkbox-inline">
											<input type="radio" id="rptType" name="rptType" value="excel"> Excel
										</label>										
									</div>
									<div class="row">
										<div class="col-sm-12 text-center">
