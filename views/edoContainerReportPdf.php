	...
	<table width="100%" style="border-collapse: collapse;" align="center">
	  <thead>
		...
		<tr bgcolor="#ffffff" height="50px">
			<th align="center" colspan="12"><font size="7"><b><?php echo $orgNAME; ?></b></font></th>
		</tr>
		<tr bgcolor="#ffffff" height="50px">
			<th align="center" colspan="12"><font size="6"><b>Container Report</b></font></th>
		</tr>
		<tr bgcolor="#ffffff" height="50px">
			<th align="center" colspan="12"><font size="6"><b>From Date : <?php echo $from_date; ?> To Date : <?php echo $to_date; ?></b></font></th>
		</tr>
		<tr>			
		...
		<?php for($i=0; $i < count($edoVerificationList); $i++) { ?>
				<tr border ='1' cellpadding='0' cellspacing='0' style="font-size:12px;  border-collapse: collapse;">
					...
					<td style="border:1px solid black; font-size:12px;  border-collapse: collapse;" align="center" align="center" colspan="12">
