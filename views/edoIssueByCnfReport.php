	...
	<table width="100%" style="border-collapse: collapse;" align="center">
		<thead>
			<tr bgcolor="#ffffff" height="50px">
				<th align="center" colspan="5">
					<img align="center" width="160px" style="margin:0px;padding:0px;" height="90px" 
					src="<?php echo ASSETS_ROOT_PATH?>images/cpa_logo.png">
				</th>
			</tr>
			<tr bgcolor="#ffffff" height="50px">
			...
			<tr bgcolor="#ffffff" height="50px">
				<th align="center" colspan="5"><font size="6"><b>Organization Wise EDO Summary Report</b></font></th>
			</tr>
			<tr bgcolor="#ffffff" height="50px">
			...
			<tr>			
				...
				<th style="border:1px solid black; font-size:15px;  border-collapse: collapse;" align="center" class="text-center" colspan="3">Total</th>
		...
		<?php for($i=0; $i < count($edoVerificationList); $i++) { ?>
				<tr border ='1' cellpadding='0' cellspacing='0' style="font-size:12px;  border-collapse: collapse;">
					...
					<td style="border:1px solid black; font-size:12px;  border-collapse: collapse;" align="center" colspan="3">
        ...
        <tr bgcolor="#ffffff" height="50px">
            ...
            <td style="border:1px solid black; font-size:12px;  border-collapse: collapse;"align="center" colspan="3"><font size="15px">
                <?php
                  $total=0;
