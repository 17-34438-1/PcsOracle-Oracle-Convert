...
<BODY>
	...
	<?php } 
		...
		header("Content-Disposition: attachment; filename=Container-List-ALL.xls;");
	...
	<tr>
		<td colspan="17" align="center"><img width="250px" height="80px" src="<?php echo ASSETS_WEB_PATH?>fimg/cpanew.jpg"></td>
	</tr>
	<?php } ?>
