...
<?php
	...
	$sqlLogTime=mysqli_query($con_ctmsmis,"select logDate,logBy from ctmsmis.mis_equip_log_in_out_info where logEquip='$row->eq' and logType='in' and  logDate $cond order by logDate limit 1");
	...
	$sqlLogOut=mysqli_query($con_ctmsmis,"select logDate from ctmsmis.mis_equip_log_in_out_info where logEquip='$row->eq' and logType='out' and  logDate $cond  order by logDate desc limit 1");
