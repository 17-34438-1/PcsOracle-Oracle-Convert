        ...
        <div class="col-lg-12">
            <section class="panel">
                ...
                <div class="panel-body">
                    ...
                    <div class="row ">
                        <form class="form-horizontal form-bordered  " id="myform" method="POST" action="<?php echo site_url('Vessel/savefireWorkServiceFormExtended') ?>" onsubmit="return validate('Are you sure?')">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
									...
									<div class="input-group mb-md">
                                        ...
                                        <input type="number" name="firemanHRS" id="firemanHRS" placeholder="Fireman(HRS)" class="form-control" >
                                    </div>	
									<div class="input-group mb-md">
                                        <span class="input-group-addon span_width">Fire Pump (HRS) :</span>
                                        <input type="number" name="firepumpHRS" id="firepumpHRS" placeholder="Fire Pump (HRS)"  class="form-control" >
                                    </div>	
									<div class="input-group mb-md">
                                        <span class="input-group-addon span_width">Fire Officer (HRS) :</span>
                                        <input type="number" name="fireofficerHRS" id="fireofficerHRS" placeholder="Fire Officer (HRS)"  class="form-control" >
                                    </div>
									<div class="input-group mb-md">
                                        <span class="input-group-addon span_width">Fire Engine (HRS) :</span>
                                        <input type="number" name="fireEngineHRS" id="fireEngineHRS" placeholder="Fire Engine (HRS)"  class="form-control" >
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-sm-12 text-center">
                                        <button type="submit" name="submit_login" id="submit"
                                            class="mb-xs mt-xs mr-xs btn btn-primary">Save & Forward</button>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-sm-12 text-center">
