				...
				<div class="invoice">
					...
					<div class="row">
						...
						<!--div class="col-sm-12 text-center">
							...
							?>
								<font size="5" color="green"><b></b><?php echo "Your payment is done." ;?></font>
							<?php
						...
						<div class="col-sm-12 text-center">
							...
							<?php
								...
								else if($paid_status == 1 and $gate_in_status==0)
								{
							?>
								<form method="POST" action="<?php echo site_url("ShedBillController/gateInStsCng") ?>"  onsubmit="return confirm('Are You Sure?');">
									<input type="hidden" name="id" id="id" value="<?php echo $id; ?>"/>
							...
							?>
								...
								<font size="5" color="green"><b></b><?php echo "Gate In Done" ?></font>
							<?php
								}																								
							?>
						</div>
