	...
	<div class="col-lg-12">						
		<section class="panel">
			<div class="panel-body">
				<form class="form-horizontal form-bordered" method="POST" action="<?php echo site_url("LCL/gateInDataSearch") ?>" onsubmit="return chkField();">
					...
					<div class="row">
						...
						<div class="col-sm-12 text-center">
							...
							?>
								...
								<form method="POST" action="<?php echo site_url("LCL/gateInStsCng") ?>"  onsubmit="return confirm('Are You Sure?');">
