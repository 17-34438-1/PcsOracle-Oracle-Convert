		...
		<section class="panel">
            ...
            <?php
				if($flag == 1)
				{
					...
					a.gkey, a.id AS cont_no, j.bl_nbr, k.gkey AS bizu_gkey, config_metafield_lov.mfdch_value,b.last_pos_slot,
					mfdch_desc, 
				...
				<div class="invoice">
					...
					<div class="row">
						<div class="col-sm-12 text-center">
							...
							?>
								<div class="col-sm-12 text-center">
									<font size="4" color="red"><b><?php echo $cont_number; ?> Container is Blocked!!</b></font>
								</div>
							<?php	
							}
							else
							{
								...
								<form method="POST" action="<?php echo site_url("ShedBillController/gateOutStsCng") ?>" onsubmit="return confirm('Are You Sure? ');">
									...
									<font size="5" color="green"><b></b><?php echo "Your all information is correct and payment is done now please gate out";?></font>
									<br/>
								...
								?>
										...
										<font size="5" color="red"><b></b><?php echo "You have Already used this ticket To Gate Out at: ". $gate_out_time;?></font>
									
									<?php
										}else if($gateFlag == 1){
									?>
										<font size="5" color="red"><b></b><?php echo "Gate out Completed!!!";?></font>
									<?php
										}
									}
								}
								...
								?>
										...
										<font size="5" color="red"><b></b><?php echo "Traffic have not confirmed yet";?></font>
									
								<?php
								}else if($cnf_chk_st == 0){
								?>
							
									<font size="5" color="red"><b></b><?php echo "C&F have not confirmed yet";?></font>
								
								<?php
								}else if($yard_security_chk_st == 0){
								?>
								
									<font size="5" color="red"><b></b><?php echo "Security have not confirmed yet";?></font>
								...
								?>
									...
									<font size='5' color="red"> Please try again after your processing done! </font>
							<?php
								}
							}
							?>
