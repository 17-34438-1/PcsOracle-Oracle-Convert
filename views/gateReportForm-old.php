					 ...
					 <table  border="0" align="center" cellspacing="0" cellpadding="0">
								...
								<div class="col-md-6">		
								 ...
								 <tr>
									<td>
										<div class="col-md-6">		
										<div class="input-group mb-md">
											<span class="input-group-addon span_width" style="width:150px;">Verification No :<span class="required">*</span></span>
								...
								<tr >
									<td>
										...
										<div class="col-md-6">		
										<div class="input-group mb-md">
											<span class="input-group-addon span_width" style="width:150px;">To Date:<span class="required">*</span></span>
											<input type="date" style="width:130px;" id="todate" name="todate" value="<?php date("Y-m-d"); ?>" disabled />
