<select name="txt_line" maxlength="50" class="form-control" onFocus="gsLabelObj(lbl_org_id,'#61BCEF','white')" onchange="myShowmlocode(this.value)">
                ...
                $qry=$_GET['q'];
				//Organization Name
				$resultcombo6 = mysqli_query($con_cchaportdb,"select  distinct Organization_Name,organization_profiles.id from organization_profiles inner join 
								igm_details 
