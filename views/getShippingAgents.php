<select name="ddl_Org_id" id="ddl_Org_id" maxlength="50" class="form-control" onFocus="gsLabelObj(lbl_org_id,'#61BCEF','white')" onBlur="gsLabelObj(lbl_org_id,'','')" onchange="myshowmloreport()">
