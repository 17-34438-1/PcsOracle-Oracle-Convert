			...
			<div class="col-lg-12">						
				<section class="panel">
					...
					<div class="panel-body">
						<form class="form-horizontal form-bordered" id="myform" method="POST" action="<?php echo site_url('report/icdContainerReportByRotationView') ?>"
						target="_blank">
							...
							<div class="form-group">
								...
								<div class="col-md-6">
									<div class="input-group mb-md">
										...
										<input type="text" name="ddl_imp_rot_no" id="txt_login" class="form-control">
									</div>
