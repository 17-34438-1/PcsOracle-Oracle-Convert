		...
		if (xmlhttp.readyState==4 && xmlhttp.status==200) 
		{
			...
			//alert(rs);
		      ...
		      if(result==0)
			  {
				...
				alert("Either it is a wrong combination of Rotation & BL OR all containers are forwarded");
			  }
			else
			{
								    ...
								    <div class="col-md-6">
											...
											<div class="row"  id="buttonSearch" style="display:none" >
												<div class="col-md-9 text-right">
													<button type="submit" name="bl_save" class="mb-xs mt-xs mr-xs btn btn-success">Save</button>
												</div>													
											</div>
											<div class="row">
