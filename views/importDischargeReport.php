    ...
    <tr bgcolor="#ffffff" height="50px">
		...
		for($i=0; $i < count($queryList); $i++) { 
			...
			?>
				...
				<tr border ='0' cellpadding='0' cellspacing='0' style="font-size:12px;  border-collapse: collapse;">
...
<div align ="center" style="margin:100px;">
	<table width="100%" style="border-collapse: collapse;" align="center" colspan="10" >
     ...
     <thead>
		...
		<tr>			
			<td style="border:1px solid black; font-size:12px;  border-collapse: collapse;" align="center" class="text-center" colspan="1" ><?php echo $countLadenTwenty;?></td>
			<td style="border:1px solid black; font-size:12px;  border-collapse: collapse;" align="center" class="text-center" colspan="1" ><?php echo $countLadenFourty;?> </td>
			<td style="border:1px solid black; font-size:12px;  border-collapse: collapse;" align="center" class="text-center" colspan="1" ><?php echo $countEmptTwenty;?></td>
			<td style="border:1px solid black; font-size:12px;  border-collapse: collapse;" align="center" class="text-center" colspan="1" ><?php echo $countEmptFourty;?></td>
			<td style="border:1px solid black; font-size:12px;  border-collapse: collapse;" align="center" class="text-center" colspan="1" ><?php echo $tuesLD;?></td>
			<td style="border:1px solid black; font-size:12px;  border-collapse: collapse;" align="center" class="text-center" colspan="1" ><?php echo $tuesMT;?></td>
			<td style="border:1px solid black; font-size:12px;  border-collapse: collapse;" align="center" class="text-center" colspan="1" ><?php echo $disCountLadenTwenty;?></td>
			<td style="border:1px solid black; font-size:12px;  border-collapse: collapse;" align="center" class="text-center" colspan="1" ><?php echo $disCountLadenFourty;?> </td>
			<td style="border:1px solid black; font-size:12px;  border-collapse: collapse;" align="center" class="text-center" colspan="1" ><?php echo $disCountEmptTwenty;?></td>
			<td style="border:1px solid black; font-size:12px;  border-collapse: collapse;" align="center" class="text-center" colspan="1" ><?php echo $disCountEmptFourty;?></td>
