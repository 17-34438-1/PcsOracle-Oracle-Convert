		...
		<div class="col-md-12">
			<section class="panel">
				...
				<div class="panel-body">
					<form class="form-horizontal form-bordered" name= "goodsReportForm" onsubmit="return(validate());" action="<?php echo site_url("report/itemWiseLyingSummaryDetailsReport");?>" method="post">
						<div class="form-group">
							...
							<div class="col-md-6">		
								...
								<div class="input-group mb-md">
									...
									<input type="text" style="width:200px;"  id="search_value"  name="search_value" list="forBill" class="form-control login_input_text" />
									<datalist id="forBill">
										<?php
								...
								<div class="input-group mb-md">
									...
									<input type="date" style="width:170px;" id="goodsfromdate" name="goodsfromdate" class="form-control login_input_text"/>
								</div>												
								<div class="input-group mb-md">
									<span class="input-group-addon span_width">To Date<span class="required">*</span></span>
									<input type="date" style="width:170px;" id="goodstodate" name="goodstodate" class="form-control login_input_text"/>
								</div>
								<div class="input-group mb-md">
