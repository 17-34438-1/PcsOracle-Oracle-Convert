<table align="center"  width="70%"  cellspacing="0" cellpadding="0">
								...
								<tr>
									...
									<th align="center" colspan="5" width="70%"  style="border: 1px solid black; color:black"><h2>Date : <?php echo $stmt_date;?></h2></th>
								</tr>	
								<tr>
								...
								<tr>
									...
									<td align="center" style="border: 1px solid black;"><?php echo $capacity;?></td>
									<td align="center" style="border: 1px solid black;"><?php echo $imp_lying;?></td>
									<td align="center" style="border: 1px solid black;"><?php echo $exp_lying;?></td>
									<td align="center" style="border: 1px solid black;"><?php echo $mty_lying;?></td>
									<td align="center" style="border: 1px solid black;"><?php echo $total_teus;?></td>
									<td align="center" style="border: 1px solid black;"><?php echo $last_24hrs;?></td>
									<td align="center" style="border: 1px solid black;"><?php echo $port_to_depo_laden;?></td>
									<td align="center" style="border: 1px solid black;"><?php echo $port_to_depo_mty;?></td>
									<td align="center" style="border: 1px solid black;"><?php echo $depo_to_port_laden;?></td>
									<td align="center" style="border: 1px solid black;"><?php echo $depo_to_port_mty;?></td>
									<td align="center" style="border: 1px solid black;"><?php echo $remarks;?></td>
								</tr>
								<tr>
