<script>
	...
	function validate2()
	{
		if( document.myform2.new_BL_No.value == "" )
		{
			alert( "Please Provide New BL no." );
			document.myform2.new_BL_No.focus() ;
			return false;
		}
		if( document.myform2.previous_BL_No.value == "" )
		{
			alert( "Please! Provide Previous BL." );
			document.myform2.previous_BL_No.focus() ;
			return false;
		}
		if( document.myform2.Submitee_Id.value == "" )
		{
			alert( "Please! Provide Submitee ID." );
			document.myform2.Submitee_Id.focus() ;
			return false;
		}
...
<section role="main" class="content-body">
			...
			<div class="col-lg-12">						
				<section class="panel">
					<div class="panel-body">
						<form class="form-horizontal form-bordered" method="POST" action="<?php echo site_url('IgmViewController/lateBLsubmissionMasterPerform'); ?>"  id="myform" name="myform">
	...
	<div class="col-lg-12">					
		<div class="panel-body">
			<section class="panel">
			<form class="form-horizontal form-bordered" method="POST" action="<?php echo base_url().'index.php/IgmViewController/lateBLsubmissionMasterAction'; ?>"  id="myform2" name="myform2" onsubmit="return(validate2());">
				      ...
				      <input type="hidden" id="final_submit" name="final_submit" value="<?php if(@$editFlag==1) echo $igm_data[0]['final_submit']; else "";?>">
				      <input type="hidden" id="mlocode" name="mlocode" value="<?php if(@$editFlag==1) echo $igm_data[0]['mlocode']; else "";?>">
				      <input type="hidden" id="file_clearence_date" name="file_clearence_date" value="<?php if(@$editFlag==1) echo $igm_data[0]['file_clearence_date']; else "";?>">
				      <!--input type="hidden" id="PFstatus" name="PFstatus" value="<?php if(@$editFlag==1) echo $igm_data[0]['PFstatus']; else "";?>">
				      <input type="hidden" id="PFstatusdt" name="PFstatusdt" value="<?php if(@$editFlag==1) echo $igm_data[0]['PFstatusdt']; else "";?>"-->
				      <input type="hidden" id="custom_check" name="custom_check" value="<?php if(@$editFlag==1) echo $igm_data[0]['custom_check']; else "";?>">
				      <input type="hidden" id="final_submit_date" name="final_submit_date" value="<?php if(@$editFlag==1) echo $igm_data[0]['final_submit_date']; else "";?>">
				      <input type="hidden" id="place_of_unloading" name="place_of_unloading" value="<?php if(@$editFlag==1) echo $igm_data[0]['place_of_unloading']; else "";?>">
				<div class="form-group">
					...
					<div class="col-md-6">
						<div class="input-group mb-md">
							<span class="input-group-addon span_width">Previous BL No <span class="required">*</span></span>
							<input type="text" name="previous_BL_No" id="previous_BL_No" class="form-control" value="<?php if(@$editFlag==1) echo $igm_data[0]['BL_No']; else "";?>" placeholder="Container height" readonly>
						</div>
					</div>
					<div class="col-md-6">
						<div class="input-group mb-md">
							<span class="input-group-addon span_width">New BL No <span class="required">*</span></span>
							<input type="text" name="new_BL_No" id="new_BL_No" class="form-control" value="" placeholder="BL No" >
						</div>
					</div>
					...
					<div class="col-md-6">
						<div class="input-group mb-md">
							...
							<input type="date" name="Bill_of_Entry_Date" id="Bill_of_Entry_Date" class="form-control" value="<?php if(@$editFlag==1) echo $igm_data[0]['Bill_of_Entry_Date']; else "";?>" placeholder="BE Date" >
						</div>
					</div>
					<div class="col-md-6">
						<div class="input-group mb-md">
					...
					<div class="col-md-6">
						<div class="input-group mb-md">
							<span class="input-group-addon span_width"> Submitee AIN <span class="required">*</span></span>
