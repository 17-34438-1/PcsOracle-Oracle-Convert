				...
				<div class="panel-body">
					<div class="table-responsive">
						...
						?>
							...
							<tr>
								<th style="background-color:#006bff45;">Discharge Time</th>
								...
								<th style="background-color:#006bff45;">Receive Pack</th>
								<td align="center"><b>:</b></td>
								<td><?php print($rtnContainerList[$i]['rcv_pack']); ?></td>
							</tr>
							<tr align="center">
								<th style="background-color:#006bff45;">Marks & Number</th>
								<td align="center"><b>:</b></td>
							...
							<tr align="center">
								...
								<td style="background-color:#006bff45;"><b>Discharge Time</b></td>
								<td align="center"><b>:</b></td>
							...
							<tr align="center">					
								...
								<td style="background-color:#006bff45;"><b>Rotation</b></td>
								<td align="center"><b>:</b></td>
							...
							<tr align="center">
								<td style="background-color:#006bff45;"><b>Dest.</b></td>
								<td align="center"><b>:</b></td>
								<td><?php if($contStatus!="FCL"){print($rtnContainerList[$i]['off_dock_id']);} ?></td>
		...
		<div class="table-responsive">
			<table class="table table-bordered table-striped table-hover" cellspacing="2" cellpadding="1"  width="60%" bgcolor="#2AB1D6" style="margin-right:180px">
				...
				<tr class="gridLight">
					...
					<td align="center"><?php echo $row->pos; ?></td>
