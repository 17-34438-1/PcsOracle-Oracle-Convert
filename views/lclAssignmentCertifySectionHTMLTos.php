		...
		<section class="panel">
			<div class="panel-body">
				<form class="form-horizontal form-bordered" method="POST" 
					action="<?php echo base_url().'index.php/Report/lclAssignmentCertifyListTos'; ?>"  id="myform" name="myform" onsubmit="return validateInitial()" style="padding:12px 20px;">
								...
								<td colspan="6">
									<div class="row">
										...
										<div class="col-sm-4" align="center">			
											<form action="<?php echo site_url('Report/releaseOrderView')?>" target="_blank" method="POST">		
												...
												<button type="submit"class="btn btn-primary" >Release Order (NTS)</button>
											</form> 
										</div>

										<div class="col-sm-4" align="left">			
											<form action="<?php echo site_url('Report/releaseOrderViewTos')?>" target="_blank" method="POST">		
												<input type="hidden" name="imp_rot" id="imp_rot" value="<?php echo $ddl_imp_rot_no; ?>" />
												<input type="hidden" name="bl_no" id="bl_no" value="<?php echo $ddl_bl_no; ?>" />
						...
						<form action="<?php echo site_url('Report/lclAssignmentVerify');?>" method="POST" name="myChkForm" onsubmit="return(validate());">
							...
							<table class="table table-bordered table-striped table-hover" cellspacing="2" cellpadding="1"  width="80%" bgcolor="#2AB1D6">
								...
								<tr class="gridDark">				
									...
									<td align="center"><b>:</b></td>
									<td><input type="number" class="form-control" value="<?php echo  $rtnContainerList[0]['update_ton']?>" name="strTonUpdt" style="width:200px;"/></td>
								</tr>
