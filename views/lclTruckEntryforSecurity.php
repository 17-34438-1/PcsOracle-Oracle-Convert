...
<section role="main" class="content-body">
	...
	<section class="panel panel-primary" id="panel-1" data-portlet-item="">
		<header class="panel-heading portlet-handler">
			...
			<form class="form-horizontal form-bordered" method="POST" action="<?php echo site_url('ShedBillController/lclTruckSearchforSecurity')?>" >
				...
				<form class="form-horizontal form-bordered" method="POST" action="<?php echo site_url('ShedBillController/lclTruckEntryforSecurity')?>" id="myform" name="myform" onsubmit="return validate()">
				...
				<div class="table-responsive" style="padding-top:20px;">
					<table id="truckInfoTbl" class="table table-bordered  table-hover table-striped mb-none" cellspacing="2" cellpadding="2" align="left">
							...
							<tr>
								...
								<td align="center">
									<form method="post" action="<?php echo site_url('ShedBillController/lclTruckEntryforSecurity'); ?>">
								...
								<td align="center">
									<p class="m-none">
										<form method="post" action="<?php echo site_url('ShedBillController/lcltruckPayBySecurity'); ?>">
		...
		<section class="panel panel-primary" id="panel-1" data-portlet-item="">
			...
			<div class="panel-body">
				<form class="form-horizontal" id="paymentDtlForm" name="paymentDtlForm" method="post" action="<?php echo site_url('ShedBillController/lcltruckPayBySecurity'); ?>" onsubmit="return confirmPay()">
