<script>
	...
	function getJettySrkr()
	{
		...
		if(data != "")
		{
			...
			var url = "<?php echo site_url('AjaxController/getJettySrkrLcl')?>?cont="+cont+"&rot="+rot+"&bl="+bl;	
	...
	<section class="panel panel-primary" id="panel-1" data-portlet-item="">
		<header class="panel-heading portlet-handler">
			...
			<div class="panel-body">
				<form class="form-horizontal form-bordered" method="POST" action="<?php echo site_url('ShedBillController/lcltruckEntryByDSForm')?>" id="myform" name="myform" onsubmit="return validate()">
					...
					<div class="form-group">
						...
						<div class="col-md-10">
							...
							<div class="input-group mb-md">
								...
								<input class="form-control" name="cnfAinNo" id="cnfAinNo" value="<?php if($flag == 1){echo $ain;}?>" <?php if($flag != 1){ echo "autofocus";} ?>/>
							...
							?>
								...
								<div class="input-group mb-md">
									<span class="input-group-addon span_width">Reg & BL</span>
									<select class="form-control" name="assignment" id="assignment" onblur="getJettySrkr()" autocomplete="off" <?php if(isset($editType)){ echo "disabled";} ?> <?php if($flag == 1){echo "autofocus";}?>>
										...
										<?php
											...
											{
												$cont_no = $data_assignment[$i]['cont_number'];
												...
												$result = $this->bm->chkBlockedContainerforTruckEntry($cont_no,$data_assignment[$i]['imp_rot_no'],$data_assignment[$i]['bl_no']);
												...
												// echo $truckAdded;
										?>	
											<option value="<?php echo $data_assignment[$i]['cont_number']."|".$data_assignment[$i]['imp_rot_no']."|".$data_assignment[$i]['cont_status']."|".$data_assignment[$i]['bl_no']."|".$igm_type."|".$igm_id."|".$data_assignment[$i]['verify_no']."|".$data_assignment[$i]['cp_no']."|".$data_assignment[$i]['cont_size']."|".$custom_block; ?>" <?php if( isset($editType) && $data_assignment[$i]['cont_number'] == $cont){echo "selected";}else if(isset($contNo) && $data_assignment[$i]['cont_number'] == $contNo){ echo "selected";}?>><?php echo $data_assignment[$i]['bl_no']." - ".$data_assignment[$i]['imp_rot_no']."  ( ".$truckAdded." Truck/s Added) "."(Shed: {$data_assignment[$i]['shed_loc']}) , {$custom_block}"; ?></option>
										<?php	
											}
										?>
									</select>
								...
								<div class="row">
									<div class="col-md-6">
										<div class="input-group mb-md">
											...
											<input class="form-control" list="driverPassList" name="driverPassNo" id="driverPassNo" value="<?php if(isset($editType) && count($rslt_trkEditInfo)>0){ echo $rslt_trkEditInfo[0]['driver_gate_pass'];}?>" onblur="getDriverInfo()" autocomplete="off" <?php if(isset($editType) && $editType == "Replace"){ echo "readonly";} ?> >
									...
									<div class="col-md-6">
										<div class="input-group mb-md">
											...
											<input class="form-control" list="assistantPassList" name="assistantPassNo" id="assistantPassNo" value="<?php if(isset($editType) && count($rslt_trkEditInfo)>0){ echo $rslt_trkEditInfo[0]['assistant_gate_pass'];}?>" onblur="getAssistantInfo()" autocomplete="off" <?php if(isset($editType) && $editType == "Replace"){ echo "readonly";} ?>>
								...
								<div class="row">
									<div class="col-md-6">
										<div class="input-group mb-md">
											<span class="input-group-addon span_width">Gate</span>
											<select name="gate" id="gate" class="form-control">
												<?php
													if(!is_null($this->session->userdata('gateData'))){
														$gateData = $this->session->userdata('gateData');
													}
												?>
												<!-- <option value="Gate 01" <?php //if(isset($editType)){if($rslt_trkEditInfo[0]['gate_no'] == "Gate 01"){ echo "selected";}} ?>>Gate 01</option>
												<option value="Gate 02" <?php //if(isset($editType)){if($rslt_trkEditInfo[0]['gate_no'] == "Gate 02"){ echo "selected";}} ?>>Gate 02</option>
												<option value="Gate 03" <?php //if(isset($editType)){if($rslt_trkEditInfo[0]['gate_no'] == "Gate 03"){ echo "selected";}} ?>>Gate 03</option>
												<option value="Gate 04" <?php //if(isset($editType)){if($rslt_trkEditInfo[0]['gate_no'] == "Gate 04"){ echo "selected";}} ?>>Gate 04</option>
												<option value="Gate 05" <?php //if(isset($editType)){if($rslt_trkEditInfo[0]['gate_no'] == "Gate 05"){ echo "selected";}} ?>>Gate 05</option>
												<option value="Gate CPAR" <?php //if(isset($editType)){if($rslt_trkEditInfo[0]['gate_no'] == "Gate CPAR"){ echo "selected";}} ?>>Gate CPAR</option>
												<option value="Gate NCY" <?php //if(isset($editType)){if($rslt_trkEditInfo[0]['gate_no'] == "Gate NCY"){ echo "selected";}} ?>>Gate NCY</option>
												<option value="Gate CCT-1" <?php //if(isset($editType)){if($rslt_trkEditInfo[0]['gate_no'] == "Gate CCT-1"){ echo "selected";}} ?>>Gate CCT-1</option>
												<option value="Gate CCT-2" <?php //if(isset($editType)){if($rslt_trkEditInfo[0]['gate_no'] == "Gate CCT-2"){ echo "selected";}} ?>>Gate CCT-2</option>
												<option value="Gate CCT-3" <?php //if(isset($editType)){if($rslt_trkEditInfo[0]['gate_no'] == "Gate CCT-3"){ echo "selected";}} ?>>Gate CCT-3</option>
												<option value="Gate NCT-1" <?php //if(isset($editType)){if($rslt_trkEditInfo[0]['gate_no'] == "Gate NCT-1"){ echo "selected";}} ?>>Gate NCT-1</option>
												<option value="Gate NCT-2" <?php //if(isset($editType)){if($rslt_trkEditInfo[0]['gate_no'] == "Gate NCT-2"){ echo "selected";}} ?>>Gate NCT-2</option>
												<option value="Gate NCT-3" <?php //if(isset($editType)){if($rslt_trkEditInfo[0]['gate_no'] == "Gate NCT-3"){ echo "selected";}} ?>>Gate NCT-3</option>
												<option value="Gate NCT-4" <?php //if(isset($editType)){if($rslt_trkEditInfo[0]['gate_no'] == "Gate NCT-4"){ echo "selected";}} ?>>Gate NCT-4</option>
												<option value="Gate OFY" <?php //if(isset($editType)){if($rslt_trkEditInfo[0]['gate_no'] == "Gate OFY"){ echo "selected";}} ?>>Gate OFY</option> -->

												<option value="Gate 01" <?php if(isset($editType)){if($rslt_trkEditInfo[0]['gate_no'] == "Gate 01"){ echo "selected";}}else if(isset($gateData)){if($gateData == 'Gate 01'){ echo 'selected';}} ?>>Gate 01</option>
												<option value="Gate 02" <?php if(isset($editType)){if($rslt_trkEditInfo[0]['gate_no'] == "Gate 02"){ echo "selected";}}else if(isset($gateData)){if($gateData == 'Gate 02'){ echo 'selected';}} ?>>Gate 02</option>
												<option value="Gate 03" <?php if(isset($editType)){if($rslt_trkEditInfo[0]['gate_no'] == "Gate 03"){ echo "selected";}}else if(isset($gateData)){if($gateData == 'Gate 03'){ echo 'selected';}} ?>>Gate 03</option>
												<option value="Gate 04" <?php if(isset($editType)){if($rslt_trkEditInfo[0]['gate_no'] == "Gate 04"){ echo "selected";}}else if(isset($gateData)){if($gateData == 'Gate 04'){ echo 'selected';}} ?>>Gate 04</option>
												<option value="Gate 05" <?php if(isset($editType)){if($rslt_trkEditInfo[0]['gate_no'] == "Gate 05"){ echo "selected";}}else if(isset($gateData)){if($gateData == 'Gate 05'){ echo 'selected';}} ?>>Gate 05</option>
												<option value="Gate CPAR" <?php if(isset($editType)){if($rslt_trkEditInfo[0]['gate_no'] == "Gate CPAR"){ echo "selected";}}else if(isset($gateData)){if($gateData == 'Gate CPAR'){ echo 'selected';}} ?>>Gate CPAR</option>
												<option value="Gate NCY" <?php if(isset($editType)){if($rslt_trkEditInfo[0]['gate_no'] == "Gate NCY"){ echo "selected";}}else if(isset($gateData)){if($gateData == 'Gate NCY'){ echo 'selected';}} ?>>Gate NCY</option>
												<option value="Gate CCT-1" <?php if(isset($editType)){if($rslt_trkEditInfo[0]['gate_no'] == "Gate CCT-1"){ echo "selected";}}else if(isset($gateData)){if($gateData == 'Gate CCT-1'){ echo 'selected';}} ?>>Gate CCT-1</option>
												<option value="Gate CCT-2" <?php if(isset($editType)){if($rslt_trkEditInfo[0]['gate_no'] == "Gate CCT-2"){ echo "selected";}}else if(isset($gateData)){if($gateData == 'Gate CCT-2'){ echo 'selected';}} ?>>Gate CCT-2</option>
												<option value="Gate CCT-3" <?php if(isset($editType)){if($rslt_trkEditInfo[0]['gate_no'] == "Gate CCT-3"){ echo "selected";}}else if(isset($gateData)){if($gateData == 'Gate CCT-3'){ echo 'selected';}} ?>>Gate CCT-3</option>
												<option value="Gate NCT-1" <?php if(isset($editType)){if($rslt_trkEditInfo[0]['gate_no'] == "Gate NCT-1"){ echo "selected";}}else if(isset($gateData)){if($gateData == 'Gate NCT-1'){ echo 'selected';}} ?>>Gate NCT-1</option>
												<option value="Gate NCT-2" <?php if(isset($editType)){if($rslt_trkEditInfo[0]['gate_no'] == "Gate NCT-2"){ echo "selected";}}else if(isset($gateData)){if($gateData == 'Gate NCT-2'){ echo 'selected';}} ?>>Gate NCT-2</option>
												<option value="Gate NCT-3" <?php if(isset($editType)){if($rslt_trkEditInfo[0]['gate_no'] == "Gate NCT-3"){ echo "selected";}}else if(isset($gateData)){if($gateData == 'Gate NCT-3'){ echo 'selected';}} ?>>Gate NCT-3</option>
												<option value="Gate NCT-4" <?php if(isset($editType)){if($rslt_trkEditInfo[0]['gate_no'] == "Gate NCT-4"){ echo "selected";}}else if(isset($gateData)){if($gateData == 'Gate NCT-4'){ echo 'selected';}} ?>>Gate NCT-4</option>
												<option value="Gate OFY" <?php if(isset($editType)){if($rslt_trkEditInfo[0]['gate_no'] == "Gate OFY"){ echo "selected";}}else if(isset($gateData)){if($gateData == 'Gate OFY'){ echo 'selected';}} ?>>Gate OFY</option>
											</select>
										</div>
									</div>
								</div>
				...
				<div class="table-responsive" style="padding-top:20px;">
					<table id="truckInfoTbl" class="table table-bordered  table-hover table-striped mb-none" cellspacing="2" cellpadding="2" align="left">
							...
							<tr>
								...
								<td align="center">
									<form method="post" action="<?php echo site_url('ShedBillController/lcltruckEntryByDSForm'); ?>">
								...
								<td align="center">
									<p class="m-none">
										<form method="post" action="<?php echo site_url('ShedBillController/lcltruckPayByAdmin'); ?>">
		...
		<section class="panel panel-primary" id="panel-1" data-portlet-item="">
			...
			<div class="panel-body">
				<form class="form-horizontal" id="paymentDtlForm" name="paymentDtlForm" method="post" action="<?php echo site_url('ShedBillController/lcltruckPayByAdmin'); ?>" onsubmit="return confirmPay()">
