    ...
    <section class="panel">
			...
			<div class="panel-body">
				...
				<table class="table table-bordered table-responsive table-hover table-striped mb-none" id="datatable-default">
					...
					<tbody>
						<?php  
							for($i=0;$i<count($rslt_marineVslLot_N4);$i++) 
							{ 
						?>
						<tr class="gradeX">
						    <td align="center"> <?php echo $i+1; ?> </td>
							<td align="center"> <?php echo $rslt_marineVslLot_N4[$i]['lot_dt']; ?> </td>
							<td align="center"> <?php echo $rslt_marineVslLot_N4[$i]['lot_id']; ?> </td>
                            <td align="center"> <?php echo $rslt_marineVslLot_N4[$i]['tot_vsl']; ?> </td>
							<td align="center"> <?php echo $rslt_marineVslLot_N4[$i]['forward_at']; ?> </td>
							<td align="center"> <?php echo $rslt_marineVslLot_N4[$i]['forward_by']; ?> </td>
							<td align="center"> <?php echo $rslt_marineVslLot_N4[$i]['vsl_lot_type']; ?> </td>							
							<td align="center">
								<form action="<?php echo site_url("Vessel/marineVslLot_N4_List")?>" method="POST" target="_blank">
									<input type="hidden" name="lotVslListId" value="<?php  echo $rslt_marineVslLot_N4[$i]['id']; ?>"/>
									<input class="btn btn-xs btn-primary" type="submit" name="btnViewLotVsl_N4" value="View Vessel"/>
								</form>
							</td>
						</tr>
						<?php
