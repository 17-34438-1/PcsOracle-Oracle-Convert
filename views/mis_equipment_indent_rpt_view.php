...
<BODY>
	...
	<?php 
		...
		$result=mysqli_query($con_sparcsn4,$getAllYard);
		$i=0;
	...
	?>
		<tr>
			...
			$row_mc="";
				...
				$result_mc=mysqli_query($con_sparcsn4,$get_mc_50_qry);
				$row_mc=mysqli_fetch_object($result_mc);
			?>
		...
		$rslt_equip_unstuffing=mysqli_query($con_sparcsn4,$sql_equip_unstuffing);
		
		while($row_equip_unstuffing=mysqli_fetch_object($rslt_equip_unstuffing))
		{
		...
		<tr>
			...
			<td align="center" style="border:1px solid black">
				<?php 
					...
					$rslt_mc_50t=mysqli_query($con_sparcsn4,$query_mc_50t);
					$row_mc_50t=mysqli_fetch_object($rslt_mc_50t);
			...
			<td align="center" style="border:1px solid black">
				<?php 
					...
					$rslt_mc_30t=mysqli_query($con_sparcsn4,$query_mc_30t);
					$row_mc_30t=mysqli_fetch_object($rslt_mc_30t);
			...
			<td align="center" style="border:1px solid black">
				<?php 
					...
					$rslt_mc_20t=mysqli_query($con_sparcsn4,$query_mc_20t);
					$row_mc_20t=mysqli_fetch_object($rslt_mc_20t);
			...
			<td align="center" style="border:1px solid black">
				<?php 
					...
					$rslt_mc_10t=mysqli_query($con_sparcsn4,$query_mc_10t);
					$row_mc_10t=mysqli_fetch_object($rslt_mc_10t);
			...
			<td align="center" style="border:1px solid black">
				<?php 
					...
					$rslt_3t=mysqli_query($con_sparcsn4,$query_3t);
					$row_3t=mysqli_fetch_object($rslt_3t);
					if($row_3t->flt_3t) 
					{
						echo $row_3t->flt_3t; 
			...
			<td align="center" style="border:1px solid black">
				<?php 
					...
					$rslt_5t=mysqli_query($con_sparcsn4,$query_5t);
					$row_5t=mysqli_fetch_object($rslt_5t);
					if($row_5t->flt_5t) 
					{
						echo $row_5t->flt_5t; 
			...
			<td align="center" style="border:1px solid black">
				<?php 
					...
					$rslt_10t=mysqli_query($con_sparcsn4,$query_10t);
					$row_10t=mysqli_fetch_object($rslt_10t);
			...
			<td align="center" style="border:1px solid black">
				<?php 
					...
					$rslt_20t=mysqli_query($con_sparcsn4,$query_20t);
					$row_20t=mysqli_fetch_object($rslt_20t);
					if($row_20t->flt_20t) 
					{
