    ...
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
		  ...
		  echo form_open(base_url().'index.php/login/myPasswordChangeUpdateForm',$attributes);
		...
		<div class="img">
			 ...
			 <table style="border:solid 1px #ccc;" width="350px" align="center" cellspacing="0" cellpadding="0">
				...
				<table border="0" width="400px" align="center">
								...
								<tr>
									<td align="center" colspan="2"><h3>Changed Password</h3></td>
								</tr>
								
								<tr><br />
									<td align="right" ><label for="user_name">User Name:<em>&nbsp;</em></label></td>
									<td align="left" >
									  <input type="text" name="user_name"  id="user_name"value="<?php echo $login_id;?>" style="width:130px;" readonly>
									</td>
								</tr>
								<tr><br />
								...
								<tr>
									<td align="right" colspan="2"></td>
									<h2><span><?php echo $ptitle; ?></span> </h2>
								</tr>
								<tr>
