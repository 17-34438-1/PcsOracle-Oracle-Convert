		...
		<div class="col-lg-12">						
			<section class="panel">
				<div class="panel-body">
					<form class="form-horizontal form-bordered" method="POST" action="<?php echo base_url().'index.php/IgmViewController/checkTheIGMList'; ?>" target="_blank" id="myform" name="myform" onsubmit="return validate()">
						<div class="form-group">
							...
							<div class="col-md-6">	
								...
								<div class="input-group mb-md">
									...
									<input type="text" name="txt_imp_rot" id="txt_imp_rot" class="form-control" placeholder="Import Rotation No">
								</div>
								<div class="input-group mb-md">
									<span class="input-group-addon span_width">Line No <span class="required">*</span></span>
									<input type="text" name="txt_line" id="txt_line" class="form-control" placeholder="Line No">
								</div>
								<div class="input-group mb-md">
									OR
								</div>
							...
							<div class="row">
								<div class="col-sm-12 text-center">
									<button type="submit" id="submit" name="add" class="mb-xs mt-xs mr-xs btn btn-success">OK</button>
								</div>													
							</div>
