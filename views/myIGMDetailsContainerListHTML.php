        ...
        <div class="article">
          ...
          <div class="clr"></div>
			...
			<table border="0" width="100%">
				...
				<TR valign="center" >
					<?php
					echo form_open(base_url().'index.php/igmViewController/myIGMContainerList',@$attribute);
				...
				<TR>
					...
					<table>
						<tr class='gridDark'>
							...
							<td>ISO CODE</td>
							<td>Cont. Category</td>
							<td>Cont. Gross Weight</td>
							<td>Cont. Tare Weight</td>
							<td>Sealed NO.</td>
							<td>Cont. Status</td>
							<td>Cont. Type</td>
							...
							/*	if ($row->type=='S')
								...
								*/
								...
								//echo $sql_str;
								$sql=mysqli_query($con_ctmsmis,$sql_str);
								...
								$sql22=mysqli_query($con_ctmsmis,"select ref_equip_type.id from inv_unit
								...
								if(@$row22=mysqli_fetch_object($sql22)){
									$isocode=$row22->id;
								}
			    ...
			    <tr  <?php if($igmContainerList[$i]['symbol']=="S") {?> bgcolor="lightgreen"<?php } else { ?>class='gridLight'<?php } ?>>
					...
					<td><?php echo $igmContainerList[$i]['Notify_name'];?></td>
