...
<table>
<tr>
		<td style="color:darkblue;font-size:16.0px;font-weight:bold">Import Rotation No:<?php print(@$old_data[0]['Import_Rotation_No']);?>&nbsp;&nbsp;VESSEL NAME:<?php print(@$old_data[0]['Vessel_Name']);?></td>
	</tr>
</table>
...
?>		
			...
			Search By:&nbsp;			
						<select name="txt_Org_Id_for_search"  maxlength="50" onFocus="gsLabelObj(lbl_org_id12,'#61BCEF','white')" onBlur="gsLabelObj(lbl_org_id12,'','')">
							<?php
								$resultcombo = mysqli_query($con_cchaportdb,"SELECT id,Organization_Name  FROM organization_profiles where Org_Type_id=2 ORDER BY Organization_Name");
								while ($rowcombo = mysqli_fetch_object($resultcombo)){
							?>
							<option value="<?php print($rowcombo->id);?>" <?php if(@$myedit=="yes") { if($rowcombo->id==$rowcombo->id) print('selected'); } ?> ><?php print($rowcombo->Organization_Name);?></option>
							<?php
...
?>	
			...
			Search By:&nbsp;								
						<select name="txt_Org_Id_for_search2"  maxlength="50">
							<?php
								$resultcombo2 = mysqli_query($con_cchaportdb,"SELECT id,Organization_Name  FROM organization_profiles where Org_Type_id=5 ORDER BY Organization_Name");
								while ($rowcombo2 = mysqli_fetch_object($resultcombo2)){
							?>
	...
	?>						
			...
			<b>Search By:&nbsp;	</b>	
						<select name="txt_Org_Id_for_search2"  maxlength="50">
							<?php
								$resultcombo2 = mysqli_query($con_cchaportdb,"SELECT id,Organization_Name  FROM organization_profiles where (Org_Type_id=6 or id=2591) ORDER BY Organization_Name");
								while ($rowcombo2 = mysqli_fetch_object($resultcombo2)){
							?>
							<option value="<?php print($rowcombo2->id);?>" <?php if(@$myedit=="yes") { if($rowcombo2->id==$rowcombo2->id) print('selected'); } ?> ><?php print($rowcombo2->Organization_Name);?></option>
							<?php	
...
?>
	...
	?>				
			...
			Search By:&nbsp;								
						<select name="txt_Org_Id_for_search2"  maxlength="50">
							<?php
								$resultcombo2 = mysqli_query($con_cchaportdb,"SELECT id,Organization_Name  FROM organization_profiles where Org_Type_id=6 ORDER BY Organization_Name");
								while ($rowcombo2 = mysqli_fetch_object($resultcombo2)){
							?>
							<option value="<?php print($rowcombo2->id);?>" <?php if(@$myedit=="yes") { if($rowcombo2->id==$rowcombo2->id) print('selected'); } ?> ><?php print($rowcombo2->Organization_Name);?></option>
							<?php	
...
?>
	...
	?>	
			...
			Search By:&nbsp;								
						<select name="txt_Org_Id_for_search2"  maxlength="50">
								<?php
									$resultcombo2 = mysqli_query($con_cchaportdb,"SELECT id,Organization_Name  FROM organization_profiles where Org_Type_id=11 ORDER BY Organization_Name");
									while ($rowcombo2 = mysqli_fetch_object($resultcombo2)){
								?>
								<option value="<?php print($rowcombo2->id);?>" <?php if(@$myedit=="yes") { if($rowcombo2->id==$rowcombo2->id) print('selected'); } ?> ><?php print($rowcombo2->Organization_Name);?></option>
								<?php	
	...
	//Custom Intelligence AIR
		...
		<?php
			...
			//	print($row->AFR);
				...
				<?php
					// intakhab	- 2022-05-22 - to get 101080130 instead of 30108010130
					$AIN_No = "";
			    ...
			    <tr class='gridLight'>
					...
					<td valign="top"><?php print('AIN NO: '.$AIN_No.'<br>'.$igmMasterList[$i]['Agent_Name']); ?></td>
				...
				<!--<td><?php print($igmMasterList[$i]['Date_of_Entry_of_Goods']); ?></td>-->
					...
					//load container detail
						...
						$result1 = mysqli_query($con_cchaportdb,"select cnt.id as id,cnt.cont_number as cont_number,cnt.cont_size as cont_size,cnt.cont_type as cont_type,cnt.cont_height as cont_height,cnt.cont_status as cont_status,cnt.cont_weight as cont_weight,cnt.cont_gross_weight,cnt.cont_seal_number as cont_seal_number,cnt.cont_description as cont_description,cnt.cont_imo as cont_imo,cnt.cont_un as cont_un from  igm_sup_detail_container  cnt where cnt.igm_sup_detail_id=$id");						
					...
					// load notify
						...
						$result3 = mysqli_query($con_cchaportdb,"select notf.id,notf.igm_sup_detail_id,notf.Notify_ID,(select org.Organization_Name from organization_profiles org where org.id=notf.Notify_ID) as notify_name,(select org1.Address_1 from organization_profiles org1 where org1.id=notf.Notify_ID) as Address_1,notf.ff_clearance as ff_clearance from igm_sup_detail_notifytabs notf where notf.igm_sup_detail_id=$id");						
					...
					// load CnF
						...
						/*$result4 = mysql_query("select cnf.id,cnf.igm_sup_detail_id,cnf.CnF_ID_to_be_AccountedFor as CnF_ID_to_be_AccountedFor,(select org.Organization_Name from organization_profiles org where org.id=cnf.CnF_ID_to_be_AccountedFor) as cnf_name,(select org1.Address_1 from organization_profiles org1 where org1.id=cnf.CnF_ID_to_be_AccountedFor) as Address_1 from igm_sup_detail_cnftabs cnf where cnf.igm_sup_detail_id=$row->id");*/               
                                                ...
                                                $result4 = mysqli_query($con_cchaportdb,"select cnf.id,cnf.igm_detail_id,cnf.CnF_ID_to_be_AccountedFor as CnF_ID_to_be_AccountedFor,(select org.Organization_Name from organization_profiles org where org.id=cnf.CnF_ID_to_be_AccountedFor) as cnf_name,(select org1.Address_1 from organization_profiles org1 where org1.id=cnf.CnF_ID_to_be_AccountedFor) as Address_1,(select org.AIN_No from organization_profiles org where org.id=cnf.CnF_ID_to_be_AccountedFor) as AIN_No from igm_detail_cnftabs cnf where cnf.igm_detail_id=$id");						
		...
		{
		// Custom
			print("<td><a href='home.php?myflag=406&Id_Detail=$igm_id&TM=$this->TM&CODE=$this->CODE'>Submit Dispute</a><br><hr noshade><a href='home.php?myflag=403&detail_id=$igm_id&dis_msg=sup&TM=$this->TM&CODE=$this->CODE'>View Dispute List</a><br><hr noshade><a href='home.php?myflag=417&sup_detail_id=$igm_id&TM=$this->TM&CODE=$this->CODE'>View Suplimentary Amendment Request list</a><br><hr noshade><a href='home.php?myflag=419&sup_detail_id=$igm_id&TM=$this->TM&CODE=$this->CODE'>Confirm Final Amendment</a><br><hr noshade><a href='home.php?myflag=421&sup_detail_id=$igm_id&TM=$this->TM&CODE=$this->CODE'>Send Change Request to Ship Agnt(Receive from C&F)</a></td>");
		}
		...
		// PORT
			if($this->TM=="GM")
			{
				...
				print("<td><a href='home.php?myflag=521&CODE=$igm_id&TM=$this->TM'>Add Cont. Unstaffing</a></td>");   
			}
			else
			{
				...
				print("<td><a href='home.php?myflag=521&CODE=$igm_id&TM=$this->TM'>Add Cont. Unstaffing</a><br><hr noshade><a href='home.php?myflag=39&CODE=$igm_id&MCODE=$this->CODE&SubCODE=$this->SubCODE&ImpRot=$this->ImpRot&MLine=$this->MLine&MBL=$this->MBL&TM=$this->TM&DV=DS&SFlag=$this->SFlag'>Update Break Bulk Discharge Status</a><br><hr noshade><a href='home.php?myflag=39&CODE=$igm_id&MCODE=$this->CODE&SubCODE=$this->SubCODE&ImpRot=$this->ImpRot&MLine=$this->MLine&MBL=$this->MBL&TM=$this->TM&DV=DL&SFlag=$this->SFlag'>Update Break Bulk Delivery Status</a></td>");  
			}
		...
		// Of Dock
			...
			{
				print("<td><<a href='home.php?myflag=521&CODE=$igm_id&TM=$this->TM'>Add Cont. Unstaffing</a><br><hr noshade><a href='home.php?myflag=39&CODE=$igm_id&MCODE=$this->CODE&SubCODE=$this->SubCODE&ImpRot=$this->ImpRot&MLine=$this->MLine&MBL=$this->MBL&TM=$this->TM&DV=DS&SFlag=$this->SFlag'>Update Break Bulk Discharge Status</a><br><hr><a href='home.php?myflag=39&CODE=$igm_id&MCODE=$this->CODE&SubCODE=$this->SubCODE&ImpRot=$this->ImpRot&MLine=$this->MLine&MBL=$this->MBL&TM=$this->TM&DV=DL&SFlag=$this->SFlag'>Update Break Bulk Delivery Status</a></td>");    
			}
