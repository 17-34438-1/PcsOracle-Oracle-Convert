		...
		<TR>
			<TD width="100%">
				<table class='table-header' border=0 width="100%">
					...
					?>
					<tr>
						<td colspan="2" align="center"><img width="300px" height="100px" src="<?php echo IMG_PATH?>cpanew.jpg"></td>
					</tr>
					<?php
					}
					else
		...
		<TR>
			<TD>
				<table width="100%" border=1  cellspacing="0" cellpadding="0">
					<tr>
						<?php 
						if ($this->session->userdata('Control_Panel')==12) 
						{ 
						?>	
								...
								?>
									...
									<td align="center">
										...
										if ($row->type=='S' and $row->cont_status=='LCL')
										{
											...
											//print($str1);
											$resultweight=mysqli_query($con_cchaportdb,$str1);
											$rowweight = mysqli_fetch_object($resultweight);
									...
									<td align="center">
										<?php 
										if($row->final_amendment==4)  
										{
											print($row->hold_application);
										}
										else if($row->final_amendment==5)  
										{
											print($row->rejected_application);
										}
										else if($row->final_amendment==2)  
										{
											print($row->response_details2);
										}
										else if($row->final_amendment==1)  
										{
											print($row->response_details3);
										}
										else 
											print("&nbsp;"); 
										?>
									...
									<td align="center">
										...
										{
											print($row->rejected_date);
										}
										else if($row->final_amendment==2)  
										{
											print($row->secondapprovaltime);
										}
										else if($row->final_amendment==1)  
										{
											print($row->thirdapprovaltime);
										}
										else 
											print("&nbsp;"); 
										?>
