...
/* $org_id=$txt_submitted_by_who_org;
$control_panel=$txt_controlpanel;
...
$str="SELECT DISTINCT igms.id AS id,igms.mlocode,igms.IGM_id AS IGM_id,igms.Import_Rotation_No AS Import_Rotation_No,
...
//print($str);
		...
		$result_VesselName = mysqli_query($con_cchaportdb,$str_vesselName);
		$row_Vessel = mysqli_fetch_object($result_VesselName)
	?>
<table align="center">
			    ...
			    <tr class='gridLight'>
					...
					//load container detail
						//print("select cnt.id as id,cnt.cont_number as cont_number,cnt.cont_size as cont_size,cnt.cont_weight as cont_weight,cnt.cont_seal_number as cont_seal_number,cnt.cont_description as cont_description from igm_detail_container cnt where cnt.igm_detail_id=$row->id");
						 ...
						 $str="SELECT cnt.id AS id, cnt.cont_number AS cont_number, cnt.cont_size AS cont_size,cnt.cont_type AS cont_type,cnt.cont_height AS cont_height,
						...
						WHERE igm_supplimentary_detail.igm_detail_id=$row->id AND cnt.cont_imo <> '' ";	
