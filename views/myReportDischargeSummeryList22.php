					...
					<tr>
						<tr>
							...
							<td align="center">Rotation No:&nbsp;&nbsp;<?php print($row_igm_master->Import_Rotation_No);?></td>
								<?php
								$sql_berth=mysqli_query($con_cchaportdb,"select * from vessels_berth_detail where 
								Import_Rotation_No='$row_igm_master->Import_Rotation_No'");
								$row_time=mysqli_fetch_object($sql_berth);
								?>
...
<td  align="left"><?php if($row->Organization_Name) print($row->Organization_Name); else print("&nbsp;");?></td>
	<td  align="left">
							...
							$sql_agent_code= oci_parse($con_sparcsn4_oracle,"select y.id  as mlo_agent_code_ctms from ref_bizunit_scoped r 
														LEFT JOIN ref_agent_representation x on r.gkey=x.bzu_gkey 
														LEFT JOIN ref_bizunit_scoped y ON x.agent_gkey=y.gkey 
														where r.id='$row->mlocode' and y.id is not null");
							oci_execute($sql_agent_code);							
							//print("select mlo_agent_code_ctms from mlo_detail where mlocode='$row->mlocode' and org_id='$row->submitee_org_id'");		
							@$row_agent_code=oci_fetch_object($sql_agent_code);
...
/*////////////////////////////////////////////////////////////////////////////////////////////////////////////////////*/
							...
							and cont_status in ('FCL','FCL/PART')and cont_size <=20 and (cont_height='8.6' or cont_height='8') and igm_details.final_submit=1 and igm_supplimentary_detail.id is null
							union all
							...
							where igm_details.Import_Rotation_No='$rotation' and igm_details.Submitee_Org_Id=$row->submitee_org_id  and mlocode='$row->mlocode' and igm_details.type_of_igm<>'TS'
							and igm_sup_detail_container.cont_status in ('FCL','FCL/PART')and igm_sup_detail_container.cont_size <=20 and (igm_sup_detail_container.cont_height='8.6' or igm_sup_detail_container.cont_height='8') and igm_details.final_submit=1 
							) as tmp";
							//print($str1."<br>");
							...
							left join igm_supplimentary_detail on igm_supplimentary_detail.igm_detail_id=igm_details.id
							where igm_details.Import_Rotation_No='$rotation' and igm_details.Submitee_Org_Id=$row->submitee_org_id  and mlocode='$row->mlocode' and igm_details.type_of_igm<>'TS' 
							and cont_status in ('FCL','FCL/PART')and cont_size <=20 and cont_height='9.6' and igm_details.final_submit=1 and igm_supplimentary_detail.id is null
							union all
							select  count(distinct igm_sup_detail_container.cont_number) as sub
							from igm_details 
							inner join igm_supplimentary_detail on igm_supplimentary_detail.igm_detail_id=igm_details.id
							inner join igm_sup_detail_container on igm_sup_detail_container.igm_sup_detail_id=igm_supplimentary_detail.id
							where igm_details.Import_Rotation_No='$rotation' and igm_details.Submitee_Org_Id=$row->submitee_org_id  and mlocode='$row->mlocode' and igm_details.type_of_igm<>'TS'
							and igm_sup_detail_container.cont_status in ('FCL','FCL/PART')and igm_sup_detail_container.cont_size <=20 and igm_sup_detail_container.cont_height='9.6' and igm_details.final_submit=1 
							) as tmp";
							//print($str1."<br>");
							$result1l=mysqli_query($con_cchaportdb,$str1);
							$row1l=mysqli_fetch_object($result1l);
							?>
							...
							left join igm_supplimentary_detail on igm_supplimentary_detail.igm_detail_id=igm_details.id
							where igm_details.Import_Rotation_No='$rotation' and igm_details.Submitee_Org_Id=$row->submitee_org_id  and mlocode='$row->mlocode' and igm_details.type_of_igm<>'TS' 
							and cont_status in ('FCL','FCL/PART')and cont_size =40 and cont_height='8.6' and igm_details.final_submit=1 and igm_supplimentary_detail.id is null
							union all
							select  count(distinct igm_sup_detail_container.cont_number) as sub
							from igm_details 
							inner join igm_supplimentary_detail on igm_supplimentary_detail.igm_detail_id=igm_details.id
							inner join igm_sup_detail_container on igm_sup_detail_container.igm_sup_detail_id=igm_supplimentary_detail.id
							where igm_details.Import_Rotation_No='$rotation' and igm_details.Submitee_Org_Id=$row->submitee_org_id  and mlocode='$row->mlocode' and igm_details.type_of_igm<>'TS'
							and igm_sup_detail_container.cont_status in ('FCL','FCL/PART')and igm_sup_detail_container.cont_size =40 and igm_sup_detail_container.cont_height='8.6' and igm_details.final_submit=1 
							) as tmp";
							//print("<br>".$str1);	
							$result1=mysqli_query($con_cchaportdb,$str1);
							$row1=mysqli_fetch_object($result1);
							...
							//print("<br>".$str1);	
							$result1f=mysqli_query($con_cchaportdb,$str1);
							$row1f=mysqli_fetch_object($result1f);				
							?>
							<td align="left">
								<?php 
							...
							<td align="left">
								<?php 
									if($row1f->total) print($row1f->total); else print("0"); 
									$total2f=$row1f->total; 
									@$totalg2f=$totalg2f+$total2f;
								?>
							</td>
							<?php
							...
							left join igm_supplimentary_detail on igm_supplimentary_detail.igm_detail_id=igm_details.id
							where igm_details.Import_Rotation_No='$rotation' and igm_details.Submitee_Org_Id=$row->submitee_org_id  and mlocode='$row->mlocode' and igm_details.type_of_igm<>'TS' 
							and cont_status in ('FCL','FCL/PART')and cont_size =45 and igm_details.final_submit=1 and igm_supplimentary_detail.id is null
							union all
							select  count(distinct igm_sup_detail_container.cont_number) as sub
							from igm_details 
							inner join igm_supplimentary_detail on igm_supplimentary_detail.igm_detail_id=igm_details.id
							inner join igm_sup_detail_container on igm_sup_detail_container.igm_sup_detail_id=igm_supplimentary_detail.id
							where igm_details.Import_Rotation_No='$rotation' and igm_details.Submitee_Org_Id=$row->submitee_org_id  and mlocode='$row->mlocode' and igm_details.type_of_igm<>'TS'
							and igm_sup_detail_container.cont_status in ('FCL','FCL/PART')and igm_sup_detail_container.cont_size =45 and igm_details.final_submit=1 
							) as tmp";
							
							//print("<br>".$str1);	
							//print($str1."<br>");
						//	echo $str1;
							$result11=mysqli_query($con_cchaportdb,$str1);
							$row11=mysqli_fetch_object($result11);
							
							//print($str1);
							$result1_dmg11=mysqli_query($con_cchaportdb,$str1);
							$row1_dmg11=mysqli_fetch_object($result1_dmg11);																					
							?>
							...
							left join igm_supplimentary_detail on igm_supplimentary_detail.igm_detail_id=igm_details.id
							where igm_details.Import_Rotation_No='$rotation' and igm_details.Submitee_Org_Id=$row->submitee_org_id  and mlocode='$row->mlocode' and igm_details.type_of_igm<>'TS' 
							and cont_status='LCL'and cont_size <=20 and cont_height='8.6' and igm_details.final_submit=1 and igm_supplimentary_detail.id is null
							union all
							select  count(distinct igm_sup_detail_container.cont_number) as sub
							from igm_details 
							inner join igm_supplimentary_detail on igm_supplimentary_detail.igm_detail_id=igm_details.id
							inner join igm_sup_detail_container on igm_sup_detail_container.igm_sup_detail_id=igm_supplimentary_detail.id
							where igm_details.Import_Rotation_No='$rotation' and igm_details.Submitee_Org_Id=$row->submitee_org_id  and mlocode='$row->mlocode' and igm_details.type_of_igm<>'TS'
							and igm_sup_detail_container.cont_status='LCL' and igm_sup_detail_container.cont_size<=20 and cont_height='8.6'and igm_details.final_submit=1 
							) as tmp";
							//print($str1."<br>");
							$result1f1=mysqli_query($con_cchaportdb,$str1);
							$row1f1=mysqli_fetch_object($result1f1);
							...
							left join igm_supplimentary_detail on igm_supplimentary_detail.igm_detail_id=igm_details.id
							where igm_details.Import_Rotation_No='$rotation' and igm_details.Submitee_Org_Id=$row->submitee_org_id  and mlocode='$row->mlocode' and igm_details.type_of_igm<>'TS' 
							and cont_status='LCL'and cont_size <=20 and cont_height='9.6' and igm_details.final_submit=1 and igm_supplimentary_detail.id is null
							union all
							select  count(distinct igm_sup_detail_container.cont_number) as sub
							from igm_details 
							inner join igm_supplimentary_detail on igm_supplimentary_detail.igm_detail_id=igm_details.id
							inner join igm_sup_detail_container on igm_sup_detail_container.igm_sup_detail_id=igm_supplimentary_detail.id
							where igm_details.Import_Rotation_No='$rotation' and igm_details.Submitee_Org_Id=$row->submitee_org_id  and mlocode='$row->mlocode' and igm_details.type_of_igm<>'TS'
							and igm_sup_detail_container.cont_status='LCL' and igm_sup_detail_container.cont_size<=20 and cont_height='9.6'and igm_details.final_submit=1 
							) as tmp";
							//print($str1."<br>");
							$result1lf1=mysqli_query($con_cchaportdb,$str1);
							$row1lf1=mysqli_fetch_object($result1lf1);							
							?>
							...
							left join igm_supplimentary_detail on igm_supplimentary_detail.igm_detail_id=igm_details.id
							where igm_details.Import_Rotation_No='$rotation' and igm_details.Submitee_Org_Id=$row->submitee_org_id  and mlocode='$row->mlocode' and igm_details.type_of_igm<>'TS' 
							and cont_status='LCL'and cont_size =40 and cont_height='8.6' and igm_details.final_submit=1 and igm_supplimentary_detail.id is null
							union all
							select  count(distinct igm_sup_detail_container.cont_number) as sub
							from igm_details 
							inner join igm_supplimentary_detail on igm_supplimentary_detail.igm_detail_id=igm_details.id
							inner join igm_sup_detail_container on igm_sup_detail_container.igm_sup_detail_id=igm_supplimentary_detail.id
							where igm_details.Import_Rotation_No='$rotation' and igm_details.Submitee_Org_Id=$row->submitee_org_id  and mlocode='$row->mlocode' and igm_details.type_of_igm<>'TS'
							and igm_sup_detail_container.cont_status='LCL' and igm_sup_detail_container.cont_size=40 and cont_height='8.6'and igm_details.final_submit=1 
							) as tmp";
							//print("<br>".$str1);	
							$result1f40=mysqli_query($con_cchaportdb,$str1);
							$row1f40=mysqli_fetch_object($result1f40);
							...
							left join igm_supplimentary_detail on igm_supplimentary_detail.igm_detail_id=igm_details.id
							where igm_details.Import_Rotation_No='$rotation' and igm_details.Submitee_Org_Id=$row->submitee_org_id  and mlocode='$row->mlocode' and igm_details.type_of_igm<>'TS' 
							and cont_status='LCL'and cont_size =40 and cont_height='9.6' and igm_details.final_submit=1 and igm_supplimentary_detail.id is null
							union all
							select  count(distinct igm_sup_detail_container.cont_number) as sub
							from igm_details 
							inner join igm_supplimentary_detail on igm_supplimentary_detail.igm_detail_id=igm_details.id
							inner join igm_sup_detail_container on igm_sup_detail_container.igm_sup_detail_id=igm_supplimentary_detail.id
							where igm_details.Import_Rotation_No='$rotation' and igm_details.Submitee_Org_Id=$row->submitee_org_id  and mlocode='$row->mlocode' and igm_details.type_of_igm<>'TS'
							and igm_sup_detail_container.cont_status='LCL' and igm_sup_detail_container.cont_size=40 and cont_height='9.6'and igm_details.final_submit=1 
							) as tmp";
							//print("<br>".$str1);	
							$result1ff40=mysqli_query($con_cchaportdb,$str1);
							$row1ff40=mysqli_fetch_object($result1ff40);
							?>
							...
							<td align="left">
								<?php if($row1ff40->total) print($row1ff40->total); 
									else print("0"); $total2f40=$row1ff40->total;
									@$totalg2f40B=$totalg2f40B+$total2f40; //print("B"); 
								?>
							 </td>
							<?php
							
							//LCL-45" 
							//LCL 45 left join to inner join with igm_supplimentary_detail edited by SUMON
							$str1="select sum(sub) as total from (
							select count(distinct cont_number) as sub
							from igm_detail_container 
							inner join igm_details on igm_details.id=igm_detail_container.igm_detail_id 
							inner join igm_supplimentary_detail on igm_supplimentary_detail.igm_detail_id=igm_details.id
							where igm_details.Import_Rotation_No='$rotation' and igm_details.Submitee_Org_Id=$row->submitee_org_id  and mlocode='$row->mlocode' and igm_details.type_of_igm<>'TS' 
							and cont_status='LCL'and cont_size =45 and cont_height='9.6' and igm_details.final_submit=1 and igm_supplimentary_detail.id is null
							union all
							select  count(distinct igm_sup_detail_container.cont_number) as sub
							from igm_details 
							inner join igm_supplimentary_detail on igm_supplimentary_detail.igm_detail_id=igm_details.id
							inner join igm_sup_detail_container on igm_sup_detail_container.igm_sup_detail_id=igm_supplimentary_detail.id
							where igm_details.Import_Rotation_No='$rotation' and igm_details.Submitee_Org_Id=$row->submitee_org_id  and mlocode='$row->mlocode' and igm_details.type_of_igm<>'TS'
							and igm_sup_detail_container.cont_status='LCL' and igm_sup_detail_container.cont_size=45 and cont_height='9.6'and igm_details.final_submit=1 
							) as tmp";
							//print("<br>".$str1);	
							//print($str1."<br>");
							$result11f45=mysqli_query($con_cchaportdb,$str1);
							$row11f45=mysqli_fetch_object($result11f45);
							//print($str1);
							...
							$result1e=mysqli_query($con_cchaportdb,$str1);
							$row1e=mysqli_fetch_object($result1e);						
							...
							igm_details.final_submit=1)";	
							$result1e40=mysqli_query($con_cchaportdb,$str1);
							$row1e40=mysqli_fetch_object($result1e40);							
...
//print($str1."<br>");							
							$result1=mysqli_query($con_cchaportdb,$str1);
							$row1e45=mysqli_fetch_object($result1);
...
$result1=mysqli_query($con_cchaportdb,$str1);
$row1t2=mysqli_fetch_object($result1);
...
and cont_size <=20 and igm_details.final_submit=1";	
$result1=mysqli_query($con_cchaportdb,$str1);
$row1t22=mysqli_fetch_object($result1);
...
$result1=mysqli_query($con_cchaportdb,$str1);
$row1t4=mysqli_fetch_object($result1);
...
$result1=mysqli_query($con_cchaportdb,$str1);
$row1t44=mysqli_fetch_object($result1);
...
$result1=mysqli_query($con_cchaportdb,$str1);
$row1t45=mysqli_fetch_object($result1);
...
and (cont_height='8.6' or cont_height='8')
  and cont_size <=20 and igm_details.final_submit=1";	
$result1=mysqli_query($con_cchaportdb,$str1);
$row1t2l=mysqli_fetch_object($result1);
...
and cont_size <=20 and igm_details.final_submit=1";	
$result1=mysqli_query($con_cchaportdb,$str1);
$row1t22l=mysqli_fetch_object($result1);
...
$result1=mysqli_query($con_cchaportdb,$str1);
$row1t4l=mysqli_fetch_object($result1);
...
$result1=mysqli_query($con_cchaportdb,$str1);
$row1t44l=mysqli_fetch_object($result1);
...
$result1=mysqli_query($con_cchaportdb,$str1);
$row1t45l=mysqli_fetch_object($result1l);
...
and (cont_status='EMT' or cont_status='Empty' or cont_status='MT' or cont_status='MTY' or cont_status='ETY') 
 and cont_size <=20 and igm_details.final_submit=1";	
$result1=mysqli_query($con_cchaportdb,$str1);
$row1t2e=mysqli_fetch_object($result1);
...
and cont_height='9.6'
  and cont_size <=20 and igm_details.final_submit=1";	
$result1=mysqli_query($con_cchaportdb,$str1);
$row1t22e=mysqli_fetch_object($result1);
...
$result1=mysqli_query($con_cchaportdb,$str1);
$row1t4e=mysqli_fetch_object($result1);
...
$result1=mysqli_query($con_cchaportdb,$str1);
$row1t44e=mysqli_fetch_object($result1);
...
$result1=mysqli_query($con_cchaportdb,$str1);
$row1t45e=mysqli_fetch_object($result1l);
...
<td  align="left"><?php if($row1t45e->total) print($row1t45e->total); 
	...
	<?php 
		$grand=$totalf20f+$totalf20+$total240+$total2f40+$tota45+$total1+$total1l+$total2+$total2f+$tota31+$total3+$total3e+$total4+$total40+$total45+
			$totalT20+$totalT2B+$totalT40+$totalT4B+$totalT45+$totalT20l+$totalT2Bl+$totalT40l+$totalT4Bl+$totalT45l+$totalT20e+$totalT2Be+
			$totalT40e+$totalT4Be+$totalT45e; 
	?>
