...
//FCL-20"
			...
			//imdg			
							...
							?>
							<td  align="left"><?php if($row1->total){ if($totalRes<0) print (-1*$totalRes); else print($totalRes);} else{ print("0");} ?></td>
							<?php
//FCL-40"
							$str1="select count(distinct cont_number) as total from igm_detail_container inner join igm_details on igm_details.id=igm_detail_container.igm_detail_id 
							where Import_Rotation_No='$rotation' and Submitee_Org_Id='$row->submitee_org_id' and mlocode='$row->mlocode' and cont_iso_type not in('22R1','45R1','45R0','25R1','45R3','22R0','42R1','45R8','20R1','22R9','42R0','22R2','20R0','45R4','22R7','42R3') and type_of_igm<>'TS' 
...
//print("<br>".$str1);		
		...
		//imdg							
							...
							<td align="left">
								<?php 
									$rowLadenTeus = ($total1*1)+($total2*2);
									if($rowLadenTeus<0) echo -1*$rowLadenTeus; else echo $rowLadenTeus;
									
									
									$totalLadenTues+=$rowLadenTeus;
								?>
							</td>
							...
							<td align="left">
								<?php 
									echo $rowEmptyTeus = ($total3*1)+($total4*2);
									$totalEmptyTues+=$rowEmptyTeus;
								?>
							</td>
							...
							<td align="left">
								<?php 
									echo $rowRefferTeus = ($total5*1)+($total6*2);
									$totalRefferTues+=$rowRefferTeus;
								?>
							</td>
							...
							<td align="left">
								<?php 
									echo $rowImdgTeus = ($total7*1)+($total8*2);
									$totalImdgTues+=$rowImdgTeus;
								?>
							</td>
							...
							<td align="left">
								<?php 
									echo $rowTransTeus = ($total9*1)+($total10*2);
									$totalTransTues+=$rowTransTeus;
								?>
							</td>
							...
							<td align="left"><?php if($grand20) {if($grand20<0) echo -1*$grand20; else echo $grand20;} else print("0"); ?></td>
							<td align="left"><?php if($grand40) {if($grand40<0) echo -1*$grand40; else echo $grand40;} else print("0"); ?></td>
							
							<td  align="left">
								<?php 
									 $rowTeus = ($grand20*1)+($grand40*2);
									
									if($rowTeus<0) echo -1*$rowTeus; else echo $rowTeus;
					...
					<!--/tr-->
						...
						<tr>
							...
							<td><b><?php if($totalg1<0) print((-1*$totalg1)); else print($totalg1);?></b></td>
							<td><b><?php if($totalg2<0) print((-1*$totalg2)); else print($totalg2);?></b></td>
							<td><b><?php if($totalLadenTues<0)print((-1*$totalLadenTues));  else print($totalLadenTues);?></b></td>
							<td><b><?php print($totalg3);?></b></td>
							<td><b><?php print($totalg4);?></b></td>
							<td><b><?php print($totalEmptyTues);?></b></td>
							<td><b><?php print($totalg5);?></b></td>
							<td><b><?php print($totalg6);?></b></td>
							<td><b><?php print($totalRefferTues);?></b></td>
							<td><b><?php print($totalg7);?></b></td>
							<td><b><?php print($totalg8);?></b></td>
							<td><b><?php print($totalImdgTues);?></b></td>
							<td><b><?php print($totalg9);?></b></td>
							<td><b><?php print($totalg10);?></b></td>
							<td><b><?php print($totalTransTues);?></b></td>
							<td><b><?php print($totalg11);?></b></td>
							<td><b><?php print($totalg12);?></b></td>
							<?php $total20Feet= $totalg1+$totalg3+$totalg5+$totalg7+$totalg9;?>
							<td><b><?php if($total20Feet<0) print(-1*$total20Feet);else print($total20Feet);?></b></td>
							<?php $total40Feet= $totalg2+$totalg4+$totalg6+$totalg8+$totalg10+$totalg11+$totalg12;?>
							<td><b><?php if($total40Feet<0) print(-1*$total40Feet);else print($total40Feet);?></b></td>
							<td><b><?php echo $totalTues; ?></b></td>
