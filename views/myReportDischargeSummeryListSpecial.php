...
<BODY>
	...
	<?php
		...
		include("dbOracleConnection.php");
			...
			$query_n4 = "SELECT ref_bizunit_scoped.name, to_char(vsl_vessel_visit_details.flex_date01,'YYYY-MM-DD') AS arr_dt
		FROM vsl_vessel_visit_details 
		INNER JOIN ref_bizunit_scoped ON vsl_vessel_visit_details.bizu_gkey=ref_bizunit_scoped.gkey 
		WHERE vsl_vessel_visit_details.ib_vyg='$rotation'";
		
		$stid = oci_parse($con_sparcsn4_oracle, $query_n4);
        oci_execute($stid);
		$row_query_n4 = oci_fetch_object($stid);
...
//mysql_select_db("ccha");
	...
	$igmdetail=mysqli_query($con_cchaportdb,"select * from igm_details where Import_Rotation_No='$rotation'");
		...
		if($testdetailRes2<1)
		{
			$igmMaster=mysqli_query($con_cchaportdb,"select Import_Rotation_No,Vessel_Name,Total_number_of_bols,Total_number_of_packages,Total_number_of_containers,Total_gross_mass,Voy_No from igm_masters where Import_Rotation_No='$rotation'");
		 ...
		 <tr>
			...
			?>
			  <tr>
					...
					<?php
					$sql_agent_code=mysqli_query($con_cchaportdb,"select mlodescription,mlo_agent_code_ctms,agent_from,org_id 
																	from mlo_detail where mlocode='$row->mlocode'");
...
//FCL-20"
	...
	//imdg			
					...
					<td  align="center">
						<?php 
							if($row1->total) print($row1->total-$row1_dmg->total); else print(""); 
							$total1=$row1->total-$row1_dmg->total; @$totalg1=$totalg1+$total1;
						?>
					</td>
					<?php
//FCL-40"
...
//imdg							
					...
					?>
					 <td  align="center">
						<?php 
							if($row1->total) print($row1->total-$row1_dmg->total); else print(""); $total2=$row1->total-$row1_dmg->total; @$totalg2=$totalg2+$total2;
						?>
					</td>
					<?php
//Empty-20"
...
//print($str1."<br>");							
			...
			<td>
				<table>
					<?php 
						...
						$result_summary=mysqli_query($con_cchaportdb,$query_summary);
						$row_summary=mysqli_fetch_object($result_summary);	
	...
	<div >
		...
		<table align="center" width="90%" border="1" style="border-collapse:collapse">
			...
			$rslt_mlo_info=mysqli_query($con_cchaportdb,$sql_mlo_info);
			...
			while($row_mlo_info=mysqli_fetch_object($rslt_mlo_info))
			{
				$tot_box=0;
				$tot_teus=0;
			?>
			<tr>
				...
				$rslt_fcl_20=mysqli_query($con_cchaportdb,$sql_fcl_20);
				
				$fcl_20=mysqli_fetch_object($rslt_fcl_20);
				?>
				...
				$rslt_fcl_40=mysqli_query($con_cchaportdb,$sql_fcl_40);
				
				$fcl_40=mysqli_fetch_object($rslt_fcl_40);
				?>
				...
				$rslt_lcl_20=mysqli_query($con_cchaportdb,$sql_lcl_20);
				
				$lcl_20=mysqli_fetch_object($rslt_lcl_20);
				?>
				...
				$rslt_lcl_40=mysqli_query($con_cchaportdb,$sql_lcl_40);
				
				$lcl_40=mysqli_fetch_object($rslt_lcl_40);
				?>
				...
				$rslt_icd_20=mysqli_query($con_cchaportdb,$sql_icd_20);
				
				$icd_20=mysqli_fetch_object($rslt_icd_20);
				?>
				...
				$rslt_icd_40=mysqli_query($con_cchaportdb,$sql_icd_40);
				
				$icd_40=mysqli_fetch_object($rslt_icd_40);
				?>
				...
				$rslt_mty_20=mysqli_query($con_cchaportdb,$sql_mty_20);
				
				$mty_20=mysqli_fetch_object($rslt_mty_20);
				?>
				...
				$rslt_mty_40=mysqli_query($con_cchaportdb,$sql_mty_40);
				
				$mty_40=mysqli_fetch_object($rslt_mty_40);
				?>
		...
		<table align="center" width="90%">
			<tr>
				<td class="defaultFont">
					<font size="6">
					<p lang="bn">১/ অত্র জাহাজের সকল OPEN TOP, FLAT RACK কন্টেইনার CCT ইয়ার্ডের নির্দিষ্ট স্লটে সংরক্ষণ করে মেমোর মাধ্যমে ASI/SI কে হ্যান্ডওভার করতে হবে। বাকী সকল বুলেটসীলযুক্ত কন্টেইনার সংশ্লিষ্ট ইয়ার্ডে সংরক্ষণ করে R/L এর উপর নিরাপত্তা রক্ষী/কর্মচারীর রিসিভিং স্বাক্ষর নিতে হবে।<br>
					...
					<br>
					<b> ৪/ MLO _______________ ICT Pangaon Container NCT ইয়ার্ডে পানগাঁও স্লটে সংরক্ষণ করতে হবে। </b></p>
					</font>
				</td>
			</tr>
		</table>
