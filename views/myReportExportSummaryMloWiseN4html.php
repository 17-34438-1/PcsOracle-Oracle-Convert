...
// 	$sql1=mysqli_query($con_sparcsn4,"select vsl_vessels.name as vsl_name,ifnull(sparcsn4.vsl_vessel_visit_details.flex_string02,ifnull(sparcsn4.vsl_vessel_visit_details.flex_string03,'')) as berth_op,ifnull(sparcsn4.argo_quay.id,'') as berth,sparcsn4.argo_carrier_visit.ata,sparcsn4.argo_carrier_visit.atd from vsl_vessel_visit_details
		...
		<td width="90%" align="center">
			<table border=0 width="90%">
				<tr>
					...
					<td style="text-decoration: underline;text-decoration-style:dotted;"><font size="4"><b> <?php echo $row1->NAME; ?></b></font></td>
...
<?php
// 	$query=mysqli_query($con_sparcsn4,"SELECT gkey,mlo,mlo_name,
...
//  FROM (
// SELECT DISTINCT sparcsn4.inv_unit.gkey AS gkey,r.id AS mlo,r.name AS mlo_name,inv_unit.goods_and_ctr_wt_kg,
...
// WHEN RIGHT(sparcsn4.ref_equip_type.nominal_length,2) = '42' AND (RIGHT(sparcsn4.ref_equip_type.nominal_height,2))='90' AND freight_kind IN ('FCL','LCL') AND sparcsn4.ref_equip_type.iso_group NOT IN ('RS','RT','RE','UT','TN','TD','TG','PF','PC')  THEN 1
...
WHERE vsl_vessel_visit_details.vvd_gkey='$ddl_imp_rot_no'
)
