...
$str="select distinct igms.id as id,igms.mlocode,igms.IGM_id as IGM_id,igms.Import_Rotation_No as Import_Rotation_No,igms.Line_No as Line_No,
		...
		igms.No_of_Pack_Discharged as No_of_Pack_Discharged,igms.Remarks as Remarks,igms.AFR as AFR,igms.ConsigneeDesc,igms.NotifyDesc,igms.navy_comments,igms.Submitee_Org_Id,
(select Organization_Name from organization_profiles orgs where 
orgs.id=igms.Submitee_Org_Id) as Organization_Name,imco,un,extra_remarks,navyresponse.response_details1,
...
on igm_detail_container.igm_detail_id=igms.id left join igm_navy_response navyresponse on navyresponse.igm_details_id=igms.id
		where igms.Import_Rotation_No='$rotation' 
and igm_detail_container.off_dock_id='2592'
union 
select distinct igms.id as id, 0 as mlocode,igms.igm_master_id as IGM_id,igms.Import_Rotation_No as Import_Rotation_No,igms.Line_No as Line_No,
		igms.BL_No as BL_No,igms.Pack_Number as Pack_Number,igms.Pack_Description as Pack_Description,igms.Pack_Marks_Number as Pack_Marks_Number,
		igms.Description_of_Goods as Description_of_Goods,igms.Date_of_Entry_of_Goods as Date_of_Entry_of_Goods,igms.weight as weight,igms.weight_unit,igms.net_weight,igms.net_weight_unit,
		igms.Bill_of_Entry_No as Bill_of_Entry_No,igms.Bill_of_Entry_Date as Bill_of_Entry_Date,igms.No_of_Pack_Delivered as No_of_Pack_Delivered,
		igms.No_of_Pack_Discharged as No_of_Pack_Discharged,igms.Remarks as Remarks,igms.AFR as AFR,igms.ConsigneeDesc,igms.NotifyDesc,'N/A' as navy_comments,igms.Submitee_Org_Id,
(select Organization_Name from organization_profiles orgs where 
orgs.id=igms.Submitee_Org_Id) as Organization_Name, 'N/A' as imco,'N/A' as un,'N/A' as extra_remarks,navyresponse.response_details1,
navyresponse.response_details2,navyresponse.secondapprovaltime,navyresponse.response_details3,navyresponse.thirdapprovaltime,
navyresponse.hold_application,navyresponse.hold_date,navyresponse.rejected_application,navyresponse.rejected_date,
navyresponse.final_amendment  
...
on igm_sup_detail_container.igm_sup_detail_id=igms.id
left join igm_navy_response navyresponse on navyresponse.egm_details_id=igms.id
		where igms.Import_Rotation_No='$rotation' 
and igm_sup_detail_container.off_dock_id='2592'";
/*else
$str="select distinct igms.id as id,igms.mlocode,igms.IGM_id as IGM_id,igms.Import_Rotation_No as Import_Rotation_No,igms.Line_No as Line_No,
		igms.BL_No as BL_No,igms.Pack_Number as Pack_Number,igms.Pack_Description as Pack_Description,igms.Pack_Marks_Number as Pack_Marks_Number,
		igms.Description_of_Goods as Description_of_Goods,igms.Date_of_Entry_of_Goods as Date_of_Entry_of_Goods,igms.weight as weight,igms.weight_unit,igms.net_weight,igms.net_weight_unit,
		...
		igms.No_of_Pack_Discharged as No_of_Pack_Discharged,igms.Remarks as Remarks,igms.AFR as AFR,igms.ConsigneeDesc,igms.NotifyDesc,igms.navy_comments,igms.Submitee_Org_Id,
(select Organization_Name from organization_profiles orgs where 
orgs.id=igms.Submitee_Org_Id) as Organization_Name,imco,un,extra_remarks,
navyresponse.response_details2,navyresponse.secondapprovaltime,navyresponse.response_details3,navyresponse.thirdapprovaltime,
navyresponse.hold_application,navyresponse.hold_date,navyresponse.rejected_application,
navyresponse.rejected_date,navyresponse.final_amendment 
from igm_details igms 
inner join igm_detail_container
on igm_detail_container.igm_detail_id=igms.id left join igm_navy_response navyresponse on navyresponse.igm_details_id=igms.id
where igms.Import_Rotation_No='$rotation' 
and igm_detail_container.off_dock_id='2592' and igms.Submitee_Org_Id='$org_id'
union 
select distinct igms.id as id,0 as mlocode,igms.igm_master_id as IGM_id,igms.Import_Rotation_No as Import_Rotation_No,igms.Line_No as Line_No,
igms.BL_No as BL_No,igms.Pack_Number as Pack_Number,igms.Pack_Description as Pack_Description,igms.Pack_Marks_Number as Pack_Marks_Number,
igms.Description_of_Goods as Description_of_Goods,igms.Date_of_Entry_of_Goods as Date_of_Entry_of_Goods,igms.weight as weight,igms.weight_unit,igms.net_weight,igms.net_weight_unit,
...
igms.No_of_Pack_Discharged as No_of_Pack_Discharged,igms.Remarks as Remarks,igms.AFR as AFR,igms.ConsigneeDesc,igms.NotifyDesc,'N/A' as navy_comments,igms.Submitee_Org_Id,
(select Organization_Name from organization_profiles orgs where 
orgs.id=igms.Submitee_Org_Id) as Organization_Name,0 as imco,0 as un,'N/A' as extra_remarks,
navyresponse.response_details2,navyresponse.secondapprovaltime,navyresponse.response_details3,navyresponse.thirdapprovaltime,
navyresponse.hold_application,navyresponse.hold_date,navyresponse.rejected_application,
navyresponse.rejected_date,navyresponse.final_amendment 
from igm_supplimentary_detail igms 
inner join igm_sup_detail_container
on igm_sup_detail_container.igm_sup_detail_id=igms.id left join igm_navy_response navyresponse on navyresponse.egm_details_id=igms.id
where igms.Import_Rotation_No='$rotation' 
and igm_sup_detail_container.off_dock_id='2592' and igms.Submitee_Org_Id='$org_id'";
*/
...
<table align="center">
			...
			<tr><td style="font-size:22px;" ><b>ICD MENIFEST</b></td></tr>
		...
		?>
			    ...
			    <tr class='gridLight'>
					...
					//load container detail
						...
						$result1 = mysqli_query($con_cchaportdb,"select cnt.id as id, cnt.cont_number as cont_number, cnt.cont_size as cont_size,cnt.cont_type as cont_type,cnt.cont_height as cont_height,cnt.cont_status as cont_status,cnt.cont_weight as cont_weight,cnt.cont_seal_number as cont_seal_number,cnt.cont_description as cont_description,cnt.cont_imo as cont_imo, cnt.cont_un as cont_un,off_dock_id,Organization_Name from igm_detail_container cnt 
inner join organization_profiles
on 
organization_profiles.id=cnt.off_dock_id 
inner join igm_details on igm_details.id=cnt.igm_detail_id
where cnt.igm_detail_id=$row->id and cnt.off_dock_id='2592' 
and igm_details.Import_Rotation_No='$row->Import_Rotation_No' and igm_details.Line_No='$row->Line_No'
union
select cnt.id as id, cnt.cont_number as cont_number, cnt.cont_size as cont_size,cnt.cont_type as cont_type,cnt.cont_height as cont_height,cnt.cont_status as cont_status,cnt.cont_weight as cont_weight,cnt.cont_seal_number as cont_seal_number,cnt.cont_description as cont_description,cnt.cont_imo as cont_imo, cnt.cont_un as cont_un,off_dock_id,Organization_Name from igm_sup_detail_container cnt 
inner join organization_profiles
on 
organization_profiles.id=cnt.off_dock_id inner join igm_supplimentary_detail on
igm_supplimentary_detail.id=cnt.igm_sup_detail_id
where cnt.igm_sup_detail_id=$row->id and cnt.off_dock_id='2592'
and igm_supplimentary_detail.Import_Rotation_No='$row->Import_Rotation_No' 
and igm_supplimentary_detail.Line_No='$row->Line_No'");						
