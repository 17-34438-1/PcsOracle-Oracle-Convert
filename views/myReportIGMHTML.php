		...
		<div class="col-lg-12">						
			<section class="panel">
				<div class="panel-body">
					<form class="form-horizontal form-bordered" method="POST" action="<?php echo base_url().'index.php/Report/myIGMReportView'; ?>" target="_blank" id="myform" name="myform">
							...
							<div class="col-md-6">		
								...
								<div class="input-group mb-md">
									...
									<select name="ddl_manifest" id="igm" class="form-control" onchange="myShowOrg();">
										...
										<option value="GM">General Manifest</option>
										<option value="ROB">ROB</option>
										<option value="TS">TS</option>
										<option value="NIL">NIL</option>
										<option value="MT">EMPTY</option>
										<option value="RC">IGM General Retention Cargo</option>
										<option value="AMS">Arms,Ammunition and Explosiv(Container)</option>
										<option value="PS">Provision And Store Supply(Container)</option>
									</select>
								</div>
								<div class="input-group mb-md">
