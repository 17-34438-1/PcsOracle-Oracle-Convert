...
<?php $ddl_imp_rot_no=$_REQUEST['ddl_imp_rot_no']; 
	...
	$sql=mysqli_query($con_cchaportdb,"
...
<?php
	$query=mysqli_query($con_cchaportdb,"SELECT DISTINCT cont_number AS id,cont_size,cont_status,cont_height,Organization_Name,off_dock_id,mlocode FROM igm_detail_container 
...
<?php
	$query=mysqli_query($con_cchaportdb,"SELECT id,cont_size,cont_status,cont_height,test,mlocode,(CASE 
