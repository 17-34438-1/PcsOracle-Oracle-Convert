		...
		<div class="col-lg-12">						
			<section class="panel">
				<div class="panel-body">
					<form class="form-horizontal form-bordered" method="POST" action="<?php echo base_url().'index.php/IgmViewController/updateManifestList'; ?>" target="" id="myform" name="myform" onsubmit="return validate()">
