<?php
	...
	$link = mysqli_connect('10.1.1.21:3306', 'sparcsn4', 'sparcsn4');
	if (!$link) {
		die('Could not connect: ' . mysqli_error());
	}
	$selected = mysqli_select_db("ctmsmis",$link)
	...
	$query=mysqli_query($con_sparcsn4,"select bill_name as invoiceDesc,if(cnt_code='BD',concat('JL/',mis_vsl_billing_detail.draftNumber,'-',substring(billing_date,4,1)),
