...
<?php
//	include("con_cchaportdb.php");		// previous before 2020-05-31
	include("mydbPConnection.php");
	
						$query=mysqli_query($con_cchaportdb,"SELECT Import_Rotation_No,igm_masters.Vessel_Name,Voy_No,Total_number_of_bols,Total_number_of_packages,				Total_number_of_containers,Total_gross_mass,Port_of_Shipment,Port_of_Destination,Submitee_Org_Id,
