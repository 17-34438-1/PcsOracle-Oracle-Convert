<script>
	...
	<section role="main" class="content-body">
		...
		<!--        <td align="center">
				 ...
				 <td align="center">
				   <?php echo $list[$i]['handover_category']?>
				 </td>   
				...
				<td align="center">
				   <?php echo $list[$i]['handover_date']?>
				 </td>  		 
				<td align="center">
				   <?php echo $list[$i]['comments']?>
				 </td>  
			 <td align="center">
				   <?php echo $list[$i]['handover_by']?>
				 </td>  
				 
				<td align="center">
					<form action="<?php echo site_url('report/networkProductDeliveryListEdit');?>" method="POST">
						<input type="hidden" id="deliveryID" name="deliveryID" value="<?php echo $list[$i]['id'];?>">							
				...
				<td align="center"> 
					<form action="<?php echo site_url('report/networkProductDeliveryList');?>" method="POST" onsubmit="return validate();">						
						<input type="hidden" id="dID" name="dID" value="<?php echo $list[$i]['id'];?>">							
