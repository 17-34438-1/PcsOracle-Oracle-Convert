<script>
	...
	<div class="img">
		...
		<table align="center"> 
                            ...
                            <tr id="ownerTr"  <?php if ($editFlag==1){ if ($product_details[0]['rcv_from']!='owner') { ?>  style="display: none" <?php } } if ($editFlag==0){ ?> style="display: none" <?php } ?> >
                            ...
                            <tr id="userTr"   <?php if ($editFlag==1){ if($product_details[0]['rcv_from']!='user') { ?>  style="display: none" <?php } } if ($editFlag==0){ ?> style="display: none" <?php } ?> >
                            ...
                            <tr id="blankTr3"  <?php  if ($editFlag==1){ if ($product_details[0]['rcv_from']!='owner' ) { ?>  style="display: none" <?php } }?>><td colspan="3">&nbsp;</td></tr>  
                             <tr>
                                 <th align="left"><nobr>Comments</nobr></th>
                                 <th align=""><nobr>&nbsp; &nbsp;&nbsp; : &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</nobr></th>
                		 <th><textarea id="rcv_comment" name="rcv_comment" tyle="width:300px; height: 20px" rows="2" ><?php if($editFlag==1) { echo $product_details[0]['comments']; }  ?> </textarea>
                            ...
                            <tr>
                                ...
                                <th align=""><nobr>&nbsp; &nbsp;&nbsp; : &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</nobr></th>
                                <th><input class="read" type="date" style="width:200px;"  id="rcv_date" name="rcv_date"  <?php if($editFlag==1){ ?> value="<?php echo $product_details[0]['rcv_date'] ?>" <?php } ?> ></nobr></th>
