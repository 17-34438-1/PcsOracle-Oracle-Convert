...
<tr bgcolor="#ffffff" align="center" height="100px">
	...
	<table width="100%" border ='1' cellpadding='0' cellspacing='0' style="border-collapse: collapse;">
		<tr align="center">
			...
			<td style="border-width:3px;"><b>Yard</b></td>	
...
WHERE date(b.flex_date01)='$fromdate' $substr1
) AS tmp $substr2";
  //echo $str;
...
");
	...
	*/
	...
	<?php } ?>
			...
			<td><a href="<?php echo site_url('Report/assignmentCNFContainerList/'.$row->consignee_bzu.'/'.$fromdate);?>" target="_blank"><?php if($row->cf) echo $row->cf; else echo "&nbsp;";?></td>
