			...
			<div class="col-lg-12">						
				<section class="panel">
					<div class="panel-body">
						<form class="form-horizontal form-bordered" method="POST" action="<?php echo site_url("Report/offDockContSearchViews");?>" target="_blank" id="myform" name="myform" onsubmit="return validate()">
