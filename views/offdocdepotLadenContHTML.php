<html>
	...
	<?php 
			...
			//echo $sValue;
			$of = Offdock(strtolower($login_id));
			$str = "select now() as dt";
			$res = mysqli_query($con_sparcsn4,$str);
			$rowD = mysqli_fetch_object($res);
			$date = $rowD->dt;
			$cond = " and destination not in('2591','BDCGP','2592','5231','5232','5233','5234','5235','5236','5237','5238','AUCTION','BDMGL','BDPGN','5239','0000')";
			...
			$result2 = mysqli_query($con_sparcsn4,$str2);
		?>
