...
<BODY>
	...
	<?php } 
		...
		header("Content-Disposition: attachment; filename=SC_HANDLING_PERFORMANCE.xls;");
...
<tr bgcolor="#ffffff" align="center" height="100px">
		<td colspan="13" align="center">
			<table border=0 width="100%">
				...
				<tr align="center">
					<td colspan="12"><font size="4"><b><u>OPERATOR'S SC HANDLING PERFORMANCE REPORT</u></b></font></td>
				</tr>
				<tr align="center">
...
$cond = "";
	...
	$strQuery = "SELECT placed_by,SUM(impRcv) AS impRcv,SUM(keepDlv) AS keepDlv,SUM(dlvOcdOffDock) AS dlvOcdOffDock,SUM(shift) AS shift
	FROM (
	SELECT placed_by,
	...
	$cond
	AND creator='-xps-' AND (full_name LIKE 'SC%')
	AND move_kind='DSCH' 
	UNION ALL
	SELECT  substr(concat(concat(REGEXP_SUBSTR( placed_by, '[^:]+', 1, 1),':'),REGEXP_SUBSTR( placed_by, '[^:]+', 1, 2 )),5) AS placed_by,
	full_name,move_kind
	...
	AND creator='-xps-' AND (full_name LIKE 'SC%')
	AND move_kind='YARD'
	)  )  GROUP BY placed_by ORDER BY placed_by";
