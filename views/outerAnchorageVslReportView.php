...
<body>
    ...
    <?php } ?>
		...
		<tr bgcolor="#ffffff" height="50px">
			<th align="center" colspan="10"><font size="6"><b>Chattogram Port Authority</b></font></th>
		</tr>
		<tr bgcolor="#ffffff" height="50px">
		...
		<?php if($vslType!=''){ ?>
		<tr bgcolor="#ffffff" height="50px">
			<th align="center" colspan="10"><font size="4"><b><?php echo "Vessel Type : ". $vslType; ?></b></font></th>
		</tr>
		<?php } ?>
		<tr bgcolor="#ffffff" height="50px">
			<th align="center" colspan="10"><font size="4"><b><?php if($_POST['searchType']=='arrival'){echo "Arrival Date : ";} else{ echo"Departure Date : "; }?></b><?php echo $formDate." To ".$toDate; ?></font></th>
		</tr>
		
		<!--tr>			
			<th style="border:1px solid black; font-size:15px;  border-collapse: collapse;" align="center" class="text-center">#Sl</th>
            <th style="border:1px solid black; font-size:15px;  border-collapse: collapse;" align="center" class="text-center">ROTATION</th>
			<th style="border:1px solid black; font-size:15px;  border-collapse: collapse;" align="center" class="text-center">NAME OF VESSEL</th>
			<th style="border:1px solid black; font-size:15px;  border-collapse: collapse;" align="center" class="text-center">DATE OF ARRIVAL</th>
            <th style="border:1px solid black; font-size:15px;  border-collapse: collapse;" align="center" class="text-center">ARRIVAL TIME</th>
            <th style="border:1px solid black; font-size:15px;  border-collapse: collapse;" align="center" class="text-center">DATE OF DEPARTURE</th>
            <th style="border:1px solid black; font-size:15px;  border-collapse: collapse;" align="center" class="text-center">DEPARTURE TIME </th>
			<th style="border:1px solid black; font-size:15px;  border-collapse: collapse;" align="center" class="text-center">BEACHING AGENT</th>
            <th style="border:1px solid black; font-size:15px;  border-collapse: collapse;" align="center" class="text-center">FLAG</th>
            <th style="border:1px solid black; font-size:15px;  border-collapse: collapse;" align="center" class="text-center">GRT</th>
            <th style="border:1px solid black; font-size:15px;  border-collapse: collapse;" align="center" class="text-center">NRT</th>
		...
		?>
				<tr>
					<td colspan="12"  align="left"><b><?php echo $queryList[$i]['vsl_type']; ?></b></td>
				</tr>
				<tr>			
					<th style="border:1px solid black; font-size:15px;  border-collapse: collapse;" align="center" class="text-center">#Sl</th>
					<th style="border:1px solid black; font-size:15px;  border-collapse: collapse;" align="center" class="text-center">ROTATION</th>
		...
		?>
				<tr>
					<td colspan="12" style="border:1px solid black; font-size:12px;  border-collapse: collapse;" align="left">
						<?php echo "<b><font size='3'>Total : ".$totVsl."</font></b>"; ?>
					</td>
				</tr>
				<tr><td>&nbsp;</td></tr>
		<?php
		...
		?>
				<tr>
					<td colspan="12"  align="left"><b><?php echo $rslt_contVsl[0]['VSL_TYPE']; ?></b></td>
				</tr>
				<tr>			
					<th style="border:1px solid black; font-size:15px;  border-collapse: collapse;" align="center" class="text-center">#Sl</th>
					<th style="border:1px solid black; font-size:15px;  border-collapse: collapse;" align="center" class="text-center">ROTATION</th>
		...
		<?php
				...
				<tr>
					<td colspan="12" style="border:1px solid black; font-size:12px;  border-collapse: collapse;" align="left">
						<?php echo "<b><font size='3'>Total : ".count($rslt_contVsl)."</font></b>"; ?>						
					</td>
				</tr>
				<tr>
					<td colspan="12" style="border:1px solid black; font-size:12px;  border-collapse: collapse;" align="left">
						<?php echo "<b><font size='3'>Grand Total : ".(count($queryList)+count($rslt_contVsl))."</font></b>"; ?>						
					</td>
				</tr>
		<?php
			}		// if container vessel
