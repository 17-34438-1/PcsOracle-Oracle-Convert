	   ...
	   <section class="panel">
		...
		<section class="panel">
			...
			<div class="panel-body">
					...
					<div class="row">
						<div class="col-sm-12 text-center">
								<form class="form-horizontal form-bordered" method="POST" action="<?php echo base_url().'index.php/Vessel/searchOnOuterVisitedVesselList'; ?>"id="myform" name="myform" onsubmit="return validate()">
									<div class="form-group">
										<label class="col-md-2 control-label">&nbsp;</label>
										<div class="col-md-8">
										 <div class="input-group mb-md">
				...
				<table class="table table-bordered table-responsive table-hover table-striped mb-none" id="datatable-default">
					<thead>
						<tr>
							<th class="text-center" colspan="10"><?php echo "Vessel Visit Info"; ?> </th>
						</tr>
						<tr>
                            <th class="text-center">SL NO</th>
							...
							<th class="text-center">Action</th-->
							<?php 
							if($this->session->userdata('login_id')=="acc") 
							{
							?>
					...
					<tbody>
						...
						<tr class="gradeX">
							...
							?>
							<td align="center">
								<input class="btn btn-xs btn-success" name="delete" type="submit" value="Bill"/>
							</td>
							<?php
							}
							?>
