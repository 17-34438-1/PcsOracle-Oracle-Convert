									...
									<td align="center">
										<?php
											...
											if($rowTotal!=0)
											{
												...
												echo "<nobr>".$rowTotWght->totPack." ".$rowUnits->rcvUnit."</nobr>";
			...
			<tr>
						...
						<td align="center" rowspan="<?php echo $rowTotal;?>">
							<?php echo $rtnTallyList[$i]['import_rotation'];?>
								...
								<?php
									...
									$resTotWght = mysqli_query($con_cchaportdb,$strTotWght);
									$rowTotWght = mysqli_fetch_object($resTotWght);
									$grandTotalPack = $grandTotalPack+$rowTotWght->totPack;
									$grandTotalweight = $grandTotalweight+$rowTotWght->weight;
									?>
				...
				<?php } ?>
					<tr>
						...
						<th align="center"><?php echo $grandTotalPack; ?></th>
						<th align="center"></th>
						<th align="center"><?php echo $grandTotalweight; ?></th>
						<th align="center"></th>
						<th align="center"></th>
					</tr>
		</table>
