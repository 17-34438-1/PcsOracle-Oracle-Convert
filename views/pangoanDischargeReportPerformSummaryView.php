...
//$ddl_imp_rot_no=$_REQUEST['ddl_imp_rot_no']; 
	...
	if($fromdate!="" and $todate!="")	
	{
		...
		//$cond = " where time_in between to_date('$frmDate','yyyy-mm-dd hh24:mi:ss') and to_date('$tDate','yyyy-mm-dd hh24:mi:ss')";
...
<table width="100%" border ='0' cellpadding='0' cellspacing='0'>
	...
	<tr>
		<td colspan="7" align="center"><font size="3"><b>MLO WISE PANGOAN DISCHARGING SUMMARY</b></font></td>					
	</tr>
	...
	<tr bgcolor="#ffffff" align="center">
		...
		<td  align="centre"><font size="3"><b>VOY- <?php echo $voy; ?></b></font></td>
...
<?php
	...
	(CASE WHEN SUBSTR(ref_equip_type.nominal_length,-2) = '20' AND SUBSTR(ref_equip_type.nominal_height,-2)='86'  AND ref_equip_type.iso_group IN ('TN','TD','TG')  THEN 1  
