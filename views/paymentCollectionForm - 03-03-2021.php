...
<div class="row">
	<div class="col-lg-12">						
		<section class="panel">
			...
			$truckQuery="SELECT id,verify_info_fcl_id,import_rotation,cont_no,truck_id,gate_no,driver_name,driver_gate_pass,assistant_name,assistant_gate_pass,visit_time_slot_start,visit_time_slot_end,paid_status, paid_method, paid_amt,paid_collect_dt,paid_collect_by,collect_gate_no,truck_agency_name
		...
		<!-- </div> -->
					...
					<div class="panel-body">
						...
						?>
							<div class="col-sm-12 text-center">
                                <font color="red"><b>Not Paid Yet!</b></font>
                            </div>
						<?php
							}else{
                        ?>
							...
							<div class="col-sm-6 text-left">
								<form action="<?php echo site_url('ShedBillController/truckEntranceApplicationPDF');?>" method="POST" 
									target="_blank">
