	...
	<div class="col-lg-12">						
		<section class="panel">
			<div class="panel-body">
				<form class="form-horizontal form-bordered" method="POST" action="<?php echo site_url("ShedBillController/paymentDataSearch") ?>">
			...
			$truckQuery="SELECT do_truck_details_entry.id,verify_info_fcl_id,verify_other_data_id,import_rotation,cont_no,truck_id,gate_no,driver_name,driver_gate_pass,assistant_name,assistant_gate_pass,visit_time_slot_start,visit_time_slot_end,paid_status, paid_method, paid_amt,paid_collect_dt,paid_collect_by,collect_gate_no,truck_agency_name,u_name,LEFT(do_truck_details_entry.update_by,9) AS agencyCode
		...
		<!-- </div> -->
					...
					<div class="panel-body" style="background-color:#fff;">
                        ...
                        ?>
								<div class="col-sm-12 text-center">
									<form method="POST" action="<?php echo site_url("ShedBillController/paymentStsCng") ?>" onsubmit="return confirm('Are You Sure?');">
                        ...
                        ?>
							...
							<div class="col-sm-3 text-center">
								<form action="<?php echo site_url('ShedBillController/vehicleGatePass');?>" method="POST" 
									target="_blank">
							...
							<div class="col-sm-4 text-left">
								<form action="http://192.168.3.30:8095/tosprint.php" method="post">
									<input type="hidden" name="VISITNO" value="<?php echo $trucVisitId; ?>">
									...
									<input type="submit" class="btn btn-primary" value="Print to Biometric Printer" class="button">
								</form>
							</div>
                        <?php
                            	}
