		...
		<div class="col-md-12">
			<section class="panel">
				...
				<div class="panel-body">					
					<form class="form-horizontal form-bordered" name= "berthWiseVesselReport" onsubmit="return(validate());" action="<?php echo site_url("pilotageApp/ReportController/PilotWiseReportPdf");?>" target="_blank" method="POST">
