...
-->
	...
	<BODY>
		...
		<div style="background-color: lightblue;height:1050px;">
				...
				<tr>
					<td align="left">1.</td>
					<td align="left" style="width:200px; font-size: 12px;">VESSELS NAME :   <u>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $rtnVesselDetails_n4[0]['Vessel_Name']?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </u></td>
								<td align="left" style="width:200px; font-size: 12px;">CALL SIGN :<u>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $rtnVesselDetails_n4[0]['radio_call_sign']?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </u></td>
								<td align="left" style="width:200px; font-size: 12px;">FLAG : <u>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $rtnVesselDetails_n4[0]['flag']; ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </u></td>
											</tr>
											<tr>
												<td align="left">2.</td>
												<td align="left" colspan="3" style="width:700px; font-size: 12px;" >NAME OF MASTER : <u>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $rtnVesselDetails_n4[0]['Name_of_Master']?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </u></td>
											</tr>
											<tr>                                
												<td align="left">3.</td>
								...
								<td align="left" style="width:200px; font-size: 12px;">NRT : <u>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $rtnVesselDetails_n4[0]['net_registered_ton']?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </u></td>
												<td align="left" style="width:160px; font-size: 12px;">DECK CARGO : <u>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $rtnVesselDetails_n4[0]['Deck_cargo']?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </u></td>
											</tr>
											<tr>
												<td align="left">4.</td>
								<td align="left" style="width:250px; font-size: 12px;">LOA : <u>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $rtnVesselDetails_n4[0]['loa_cm']?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </u></td>
											...
											<tr>
												<td align="left">6.</td>
								<td align="left" colspan="3" style="width:500px;font-size: 12px;" >NAME AND ADDRESS OF OWNERS: <u>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $rtnVesselDetails_n4[0]['Vessel_Name']?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </u></td>						
											</tr>
											<tr>
												<td align="left">7.</td>
								<td align="left" style="width:200px; font-size: 12px;">LOCAL AGENT : <u>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $rtnVesselDetails_n4[0]['localagent']?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </u></td>
												<td align="left" style="width:200px; font-size: 12px;">LAST PORT : <u>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <?php  echo "BDCGP"?> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </u></td>
												<td align="left" style="width:145px; font-size: 12px;">NEXT PORT : <u>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo "PNGA";?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </u></td>	
											</tr>
											<tr>
												<td align="left">8.</td>
		...
		<div style="page-break-after: always;background: #eaf9a7; height:1050px;">
			<table class="tbl" width="100%" border ='0' cellpadding='0' cellspacing='0' >
				...
				<tr align="left">
					<td colspan="4"><font size="2px">1. VESSEL NAME : <u><?php echo $rtnVesselDetails_n4[0]['Vessel_Name']; ?></u></font></td>
				...
				<tr align="left">
					<td colspan="10"><font size="2px">2. NAME OF MASTER : <u><?php echo $rtnVesselDetails_n4[0]['Name_of_Master']; ?></u></font></td>
				</tr>
				<tr align="left">
					...
					<td colspan="3">DECK CARGO : <u><?php echo $rtnVesselDetails_n4[0]['Deck_cargo']; ?></u></td>
				</tr>
				<tr align="left">
		...
		<div style="background: #E6E45A; font-family: Times New Roman;font-size: 10px; height:1050px;">
			<table class="tbl" width="100%" border ='0' cellpadding='0' cellspacing='0' >
				...
				<tr align="left">
					<td colspan="4">1.&nbsp;&nbsp;&nbsp;VESSEL NAME : <u><?php echo $rtnVesselDetails_n4[0]['Vessel_Name']; ?></u></td>
				...
				<tr align="left">
					<td colspan="10" class="lbl">2.&nbsp;&nbsp;&nbsp;NAME OF MASTER : <u><?php echo $rtnVesselDetails_n4[0]['Name_of_Master']; ?></u></td>
				</tr>
				<tr align="left">
						<td colspan="3">3.&nbsp;&nbsp;&nbsp;GRT : <u><?php echo $rtnVesselDetails_n4[0]['gross_registered_ton']; ?></u></td>
						<td colspan="3">NRT : <u><?php echo $rtnVesselDetails_n4[0]['net_registered_ton']; ?></u></td>
						<td colspan="4">DECK CARGO : <u><?php echo $rtnVesselDetails_n4[0]['Deck_cargo']; ?></u></td>
				</tr>
				<tr align="left">
						<td colspan="4">4.&nbsp;&nbsp;&nbsp;LOA : <u><?php echo $rtnVesselDetails_n4[0]['loa_cm']; ?></u></td>
				...
				<tr align="left">
						...
						<td colspan="3">LAST PORT : <u><?php  echo "BDCGP"?></u></td>
						<td colspan="3">NEXT PORT : <u><?php  echo "PNGA"?></u></td>
				</tr>
				<tr align="left">
