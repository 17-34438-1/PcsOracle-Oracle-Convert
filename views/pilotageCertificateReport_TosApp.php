	...
	<BODY style="background-color: green;">
		<?php if($activity_for=="incoming"){ ?>
			...
			<table class="tbl" width="100%" border ='0' cellpadding='0' cellspacing='0' style="line-height:20px;">	
				<tr>
					<td colspan="4" style="font-size: 15px;">1. VESSELS NAME :<u><?php echo $rtnVesselDetails_n4[0]['Vessel_Name'];?></u></td>
				...
				<tr>
					<td colspan="5" style="font-size: 15px;">7. LOCAL AGENT: <u><?php echo $rtnVesselDetails_n4[0]['localagent'];?></u></td>
					<td colspan="2" style="font-size: 15px;">LAST PORT: <u><?php	?></u></td>
					<td colspan="3" style="font-size: 15px; text-align: left;">NEXT PORT: <u><?php ?></u></td>	
				</tr>
				<tr>
					<td colspan="4" style="font-size: 15px;">8. NAME OF PILOT: <u><?php if($pilot_name !=""){ echo $pilot_name;}else { echo ""; }?></u></td>
			  ...
			  <tr>
				...
				<tr>
					<td colspan="10" style="font-size: 15px;">24.REMARKS IF ANY : <?php echo $rtn_vsl_arrival_info[0]['remarks'];?></td>
				</tr>
				...
				<tr>
					<td colspan="5"  style="font-size: 15px; text-align: center;"><?php echo $rtn_vsl_arrival_info[0]['sign_arraival'];  ?></td>
		...
		<?php }else if ($activity_for=="shifting") { ?>
			<div style="background-color: #6da38a;height: 100%;">
				...
				<table class="tbl" width="100%" border ='0' cellpadding='0' cellspacing='0' style="line-height:20px; ">	
					<tr>
						<td colspan="4" style="font-size: 15px;">1. VESSEL NAME : <u><?php echo $rtnVesselDetails_n4[0]['Vessel_Name']; ?></u></td>
					...
					<tr>
						...
						<td colspan="3"  style="font-size: 15px;">BOARDED AT : <u><?php echo $rslt_show_current_data[0]['pilot_on_board'];  ?></u></td>
						<td colspan="3"  style="font-size: 15px;">LEFT AT : <u><?php echo $rslt_show_current_data[0]['pilot_off_board']; ?></u></td>
					</tr>
					<tr>
					...
					<tr>
						<td colspan="10" style="font-size: 15px;">19.REMARKS IF ANY : <?php echo $rslt_show_current_data[0]['remarks'];?></td>
					</tr>
					...
					<tr>
						<td colspan="5" style="font-size: 15px; text-align: center;"><?php echo $rslt_show_current_data[0]['sign_shift'];  ?></td>
						<td colspan="5" style="font-size: 15px; text-align: center;" ><?php if($rtn_vsl_arrival_info[0]['photo_base_64'] != "" || $rtn_vsl_arrival_info[0]['photo_base_64'] != null){ ?><img height="50px" width="190px" src="data:image/jpeg;charset=utf-8;base64,<?php echo $rtn_vsl_arrival_info[0]['photo_base_64']; ?>"/> <?php } ?></td>
					</tr>
		...
		<?php }else if($activity_for=="outgoing"){ ?>
			...
			<table class="tbl" width="100%" border ='0' cellpadding='0' cellspacing='0' style="line-height:15px; ">	
				...
				<tr>
					<td colspan="4" style="font-size: 15px;">&nbsp;7.NAME OF PILOT : <u><?php  if($pilot_name !=""){ echo $pilot_name;} else { echo ""; }?></u></td>
					<td colspan="3" style="font-size: 15px;">BOARDED AT : <u><?php  echo $rtnVesselDetails_depart[0]['pilot_on_board']; ?></u></td>
					<td colspan="3" style="font-size: 15px;">LEFT AT : <u><?php echo $rtnVesselDetails_depart[0]['pilot_off_board'];   ?></u></td>
				
				</tr>
				<tr>
					<td colspan="4" style="font-size: 15px;">&nbsp;8.PILOTAGE FROM : <u><?php echo $rtnVesselDetails_depart[0]['pilot_frm'];   ?></u></td>
					<td colspan="6" style="font-size: 15px;">TO : <u><?php  echo $rtnVesselDetails_depart[0]['pilot_to']; ?></u></td>
					</tr>
				<tr>
				...
				<tr>
					<td colspan="4" style="font-size: 15px;">10.DATE OF DEPARTURE : <u><?php  echo $rtnVesselDetails_depart[0]['atd']; ?></u></td>
					<td colspan="6" style="font-size: 15px;">DEP.DRAFT(MAX) : </td>
				</tr>
				<tr>
					<td colspan="4" style="font-size: 15px;">11.TIME OF UNMOORING FROM : <u><?php  echo $rtnVesselDetails_depart[0]['mooring_frm_time']; ?></u></td>
					<td colspan="6" style="font-size: 15px;">TO : <u><?php echo $rtnVesselDetails_depart[0]['mooring_to_time'];  ?></u></td>
				</tr>
				<tr>
					<td colspan="4" style="font-size: 15px;">12.CPA TUG/TUGS(NAME) : <u><?php echo $rtnVesselDetails_depart[0]['aditional_tug'];  ?></u></td>
					<td colspan="4" style="font-size: 15px;">ASSISTANCE FROM : <u><?php  echo $rtnVesselDetails_depart[0]['assit_frm']; ?></u></td>
					<td colspan="2" style="font-size: 15px;">TO : <u><?php  echo $rtnVesselDetails_depart[0]['assit_to']; ?></u></td>
				</tr>
				<tr>
				...
				<tr>
					<td colspan="10" style="font-size: 15px;">23.REMARKS IF ANY :  <?php echo $rtnVesselDetails_depart[0]['remarks'];?></td>
				</tr>
				...
				<tr><td colspan="10">&nbsp;</td></tr>
				<tr>
					<td colspan="5" style="font-size: 15px; text-align:center;"><?php echo $rtnVesselDetails_depart[0]['sign_depart']; ?></td>	
		...
		<?php }else if ($activity_for=="cancel") { ?>
			...
			<table class="tbl" width="100%" border ='0' cellpadding='0' cellspacing='0' style="line-height:20px;">
				...
				<tr align="left">
					...
					<td colspan="3"><font size="2px">CALL SIGN : <u><?php echo $rtnVesselDetails_igm[0]['radio_call_sign']; ?></u></font></td>
				...
				<tr align="left">
					<td colspan="5">3. GRT : <u><?php echo $rtnVesselDetails_igm[0]['gross_registered_ton']; ?></u></td>
					<td colspan="5">NRT : <u><?php echo $rtnVesselDetails_igm[0]['net_registered_ton']; ?></u></td>
				</tr>
				<tr align="left">
				...
				<tr align="left">
					<td colspan="10" class="lbl">5. LOCAL AGENT : <u><?php echo $rtnVesselDetails_igm[0]['localagent']; ?></u></td> 
				...
				<tr><td colspan="10">&nbsp;</td></tr>
				<tr>
					<td  colspan="5" style="font-size: 15px; text-align: center;"><?php echo $rslt_show_current_data[0]['sign_cancel']; ?></td>
					<td  colspan="5" style="font-size: 15px; text-align: center;" ><?php if($rtn_vsl_arrival_info[0]['photo_base_64'] != "" || $rtn_vsl_arrival_info[0]['photo_base_64'] != null){ ?><img height="50px" width="190px" src="data:image/jpeg;charset=utf-8;base64,<?php echo $rtn_vsl_arrival_info[0]['photo_base_64']; ?>"/> <?php } ?></td>
				</tr>
