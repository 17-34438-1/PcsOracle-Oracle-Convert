	...
	<BODY style="background-color: green;">
		...
		<div style="background-color: lightblue;height: 100%;">
			...
			<table class="tbl" width="100%" border ='0' cellpadding='0' cellspacing='0' style="line-height:20px;">
				<tr>
					<td align="left">1.</td>
					<td align="left" style="width:200px; font-size: 15px;">VESSELS NAME :   <u>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $rtnVesselDetails_igm[0]['Vessel_Name']?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </u></td>
					<td align="left" style="width:200px; font-size: 15px;">CALL SIGN :<u>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $rtnVesselDetails_n4[0]['radio_call_sign']?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </u></td>
					<td align="left" style="width:200px; font-size: 15px;">FLAG : <u>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $rtnVesselDetails_n4[0]['cntry_name']?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </u></td>
				</tr>
				<tr>
					<td align="left">2.</td>
					<td align="left" colspan="3" style="width:700px; font-size: 15px;" >NAME OF MASTER : <u>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $rtnVesselDetails_igm[0]['Name_of_Master']?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </u></td>
				</tr>
				<tr>                                
					<td align="left">3.</td>
					<td align="left" style="width:200px; font-size: 15px;">GRT : <u>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $rtnVesselDetails_n4[0]['gross_registered_ton']?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </u></td>
					<td align="left" style="width:200px; font-size: 15px;">NRT : <u>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $rtnVesselDetails_n4[0]['net_registered_ton']?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </u></td>
					<td align="left" style="width:160px; font-size: 15px;">DECK CARGO : <u>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $rtnVesselDetails_igm[0]['Deck_cargo']?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </u></td>
				</tr>
				<tr>
					<td align="left">4.</td>
					<td align="left" style="width:250px; font-size: 15px;">LOA : <u>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $rtnVesselDetails_n4[0]['loa_cm']?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </u></td>
					<td align="left" colspan="2" style="width:300px; font-size: 15px;">MAX. FW DRAUGHT : <u>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php // echo $arrivalInfo42[0]['Vessel_Name']?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </u></td>	
				</tr>
				<tr>
					<td align="left">5.</td>
					<td align="left" colspan="3" style="width:500px; font-size: 15px;">NUMBER OF CREW & OFFICER INCLUSIVE MASTER : <u>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $rtn_vsl_arrival_info[0]['Vessel_Name']?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </u></td>
				</tr>
				<tr>
					<td align="left">6.</td>
					<td align="left" colspan="3" style="width:500px;font-size: 15px;" >NAME AND ADDRESS OF OWNERS: <u>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $rtnVesselDetails_igm[0]['Vessel_Name']?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </u></td>						
				</tr>
				<tr>
					<td align="left">7.</td>
					<td align="left" style="width:200px; font-size: 15px;">LOCAL AGENT : <u>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $rtnVesselDetails_n4[0]['localagent']?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </u></td>
					<td align="left" style="width:200px; font-size: 15px;">LAST PORT : <u>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <?php // echo $arrivalInfo42[0]['Vessel_Name']?> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </u></td>
					<td align="left" style="width:145px; font-size: 15px;">NEXT PORT : <u>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php // echo $arrivalInfo42[0]['Vessel_Name']?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </u></td>	
				</tr>
				<tr>
					<td align="left">8.</td>
					<td align="left" style="width:200px; font-size: 15px;">NAME OF PILOT : <u>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $pilot_name?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </u></td>
					<td align="left" style="width:200px; font-size: 15px;">BOARDED : <u>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $rtn_vsl_arrival_info[0]['pilot_on_board']?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </u></td>
					<td align="left" style="width:200px; font-size: 15px;">LEFT : <u>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $rtn_vsl_arrival_info[0]['pilot_off_board']?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </u></td>	
				</tr>
				<tr>
					<td align="left">9.</td>
					<td align="left" style="width:200px; font-size: 15px;">PILOTAGE FROM : <u>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $rtn_vsl_arrival_info[0]['pilot_frm']?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </u></td>	
					<td align="left" style="width:200px; font-size: 15px;">TO : <u>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $rtn_vsl_arrival_info[0]['pilot_to']?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </u></td>						
				</tr>
				<tr> 
					<td align="left">10.</td>
					<td align="left" style="width:170px; font-size: 15px;">TIME OF MOORING FROM: <u>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $rtn_vsl_arrival_info[0]['mooring_frm_time']?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </u></td>	
					<td align="left" style="width:200px; font-size: 15px;">TO: <u>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $rtn_vsl_arrival_info[0]['mooring_to_time']?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </u></td>						
				</tr>
				 <tr>
					<td align="left">11.</td>
					<td align="left" style="width:150px; font-size: 15px;">CPA TUG/TUGS(NAME): <u>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $rtn_vsl_arrival_info[0]['aditional_tug']?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </u></td>	
					<td align="left" style="width:220px; font-size: 15px;">ASSISTANCE FROM : <u>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $rtn_vsl_arrival_info[0]['assit_frm']?>&nbsp;&nbsp;&nbsp;&nbsp;</u></td>	
					<td align="left" style="width:150px; font-size: 15px;">TO : <u>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $rtn_vsl_arrival_info[0]['assit_to']?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </u></td>						
				</tr>
				<tr> 
					<td align="left">12.</td>
					<td align="left" style="width:100px; font-size: 15px;">ARRIVAL AT OUTER ANCHORAGE DATE : <u>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $rtn_vsl_arrival_info[0]['oa_dt']?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </u></td>		
					<td align="left" colspan="2" style="width:300px; font-size: 15px;">FW. DRAFT (MAX): <u>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php // echo $rtn_vsl_arrival_info[0]['Vessel_Name']?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </u></td>						
				</tr>
				<tr>
					<td align="left">13.</td>
					<td align="left" style="width:400px; font-size: 15px;">IF WORKED AS LIGHTER, NAME OF MOTHER VESSEL : <u>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php // echo $rtn_vsl_arrival_info[0]['Vessel_Name']?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </u></td>						
				</tr>
				<tr>
					<td align="left">14.</td> 
					<td align="left"colspan="3" style="width:400px; font-size: 15px;">WORKED AT OUTER ANCHORAGE / OUTAGE PORT LIMIT.(TICK)</td>						
				</tr>
				<tr>
					<td align="left">15.</td>
					<td align="left" colspan="3" style="width:400px; font-size: 15px;">DANGEROUS CARGO IF ANY : <u>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php // echo $rtn_vsl_arrival_info[0]['Vessel_Name']?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </u></td>						
			  </tr>
			</table>
			<table class="tbl" width="100%" border ='0' cellpadding='0' cellspacing='0'  style="line-height:20px;">
				<tr>
					<td align="left">16.</td>
					<td  align="left" style="width:300px; font-size: 15px;">MAIN ENGINES IN GOOD WORKING CONDITION?</td> YES
					<td align="left" style="font-size: 15px;">  &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp;<img src="<?php echo IMG_PATH?>check_mark_icon.jpg" />&nbsp;YES  &nbsp; &nbsp; &nbsp; &nbsp;<input type="checkbox" class="radio"  style="width:80px; font-size: 15px;" id="twoAnchorNo" name="twoAnchorNo" >NO </td>
				</tr>
				<tr>
					<td align="left">17.</td>
				...
				<tr>
				   <td align="left">23.</td>
					<td align="left" style="width:250px; font-size: 15px;">NOS OF GOOD MOORING LINES: FORD:  <u>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </u></td>	
					<td align="left" style="width:250px; font-size: 15px;">AFT : <u>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</u></td>			
				</tr>			
				<tr>
					<td align="left">23.</td>
					<td align="left" style="width:250px; font-size: 15px;">STERN POWER AVAILABLE :  <u>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </u></td>	
					<td align="left" style="width:250px; font-size: 15px;">IMMEDIATELY : <u>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</u> SECS. LATER</td>												
				</tr>
				<tr>
					<td align="left">24.</td>
					<td align="left" colspan="2"  style="width:470px;">REMARKS IF ANY : <?php // echo $rtn_vsl_arrival_info[0]['Vessel_Name']?></td>
				</tr>
				...
				<tr>
					<td colspan="4">&nbsp;</td>
					<td colspan="4" ><?php if($rtn_vsl_arrival_info[0]['photo_base_64'] != "" || $rtn_vsl_arrival_info[0]['photo_base_64'] != null){ ?><img height="50px" width="190px" src="data:image/jpeg;charset=utf-8;base64,<?php echo $rtn_vsl_arrival_info[0]['photo_base_64']; ?>"/> <?php } ?></td>
				</tr>
		...
		?>
		<div style="page-break-after: always;background: #eaf9a7;height: 100%; ">
			<table class="tbl" width="100%" border ='0' cellpadding='0' cellspacing='0' style="line-height:20px;">
				<tr align="center">
					<td  colspan="10" align="center">  
						<img src="<?php echo ASSETS_WEB_PATH;?>fimg/cpaLogo.png" alt="Chattogram Port Authority Logo"/><br>
				...
				<tr align="left">
					<td colspan="4" class="lbl">7. NAME OF PILOT : <u><?php if($pilot_name !=""){ echo $pilot_name;}else { echo ""; }   //if(count($rslt_show_current_data)>0) { echo $rslt_show_current_data[0]['pilot_name']; } else { echo ""; } ?></u></td>
				...
				<tr align="left">
					<td colspan="4" >9. TIME OF MOORING/UNMOORING FROM : <u><?php if(count($rslt_show_current_data)>0) { echo $rslt_show_current_data[0]['mooring_to_time']; } else {echo "";} ?></td>
					<td colspan="3">TO : <u><?php if(count($rslt_show_current_data)>0) { echo $rslt_show_current_data[0]['mooring_frm_time']; } else {echo "";} ?></u></td>
				...
				<tr><td colspan="4">&nbsp;</td></tr>
				<tr align="left">
					<td colspan="100%">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;CERTIFIED THAT THE ABOVE PARTICULARS ARE CORRECT AND CHARGES THEREOF</td>						
				</tr>
				<tr align="left">
					<td  colspan="100%">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;WILL BE PAID BY US/LOCAL AGENT INCLUSIVE OF OTHER PORT CHARGES.</td>						
				</tr>
				<tr><td colspan="4">&nbsp;</td></tr>
				<tr>
					<td colspan="4">&nbsp;</td>
				...
				<tr>
					<td colspan="4" class="lbl"><?php 
								if($rslt_show_current_data[0]['photo_base_64'] != "" || $rslt_show_current_data[0]['photo_base_64'] != null){ ?><img height="50px" width="190px" src="data:image/jpeg;charset=utf-8;base64,<?php echo $rslt_show_current_data[0]['photo_base_64']; ?>"/> <?php } ?></td>	
		...
		<?php } else {
		?>
		<div style="background: #E6E45A; font-family: Times New Roman;font-size: 10px;">
			<table class="tbl" width="100%" border ='0' cellpadding='0' cellspacing='0' style="line-height:20px;">
				<tr align="center">
					<td  colspan="10" align="center">  
						<img src="<?php echo ASSETS_WEB_PATH;?>fimg/cpaLogo.png" alt="Chattogram Port Authority Logo"/><br>
				...
				<tr align="left">
						<td colspan="3">7.&nbsp;&nbsp;&nbsp;NAME OF PILOT : <u><?php  if($pilot_name !=""){ echo $pilot_name;} else { echo ""; }  //if($chk_igm_id>0) { echo $rtnVesselDetails_depart[0]['pilot_name']; } else { echo "---------"; } ?></u></td>
					...
					<tr><td colspan="4">&nbsp;</td></tr>
						...
						<td colspan="4" >
							<?php 
								if($rtnVesselDetails_depart[0]['photo_base_64'] != "" || $rtnVesselDetails_depart[0]['photo_base_64'] != null){ ?><img height="50px" width="190px" src="data:image/jpeg;charset=utf-8;base64,<?php echo $rtnVesselDetails_depart[0]['photo_base_64']; ?>"/> <?php } ?></td>
						</tr>

						<tr>
						<td colspan="4" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<u>&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $rtnVesselDetails_depart[0]['sign_arraival']; ?>&nbsp;&nbsp;&nbsp;&nbsp;</u></td>	
						<!--td colspan="4" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<u>&nbsp;&nbsp;&nbsp;&nbsp;<?php echo "2018-09-26";?>&nbsp;&nbsp;&nbsp;&nbsp;</u></td-->
						<td colspan="4">------------------------------------------------------------</td>		
						</tr>
					<!-- -->
