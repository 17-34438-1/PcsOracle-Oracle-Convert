<script type="text/javascript">
	...
	<div class="img">
		<form name= "product_dlv_form" id="product_dlv_form"  action="<?php echo site_url("Report/product_dlv_entry");?>"  method="post">
						<table align="center"  align="center" cellspacing="0" cellpadding="0">
							<tr>
							...
							<tr>
								...
								<td>
									<select id="product_type" name="product_type" onchange="get_product_name(this.value);" >
										...
										$rslt_product_type=mysqli_query($con_cchaportdb,$sql_product_type);
										
										while($row_product_type=mysqli_fetch_object($rslt_product_type))
										{
...
<!--							<tr>
							...
							<td align="center" ><font color='red'><b>*</b></font>Handover To : </td>
								<td>
										<select  id="handover_to" name="handover_to" style="width:215px;" onchange="showUsr(this.value)">
											...
											<?php 
											if($editflag==1)  { $hand_to= $delv_details[0]['handover_to']; ?> 
							...
							<tr id="ownerTr"  <?php  if ($editflag==1){ if ($delv_details[0]['handover_to']!='owner') { ?>  style="display: none" <?php } } ?>>
...
<!--                              <th align=""><nobr>&nbsp; &nbsp;&nbsp; : &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</nobr></th>-->
								<td>
									<select  id="ownar_id" name="ownar_id" style="width:215px;" value="" >
												<option value="">--Select--</option>
												 ...
												 <?php if($editflag==1){if($editflag==1 && $hand_to=="owner"){?> 
							...
							<tr id="userTr"   <?php  if ($editflag==1){ if ($delv_details[0]['handover_to']!='user') { ?>  style="display: none" <?php } } ?> >
								<td align="center"><nobr>Handover To User  : </nobr></td>
								<td>
									<select  id="usr_id" name="usr_id" style="width:215px;" value="" >
												<option value="">--Select--</option>

											 <?php if($editflag==1){ if($editflag==1 && $hand_to=="user"){?> 
												<option value="<?php echo $delv_details[0]['handover_owner_user_id']; ?>" selected="true"><?php echo $delv_details[0]['owner_user']; ?></option>
											 <?php } } ?> 
							...
							<tr>
								...
								<td>
								<input type="date" style="width:150px;" id="handover_date" name="handover_date"  <?php if($editflag==1){ ?> value="<?php echo $delv_details[0]['handover_date'];  }?>"/>
								</td>
							...
							<tr>
								...
								<td>
									<textarea id="comments" name="comments" rows="2" ><?php if($editflag==1) { echo $delv_details[0]['comments']; }  ?> </textarea>
								</td>
							</tr>
							<tr>
								<td>&nbsp;</td>
