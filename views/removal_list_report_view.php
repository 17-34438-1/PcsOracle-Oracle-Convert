		...
		<td>
			<table style="border-collapse:collapse;" border="1">
				...
				for($i=0;$i<count($rslt_removal_list);$i++)
				{
					...
					$query2="SELECT ctmsmis.cont_block('$slot','$row->Yard_No') AS Block_No ";
					$res2=mysqli_query($con_sparcsn4,$query2);
				...
				<tr>
					...
					<td align="center"><?php echo $row2->Block_No; ?></td>
					<td align="center"><?php echo $row->Yard_No; ?></td>
					<td align="center"></td>
					<td align="center"><?php echo $rslt_removal_list[$i]['REMARK']?></td>
				</tr>
				<?php
				}
				?>
