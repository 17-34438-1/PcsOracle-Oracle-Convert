	...
	function chkDataForRO()
	{
		...
		xmlhttp.onreadystatechange=function() {
			...
			{			
				...
				if(jsonData.stat==0)
				{					
					document.getElementById('btnSubmitRO').style.display = "none";
					document.getElementById('resMsg').style.display = "block";
					document.getElementById('msgText').innerHTML = jsonData.msg;
				}
				else
				{
					document.getElementById('btnSubmitRO').style.display = "block";
					document.getElementById('resMsg').style.display = "none";
				}
			}
		}
		var url="<?php echo site_url('Report/chkDataForRO')?>?blNo="+blNo+"&rotNo="+rotNo;
		// alert(url);
				...
				<div class="col-lg-12">						
					<section class="panel">						
						<div class="panel-body">
							<!--form class="form-horizontal form-bordered" id="myform" method="POST" action="<?php echo site_url('report/releaseorderpdf') ?>" onsubmit="return getVerifyNo()" target="_blank"-->
							<form class="form-horizontal form-bordered" id="myform" method="POST" action="<?php echo site_url('report/submitRO') ?>" onsubmit="return chkBlank()" >
								<!--input type="hidden" name="submitStat" id="submitStat" value="<?php echo $submitStat; ?>" /-->
								<div class="form-group">
									...
									<div id="btnSubmitRO" class="row" style="display:none">
										<div class="col-sm-12 text-center">											
