					...
					<div class="invoice">
						<header class="clearfix">
							...
							<div class="row">
								...
								<div class="col-sm-3 col-md-offset-3 text-left mt-md mb-md text-bold">
							...
							<table class="table table-responsive table-bordered table-hover mb-none">
								...
								<tbody>
									<?php 
										...
										for($i=0; $i<count($bill_rslt); $i++) { ?>
											<tr class="gradeX">
												...
												<td align="center">
													<?php  if (strpos($bill_rslt[$i]['vatbd'], '.') !== false) {
									...
									<?php 
										 ...
										 $vatbd=isset($bill_rslt[$i]['vatbd']) ? $bill_rslt[$i]['vatbd'] : 0;
									} 
									...
									?>
										<tr align="center" class="gradeX">
											...
											<th class="text-center">
												<?php if (strpos($totalUSDCharge, '.') !== false) {
													echo $totalUSDCharge;
												} else {
										...
										<tr align="center" class="gradeX">
											...
											<th class="text-center">
												<?php  if (strpos($totalBDTCharge, '.') !== false) {
													echo $totalBDTCharge;
												} else {
						...
						<div class="row">
							...
							<div class="col-sm-9 col-sm-offset-3 mt-md">
								<p><b>IN WORDS:- </b> <?php  echo numtowords($totalBDTCharge)." Only";?></p>
							</div>
							<div class="col-sm-9 col-sm-offset-3 mt-md">
								<p><b>VAT BDT:- </b> <?php echo numtowords($vatbd)." Only";?></p>
							</div>
						</div>
