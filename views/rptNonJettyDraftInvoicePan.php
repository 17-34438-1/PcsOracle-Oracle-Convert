				...
				<div class="panel-body">
					<div class="invoice">
							...
							<table class="table table-responsive table-bordered table-hover mb-none">
								<thead>
									<tr class="gridDark">
										...
										<th class="text-center">VAT(BDT)</th>
									</tr>
								</thead>
								<tbody>
									<?php 
										...
										for($i=0; $i<count($bill_rslt); $i++) { ?>
											<tr class="gradeX">
												...
												<td align="center"><?php echo $bill_rslt[$i]['rateBilled'];?></td>
												...
												<td align="center">
													<?php if (strpos($bill_rslt[$i]['bdChraged'], '.') !== false) {
														echo $bill_rslt[$i]['bdChraged'];
													} else {
														echo $bill_rslt[$i]['bdChraged'].".000";
													}?>
												</td>
												<td align="center">
													<?php if (strpos($bill_rslt[$i]['bdVat'], '.') !== false) {
														echo $bill_rslt[$i]['bdVat'];
													} else {
														echo $bill_rslt[$i]['bdVat'].".000";
													}?>
												</td>
											</tr>
									<?php 
										...
										$itotalCharge = $total;
										$vatTotalCharge=$vatTotal;
									?>
										<tr align="center" class="gradeX">
											<th colspan="7" class="text-center">Total TK:</th>
											<th class="text-center">
												<?php  if (strpos(isset($bill_rslt[0]['itotalCharge']) ? $bill_rslt[0]['itotalCharge'] : "", '.') !== false) {
													echo isset($bill_rslt[0]['itotalCharge']) ? $bill_rslt[0]['itotalCharge'] : "";
												} else {
													echo isset($bill_rslt[0]['itotalCharge']) ? $bill_rslt[0]['itotalCharge'] : "".".00";
												}?>
											</th>
											<th class="text-center">
												<?php  if (strpos(isset($bill_rslt[0]['vatTotalCharge']) ? $bill_rslt[0]['vatTotalCharge'] : "", '.') !== false) {
													echo isset($bill_rslt[0]['vatTotalCharge']) ? $bill_rslt[0]['vatTotalCharge'] : "";
												} else {
													echo isset($bill_rslt[0]['vatTotalCharge']) ? $bill_rslt[0]['vatTotalCharge'] : "".".00";
												}?>
											</th>
										</tr>
								</tbody>
						...
						<div class="row">
							...
							<div class="col-sm-9 col-sm-offset-3 mt-md">
								<p><b>VAT:- </b> <?php  echo numtowords($vatTotal)." Only";?></p>
							</div>
						</div>
						<div class="invoice-summary">
							...
							<div class="row">
								...
								<div class="col-sm-12 mt-md">
									...
									PRINT DATE:- <?php echo isset($print_time[0]['Time']) ? $print_time[0]['Time'] : ""; ?>
									</p>
								</div>
								<div class="col-sm-12 mt-md">
									<p>
