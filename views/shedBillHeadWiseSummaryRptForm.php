...
<script>
    function validate()
    {
        ...
        if( document.myForm.todate.value == "" )
        {
            ...
            return false;
        }if( document.myForm.unitNo.value == "" )
    {
        alert( "Please provide Unit!" );
        document.myForm.unitNo.focus() ;
        return false;
    }
                ...
                <section class="panel">
                    ...
                    <div class="panel-body">
                        <form name="myForm" id="myForm"  class="form-horizontal form-bordered"
                              action="<?php echo site_url("ShedBillController/shedBillHeadWiseSummaryRptView");?>" method="post" onsubmit="return validate()" target="_blank">
                            ...
                            <div class="form-group">
                                <label class="col-md-3 control-label" for="inputSuccess">Unit :</label>
                                <div class="col-md-3">
                                    <select class="form-control input-sm mb-md" name="unitNo" id="unitNo">
