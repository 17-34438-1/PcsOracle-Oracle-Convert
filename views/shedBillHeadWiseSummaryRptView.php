...
if($_POST['options']=='html'){?>
    ...
    <a href="<?php echo site_url('ShedBillController/shedBillHeadWiseSummaryRptView/'.'print'.'/'.$from_dt.'/'.$to_dt.'/'.$unitNo)?>" target="_blank" class="btn btn-primary ml-sm"><i class="fa fa-print"></i> Print</a>
    </div>
	</BODY>
</HTML>
<?php }?>
