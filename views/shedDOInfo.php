        ...
        <section class="panel">
            <div class="panel-body">
				<form class="form-horizontal form-bordered" method="POST" id="myform" name="myform" 
					action="<?php echo base_url().'index.php/ShedBillController/shedDeliveryOrderInfoData'; ?>" onsubmit="return validate()">
			...
			<div class="panel-body">
				<?php if($frmType=="search" or $frmType=="inserted" or $frmType=="deleted") { 
					...
					<form method="POST" enctype="multipart/form-data" 
							action="<?php echo site_url("ShedBillController/shedDeliveryOrderInfoEntry") ?>">
							...
							<tr>
								...
								<td align="center">
									...
									<input type="date" name="valid_upto" id="valid_upto" 
										style="width:150px;height:30px;text-align:center;"
								...
								<td colspan="6">
									<table border="1" style="border-collapse:collapse;" align="center" width="100%">
										<tr>
											...
											<th class="text-center">Size/Type/Height</th>
