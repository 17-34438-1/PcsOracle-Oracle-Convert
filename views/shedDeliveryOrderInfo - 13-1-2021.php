...
<script language="JavaScript">
	...
	// 	}
	// 	var url = "<?php //echo site_url('AjaxController/getBl');?>?rotaion_no="+val;
	// 	//alert(url);
	// 	xmlhttp.onreadystatechange=stateChangeBl;
	// 	xmlhttp.open("GET",url,false);
	// 	xmlhttp.send();
	// }
			
	// function stateChangeBl()
	// {
	// 	//alert(xmlhttp.responseText);
	// 	if (xmlhttp.readyState==4 && xmlhttp.status==200) 
	// 	{
	// 	  var selectList=document.getElementById("blno");
	...
	// 			option.value = jsonData[i].BL_No;
	// 			option.text = jsonData[i].BL_No;
	...
	// 	var url = "<?php //echo site_url('AjaxController/getCNFName');?>?bb_cnf_lic_no="+cnflicno;
	// 	//alert(url);
	...
	// 		for (var i = 0; i < jsonData.length; i++) 
	// 		{
	// 			cnfName = jsonData[i].name;
	// 		}
	// 		document.getElementById("cnfname").value=cnfName;
	// 		return true;
	// 	}
	// }
                                    ...
                                    <tr>
                                        <td colspan="3" valign="top" align="left">
                                            <p>
												...
												?>
                                                <input type="text" name="cnfname" id="cnfname" value="<?php echo $cfNm; ?>"
