           ...
           <div class="table-responsive">
                ...
                ?>
                     <tr class="gradeX"> 
                      ...
                      <td>
                       <?php echo $chargeList[$i]['vatTK']; $totVat+=$chargeList[$i]['vatTK']; ?>
                      </td>
                      <td>
                       <?php echo $chargeList[$i]['mlwfTK']; //$totMlwf+=$chargeList[$i]['vatTK'];?>
                      </td>
                    </tr>
                     <?php
                    }
            ...
            <div class="row">   
                ...
                <table align="center" width="90%" class="table table-bordered table-responsive table-hover table-striped mb-none">
					...
					<tr >
						...
						<td>VAT : <?php echo $totVat; ?></b></td>
						<td>MLWF: <?php echo $totmlwf; ?></b></td>
					</tr>
					<tr>
						<td align="center" colspan="5">
							<b>NET PAYABLE (TK) : <?php echo $tot_sum + $totmlwf+ $totVat;?></b>
						</td>
					</tr>
					<tr>
						<td colspan="5">
							REMARKS :  <?php echo numtowords($tot_sum+$totmlwf+$totVat); ?>
				...
				<table width="100%" border="0">
					<tr>
						<td align="left" width="45%">
							<table style="margin-left:5%;border: 2px solid black">
								 <tr class="gradeX">
									<td>Bank Name</td>
									<td>:</td>
