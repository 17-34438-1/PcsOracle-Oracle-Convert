	...
	<tr bgcolor="#ffffff" align="center" height="100px">
		<td colspan="13" align="center">
			<table border=0 width="100%">
				<tr align="center">
					<td colspan="7"><img height="100px" src="<?php echo ASSETS_WEB_PATH;?>fimg/cpaLogo.png" /></td>
				</tr>
				<tr align="center">
...
<div align="center">
	<table border=0 cellspacing="5" cellpadding="5">		
		...
		<tr>
			...
			WHERE to_date(flex_date01)='$fromdate'  AND config_metafield_lov.mfdch_value NOT IN ('CANCEL') AND a.remark LIKE 'overflow%'
			";

$queryOverflow=oci_parse($con_sparcsn4_oracle,$strQuery);
$rowOverflow=oci_execute($queryOverflow); 
$results=array();
$rowOverflow = oci_fetch_all($strQuery2Res, $results, null, null, OCI_FETCHSTATEMENT_BY_ROW);
oci_free_statement($strQuery2Res);

			// $queryOverflow=mysqli_query($con_sparcsn4,$strQuery);
			// $rowOverflow=mysqli_fetch_object($queryOverflow);
			?>
