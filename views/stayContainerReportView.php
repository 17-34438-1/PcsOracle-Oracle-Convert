...
$ddl_imp_rot_no=@$_REQUEST['ddl_imp_rot_no']; 
	...
	@$row=mysqli_fetch_object($con_sparcsn4,$sql);
...
<tr bgcolor="#ffffff" align="center" height="100px">
		<td colspan="13" align="center">
			<table border=0 width="100%">
				...
				<tr align="center">
					<td colspan="12"><font size="4"><b><!--?php echo $head;?-->Assignment Date Wise Import Container List</b></font></td>
				</tr>
				<tr align="center">
					<td colspan="12"><font size="4"><b>DATE : <?php echo $fromdate; ?>&nbsp;&nbsp;Yard NO : <?php echo $yard_no; ?>&nbsp;&nbsp;Shift : Stay Container</b></font></td>
...
) AS tmp where Yard_No='$yard_no' order by sl,Yard_No,shift,mfdch_desc,cf,proEmtyDate) as tmp2 where stay='1'
");
