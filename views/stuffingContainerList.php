<html>
	...
	<body>
		...
		?>
			<tr>
				<td colspan="12" align="center"><h2><?php echo $name; ?></h2></td>
			</tr>
			<tr>
		...
		<div class="text-right mr-lg">
			<form class="form-horizontal form-bordered" method="POST" action="<?php echo site_url('Report/stuffingContListPrint') ?>" target="_blank">
				...
				<input type="hidden" name="stuffing_date" id="stuffing_date" value="<?php echo $stuffing_date?>" />
				<input type="hidden" name="offdock" id="offdock" value="<?php echo $offdock?>" />
