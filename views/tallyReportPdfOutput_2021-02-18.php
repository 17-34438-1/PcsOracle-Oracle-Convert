					...
					<table border="1" align="center" cellspacing="0" cellpadding="0" width="100%" style="font-size:11px">
						...
						<tr>
							...
							while($rtntallyreport=mysqli_fetch_object($restallyreport)) { 
								...
								$strrcv1 = "select sum(rcv_pack) as rcv_pack,sum(flt_pack) as flt_pack,sum(flt_pack_loc) as flt_pack_loc,sum(loc_first) as loc_first,sum(total_pack) as total_pack,rcv_unit,shed_loc,remarks,shift_name from shed_tally_info 
											where igm_sup_detail_id='$rtntallyreport->id' group by rcv_unit,shed_loc
							...
							?>
								...
								{
								$lim = $totRow-1;
								$strrcv2 = "select sum(rcv_pack) as rcv_pack,sum(flt_pack) as flt_pack,sum(flt_pack_loc) as flt_pack_loc,sum(loc_first) as loc_first,total_pack,rcv_unit,shed_loc,remarks,shift_name 
								from shed_tally_info 
								where igm_sup_detail_id='$rtntallyreport->id' group by rcv_unit,shed_loc
