				...
				<td>
					<table border="1" align="center" cellspacing="0" cellpadding="0" width="100%" style="font-size:11px">
						...
						<tr>
							...
							$sqltallyreport = "SELECT * FROM (SELECT igm_details.id,BL_No AS master_BL_No, Description_of_Goods,Import_Rotation_No,BL_No,igm_detail_container.cont_number,
							...
							WHERE igm_details.Import_Rotation_No='$rotation' AND shed_tally_info.cont_number='$container' 
							...
							while($rtntallyreport=mysqli_fetch_object($restallyreport)) { 
								...
								WHERE igm_detail_id='$rtntallyreport->id' GROUP BY rcv_unit,shed_loc) 
								AS tbl ORDER BY id";
