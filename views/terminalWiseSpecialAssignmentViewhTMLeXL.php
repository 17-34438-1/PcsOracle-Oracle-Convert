...
<BODY>
	...
	<?php } 
		...
		header("Content-Disposition: attachment; filename=TerminalWiseSpecialAssignmentViewhTMLeXL.xls;");
			...
			<div align="center">
				<table align="center">
					...
					<tr>
						...
						<td align="center"><font size="4"><b>TERMINAL: <?php echo $terminal ?></b></font></td>
					</tr>
				</table>
			</div>			
			<div align="center">
