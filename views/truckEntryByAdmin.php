	...
	<section class="panel panel-primary" id="panel-1" data-portlet-item="">
		<header class="panel-heading portlet-handler">
			...
			<div class="panel-body">
				<form class="form-horizontal form-bordered" method="POST" action="<?php echo site_url('ShedBillController/truckEntryByDSForm')?>" id="myform" name="myform">
							...
							?>
								...
								<div class="row">
									<div class="col-md-6">
										<div class="input-group mb-md">
											...
											<input class="form-control" list="driverPassList" name="driverPassNo" id="driverPassNo" value="<?php if(isset($editType) && count($rslt_trkEditInfo)>0){ echo $rslt_trkEditInfo[0]['driver_gate_pass'];}?>" onblur="getDriverInfo()" autocomplete="off">
									...
									<div class="col-md-6">
										<div class="input-group mb-md">
											...
											<input class="form-control" list="assistantPassList" name="assistantPassNo" id="assistantPassNo" value="<?php if(isset($editType) && count($rslt_trkEditInfo)>0){ echo $rslt_trkEditInfo[0]['assistant_gate_pass'];}?>" onblur="getAssistantInfo()" autocomplete="off">
								...
								<div class="row">
									<div class="col-sm-12 text-center">
										...
										?>
										<button type="submit" style="width:70px;" value="<?php if(isset($editType)){?>Update<?php }else{?>Add<?php }?>" name="searchByCnfId" id="searchByCnfId" class="btn btn-primary btn-xs" onclick="return validate()"><?php if(isset($editType)){?>Update<?php }else{?>Add<?php }?></button>
									</div>
								</div>
				...
				<div class="table-responsive" style="padding-top:20px;">
					<table id="truckInfoTbl" class="table table-bordered  table-hover table-striped mb-none" cellspacing="2" cellpadding="2" align="left">
							...
							<tr>
								...
								<td align="center">
									<form method="post" action="<?php echo site_url('ShedBillController/truckEntryByDSForm'); ?>">
								...
								<td align="center">
									<p class="m-none">
										<form method="post" action="<?php echo site_url('ShedBillController/truckPayByAdmin'); ?>">
		...
		<section class="panel panel-primary" id="panel-1" data-portlet-item="">
			...
			<div class="panel-body">
				<form class="form-horizontal" id="paymentDtlForm" name="paymentDtlForm" method="post" action="<?php echo site_url('ShedBillController/truckPayByAdmin'); ?>" onsubmit="return confirmPay()">
