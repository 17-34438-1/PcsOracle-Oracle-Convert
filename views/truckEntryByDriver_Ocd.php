<script>
	...
	function chkBlankField()
	{
		...
		var driverPass = document.getElementById("driverPassNo").value;
		var helperPass = document.getElementById("assistantPassNo").value;
		var driverPhone = document.getElementById("phoneNo").value;
...
<section role="main" class="content-body">
	...
	<section class="panel panel-primary" id="panel-1" data-portlet-item="">
		...
		<div class="panel-body">
				<form class="form-horizontal form-bordered" method="POST" action="<?php echo site_url("ShedBillController/driverOcdTruckVerify") ?>" onsubmit="return chkBlankField();">
