<script>
	...
	function chkBlankField()
	{
		...
		var blNo = document.getElementById("blNo").value.trim();
		var driverPass = document.getElementById("driverPassNo").value.trim();
		var helperPass = document.getElementById("assistantPassNo").value.trim();
		var driverPhone = document.getElementById("phoneNo").value.trim();
		var regCity = document.getElementById("regCity").value.trim();
		var regClass = document.getElementById("regClass").value.trim();
		var truckNo = document.getElementById("truckNo").value.trim();

		if(rot == "")
		{
			alert("Please give a Rotation!");
			return false;
		}
		if(blNo == "")
		{
			alert("Please give a BL!");
			return false;
		}
		if(driverPass == "")
		{
		...
		if(driverPhone == "")
		{
			alert("Please write driver phone no.!");
			return false;
		}
...
<section role="main" class="content-body">
	...
	<section class="panel panel-primary" id="panel-1" data-portlet-item="">
		...
		<div class="panel-body">
				<form class="form-horizontal form-bordered" method="POST" action="<?php echo site_url("ShedBillController/driverShedTruckVerify") ?>" onsubmit="return chkBlankField();">
					<div class="form-group">
						...
						<div class="col-md-6 col-md-offset-3">
							<div class="input-group mb-md">
								...
								<input type="text" name="rot" id="rot" class="form-control login_input_text" autofocus= "autofocus" placeholder="Rotation No" />
							</div>
						</div>	
