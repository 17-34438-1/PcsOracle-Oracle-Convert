                ...
                <div class="form-group col-md-5">
                    <form class="form-horizontal form-bordered" method="POST" action="<?php echo site_url("ShedBillController/driverYardTruckPay") ?>" onsubmit="return chkBlankField();">
                        ...
                        <div class="row" id="applyBtn">
							...
							<div class="col-sm-12 text-center">
                                <font color="red" size="4">You already reached your max limit!</font>
                            </div>
							<?php
									}else{
							?>
							...
							<div class="col-sm-12 text-center">
                                <font color="red" size="4">You can't add emergency truck without port security approvement!</font>
                            </div>
								...
								<tr>
									...
									<td>
										...
										<form class="form-horizontal form-bordered" method="POST" action="<?php echo site_url('ShedBillController/checkoutbyOnline') ?>">
											...
											<input type="hidden" name="cont_status" id="cont_status" value="<?php echo $cont_status;?>">
											<input type="hidden" name="rotNo" id="rotNo" value="<?php echo $rot;?>">
											<button type="submit" name="gatewayType" value="ekpay" class="btn btn-primary btn-xs" disabled/>
												EkPay
											</button>
										</form>
										<?php
