		...
		<div class="panel-body">
            <div class="col-md-12">
                <div class="form-group col-md-5">
                    <form class="form-horizontal form-bordered" method="POST" action="<?php echo site_url("ShedBillController/driverShedTruckPay") ?>" onsubmit="return chkBlankField();">
                        <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="input-group mb-md">
                                ...
                                <input type="text" name="rot" id="rot" class="form-control login_input_text" autofocus= "autofocus" value="<?php echo $rot; ?>" readonly/>
                        ...
                        <div class="col-md-12">
                            <div class="input-group mb-md">
                                ...
                                <input type="text" name="blNo" id="blNo" class="form-control login_input_text" autofocus= "autofocus" value="<?php echo $blNo; ?>" readonly/>
                            </div>
                        </div>
                        ...
                        <div class="col-md-12">
                            <div class="input-group mb-md">
                                <span class="input-group-addon span_width">Truck No</span>
                        ...
                        <div class="row" id="applyBtn">
                            ...
                            <div class="col-sm-12 text-center">
                                ...
                                <button type="submit" name="btnVerify" value="sonalypay" class="mb-xs mt-xs mr-xs btn btn-primary" <?php if($custom_block_status == "DO_NOT_RELEASE"){ echo "disabled";}?>>
                                    SonaliPay
                                </button>
                            </div>
                ...
                <div class="col-md-7">
					<div class="col-md-6" style="padding:0px;">
						...
						<label class="col-md-12 col-form-label">Rotation No: <b><?php echo $rot; ?></b></label>

                        <label class="col-md-12 col-form-label">BL No: <b><?php echo $blNo; ?></b></label>
								...
								<tr>
									...
									<td>
										...
										<form class="form-horizontal form-bordered" method="POST" action="<?php echo site_url('ShedBillController/checkoutbyOnline') ?>">
											<input type="hidden" name="assignmentType" id="assignmentType" value="<?php echo "";?>">
									...
									<td>
										...
										<form class="form-horizontal form-bordered" method="POST" action="<?php echo site_url('ShedBillController/checkoutbyOnline') ?>">
											...
											<input type="hidden" name="cont_status" id="cont_status" value="<?php echo $cont_status;?>">
											<input type="hidden" name="rotNo" id="rotNo" value="<?php echo $rot;?>">
											<button type="submit" name="gatewayType" value="ekpay" class="btn btn-success btn-xs"/>
												EkPay
											</button>
										</form>
										<?php
