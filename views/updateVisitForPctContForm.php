		...
		<div class="col-md-12">
			<section class="panel">
				...
				<div class="panel-body">					
					<form class="form-horizontal form-bordered" action="<?php echo site_url("report/updateVisitForPctContPerformed");?>" method="post" onsubmit="return rtnConrfm()">
						<div class="form-group">
							<label class="col-md-3 control-label">&nbsp;</label>
							<div class="col-md-6">		
								<div class="input-group mb-md">
									<span class="input-group-addon span_width">Rotation No <span class="required">*</span></span>
									<input type="text" name="rot" id="rot" class="form-control login_input_text" >
								</div>
								<div class="input-group mb-md">
									<span class="input-group-addon span_width">Container <span class="required">*</span></span>
									<input type="text" name="cont" id="cont" class="form-control login_input_text" >
								</div>	
								<div class="input-group mb-md">
									<span class="input-group-addon span_width">Category <span class="required">*</span></span>
									<select name="cate" style="width:150px">
										<option value="">---Select--</option>
										<option value="EXPRT">Export</option>
										<option value="STRGE">Storage</option>
									</select>
								</div>												
							</div>
