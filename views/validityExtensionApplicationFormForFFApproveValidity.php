    ...
    <div class="panel-body">
			<div class="row">
				<div class="col-sm-12 col-md-12 text-center">
					<h4 class="h4 mt-none mb-sm text-dark"><b><u>Approve Validity Extension </u></b></h4>
				</div>
				<div class="col-sm-12 col-md-12">
                    ...
                    <form action="<?php echo site_url('EDOController/validityExtendForApproveFF')?>" method="POST" onsubmit="return validityExtend(); ">
                    ...
                    <h6 class="h6 mt-none mb-sm">
						<div class="row">
							...
							<div class="col-md-6 text-left">
                                <label id="bltype"><input type="date" name="validity_extend" id="validity_extend" value="<?php echo $validityDate;?>" class="form-control"/></label>
                            </div>
						</div>
					</h6>
				</div>
					...
					<thead>
						<tr>						
							<th class="text-center">
								...
								<input type="hidden" name="bl_type" id="bl_type" value="<?php echo $bl_type;?>"></input>
								...
								<input type="checkbox" name="checkAll" id="checkAll" onclick="selectAll();" <?php 
								...
								if($countResult==$countSelectedContainerResult){
									echo "checked";
								}
								?>></input>
							</th>							
