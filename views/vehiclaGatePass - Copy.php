...
<html lang="en">
	...
	<?php
			...
			$truckQuery="SELECT do_truck_details_entry.id AS visit_id, verify_info_fcl_id,truck_id,verify_other_data_id,gate_no,driver_name,driver_gate_pass,assistant_name,assistant_gate_pass,visit_time_slot_start,visit_time_slot_end,paid_status, paid_method, paid_amt,paid_collect_dt,paid_collect_by,collect_gate_no,truck_agency_name,u_name
        ...
        <div class="ticket">
			...
			<table>
					...
					<tr>
                        <td><b>Agency : </b><?php echo $truck_agency_name; ?></td>
                    </tr>
            </table>
			<br/>
