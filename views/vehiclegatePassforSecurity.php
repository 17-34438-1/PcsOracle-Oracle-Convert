			...
			<div class="col-lg-12">						
				<section class="panel">
                    ...
                    <div class="ticket">
                        ...
                        ?>
                        <table style="border-top:none;background-color:#c3ecf9;">
                            <tr style="border-top:none;">
                                <td align="center" style="border-top:none;">
                                    <img src="<?php echo $path;?>" height="70px" width="70px" style="padding-left:60px;">
                                </td>
                            </tr>
                        </table>
                    ...
                    <div style="width:54%;padding-left:23%;">
                        <!-- <div style="float:left">
                            <form method="POST" action="<?php //echo site_url("ShedBillController/vehicleGatePass") ?>">
                                <input type="hidden" name="rot_no" value="<?php //echo $rot_no; ?>"/>
                                <input type="hidden" name="cont_no" value="<?php //echo $cont_no; ?>"/>
                                <input type="hidden" name="trucVisitId" value="<?php //echo $trucVisitId; ?>"/>
                                <input type="hidden" name="flag" value="security"/>
                        ...
                        <div style="float:right">
                            <form method="POST" action="<?php if($flag == "FCL"){ echo site_url('ShedBillController/fclTruckEntryformforSecurity');}else{ echo site_url('ShedBillController/lclTruckEntryformforSecurity');} ?>">
