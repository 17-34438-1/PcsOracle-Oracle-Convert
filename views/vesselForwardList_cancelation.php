...
<section role="main" class="content-body">
			...
			<div class="col-lg-12">						
				<section class="panel">
					<div class="panel-body">
						<form class="form-horizontal form-bordered" method="POST" action="<?php echo site_url('Vessel/vslCancelationForwardList'); ?>">
	...
	<div class="col-lg-12">						
		...
		<div class="form-group">
			...
			<form method="POST" enctype="multipart/form-data" action="<?php echo site_url("Vessel/vslCancelationForwardingPerform") ?>" onsubmit="return validate()">
			...
			<table width=100%>
				...
				<tr><td align="center"><u>টেলেক্সঃ ৬৭৬২৫৬ পোর্ট বিজে, ফাক্সঃ- ৮৮-০৩১-২৫১০৮৮৯, ফোনঃ পি এ বি এক্সঃ ২৫২২২০০-২৯</u></td></tr>
				...
				<tr>
					...
					চট্টগ্রাম । <br/>
					বিষয়: <input type="text" style="width:700px; height:25px;" id="filesub" name="filesub" value="<?php echo $dateData; ?> ইং মাসে মুভমেন্ট বাতিল হয়েছে এরুপ জাহাজের চার্জ আদায়করন প্রসঙ্গে।" /> <br/>
					</td>
				</tr>
				<tr><td><br/></td></tr>
				...
				<tr>
					<td align="left">
						গত <?php echo $fromDate." ইং হতে ".$toDate; ?> ইং পর্যন্ত যে সমস্ত জাহাজের মুভমেন্ট বাতিল হয়েছে উহাদের খাতে সংশ্লিষ্ট এজেন্টের নিকট হইতে মুভমেন্ট বাতিলের চার্জ আদায়ের লক্ষে মুভমেন্ট বাতিলের পেপার তৈয়ার করিয়া এতদসঙ্গে সংযুক্ত ও প্রেরণ করা হল।
					</td>
				</tr>
			</table>
			<?php } ?>		
			...
			<form method="POST" enctype="multipart/form-data" action="<?php echo site_url("Vessel/vslCancelationForwardingPerform") ?>">
			<?php } ?>
