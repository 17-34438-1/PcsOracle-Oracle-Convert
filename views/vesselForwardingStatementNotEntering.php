<table border="0" align="center" width="100%" style="border-collapse:collapse;">
    <tr>
        <td align="center" width="70%">
            ...
            <h2>STATEMENT SHOWING THE PARTICULARS OF SHIPS SAILED FROM OUTER ANCHORAGE WITHOUT ENTERING IN TO HARBOUR DURING THE MONTH 
            <?php 
                echo $month = numberToMonth($stmt_month)."/";
...
<table border="1" style="border-collapse:collapse;margin-top:12px;" align="center" width="100%">					
    <thead>
        <tr>
            ...
            <th rowspan="2" class="text-center" width="10%"><h2>Date of Arrival</h2></th>
