...
<table border="1" style="border-collapse:collapse;width:100%;">
	<?php
	if($rslt_show_report[0]['place_dec']!="")
	{
	?>
	<tr>
		<td colspan="9" align="left"><b>EXIT NOTE NUMBER : <span style="background-color:#a5da68"><?php echo $rslt_show_report[0]['place_dec']; ?></b></span></td>
	</tr>
	<?php
	}
	if(count($rslt_cont_info)!=0)
