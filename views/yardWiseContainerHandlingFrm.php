 ...
 <script type="text/javascript">
  ...
  function getBlock(yard)
	...
	function validate()
	{
		...
		if( document.getElementById('rotNum').disabled == false && document.myform.rotNum.value == "" )
		{
		...
		// {
			// if( document.getElementById('yard_no').value == "" )
			// {
	...
	function enableRot(val)
	{
		if(document.getElementById('searchBy').value=="Rotation")
		{
			document.getElementById('rotNum').disabled = false;			
		}
		else
		{
			document.getElementById('rotNum').disabled = true;
		...
		<div class="col-lg-12">						
			<section class="panel">
				<div class="panel-body">
					<form class="form-horizontal form-bordered" method="POST" action="<?php echo base_url().'index.php/Report/yardWiseContainerHandlingView'; ?>" target="_blank" id="myform" name="myform" onsubmit="return validate()">
						<div class="form-group">
							...
							<div class="col-md-6">
								...
								<div class="input-group mb-md">
									...
									<select name="searchBy" id="searchBy" class="form-control" onchange="enableRot(this.value)">
								...
								<div class="input-group mb-md">
									...
									<input type="text" name="rotNum" id="rotNum" class="form-control" placeholder="Rotation No" disabled >
								</div>
								<div class="input-group mb-md">
							...
							<div class="row">
								<div class="col-sm-12 text-center">
									...
									<button type="submit" id="submit" name="report" class="mb-xs mt-xs mr-xs btn btn-success login_button">Show</button>
								</div>													
							</div>
							<div class="row">
								<div class="col-sm-12 text-center">
