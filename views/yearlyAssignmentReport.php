                        ...
                        <tr  align="center" height="100px">
                            <td colspan="13" align="center">
                                <table border=0 width="100%">
                                    <tr align="center">
                                        <td colspan="12"><font size="5"><b>Yearly Assignment Report</font></td>
                                    </tr>
                                    <tr align="center">
						...
						<table width="35%" border ='1' align="center" cellpadding='0' cellspacing='0'>
                            ...
                            <tr>
                                <?php
                                    ...
                                    //return;
                                    for($i=0;$i<count($yearlycnfReport);$i++){
                                        $monthName = $yearlycnfReport[$i]['assignDt'];
                                        $cntNo = $yearlycnfReport[$i]['cnt'];
                                        $total+=$cntNo;
